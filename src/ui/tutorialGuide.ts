...
export const TUTORIAL_PLANNED_MECHANICS = [
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans remain the current human population. One independently generated dog remains paired with a porter without ownership, while one separate settlement-custodied working dog watches near the existing two-goat herd from its own kennel relationship. Near the stable starting harbor, one bounded habitat-derived local assemblage also includes deer, gulls, black bears, brown-rat population areas, free-ranging domestic cats, marsh rabbits, marsh foxes, fish crows, one northern harrier, a southern leopard-frog population area, an Atlantic-silverside school aggregate, an Atlantic-marsh-fiddler-crab area aggregate, at most one snowy egret, at most one American black duck, at most one habitat-supported North American river otter, one stable two-to-three-member domestic chicken flock in the storehouse yard, and exactly two domestic goats in one separate herd and pen. Rats, frogs, silversides, and fiddler crabs remain conserved aggregate populations rather than individual actors; the other listed wildlife use bounded persistent representatives. Each chicken, goat, and dog remains an individual, and the domestic groups use explicit settlement-custody relationships. Additional dogs and wildlife species beyond this bounded roster, worldwide populations and domestic ownership, reproduction, animal death and carcasses, attacks, a new guardian sound, general scent and evidence tracking, rumors, companions, complete circadian life, foliage browsing, herding, guaranteed livestock defense, and the full bestiary remain planned.",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The Missing Goat adds no animal. A current caused flee or retreat can split an existing social group only when the exact bodies are physically far enough apart; distance alone cannot invent an incident. A separated goat may choose to move toward a herd mate only after current identified sight, while danger, exhaustion, and other needs keep priority. The keeper must lawfully notice a separation before an explicit report of the last known area can recruit the existing guardian dog's bounded search lifecycle. Searching never proves the goat was found. The same saved bodies must physically rejoin, and current keeper sight of every member inside the existing pen must confirm recovery; an unnoticed return closes without inventing earlier keeper knowledge. Whole saved groups enter detailed simulation as indivisible cap units, so one member cannot be discarded at the edge of the field. Chart, Relief, quick inspection, and pane-free ABOUT reveal only visible movement, never the private regroup intent or a remote recovery marker. Outer save 21 adopts one sealed version-20 world exactly once and appends a bounded recovery record while habitat remains version 9, settlement ecology remains version 4, aggregate ecology remains version 4, working-animal state remains version 2, and every established actor, home, relationship, item, Promise, and world fact stays exact. Shared invariants and representative emergence validate this reusable seam without species-by-species or N² pair testing. This is not a new species, broad herding, teleporting livestock, guaranteed recovery, autonomous home return, a player command, attack, injury, mortality, carcass, worldwide ecology, or broader settlement-animal simulation.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      {
        ...
        body: "Click or tap a directly visible resident, traveling porter, dog, deer, gull, black bear, domestic cat, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, brown-rat sign, frog-population sign, silverside-school sign, or fiddler-crab sign. ABOUT closes when that actor or sign leaves exact sight; it is a live field observation, not a remote tracker. Several visible gulls or crows may be summarized with the same approximate visible flock count shown in the world, without revealing birds outside your sight. The black duck and otter are each one addressable individual rather than a flock, and aggregate evidence never invents an individual rat, frog, fish, or crab.",
      ...
      },
      {
        ...
        body: "Near the stable starting harbor, terrain and habitat derive each local population rather than forcing a fixed roster. The mixed-resolution model records capacity, population pressure, and trend while materializing only a bounded set of representatives; a species with too little support is genuinely absent instead of being rerolled. When present in numbers, deer persist in herds, gulls in flocks, and up to three fish-crow representatives in one CROW-FLOCK. One storehouse-yard anchor supports exactly one stable two-to-three-member domestic-chicken flock, while a deliberately separated pen supports exactly two domestic goats in one HERD; every bird and goat retains its own identity inside the group. One additional seed-stable dog is generated separately under settlement custody and a persisted guardian assignment; it is not a habitat population, a member of the goat herd, or the original independent porter-scene dog. Black bears and the northern harrier stay solitary; at most one snowy egret, American black duck, and habitat-supported North American river otter use persistent individual identities. Free-ranging domestic cats, marsh rabbits, and marsh foxes also use persistent individual representatives. Brown rats, southern leopard frogs, Atlantic silversides, and Atlantic marsh fiddler crabs remain conserved population-area or school aggregates and never become clouds of fake actors. When more core-wildlife individuals are eligible than the active field can hold, deterministic distance and stable identity select the nearest 24 while every overflow actor remains preserved in coarse state.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "The seven Wave-B roles, Wave-C tidal roles, and bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices remain one integration near the stable starting harbor. They share versioned role, perception, movement, group, aggregate, tide, physical-item, plural-custody, typed-home, working-assignment, recovery, and presentation contracts instead of hardcoded species or pair lists. This closes the bounded starting-harbor Wave-D integration seam; it does not create storage, livestock, recovery, or dog ecology in every settlement, does not create ecology in every distant region, and does not complete the wider biodiversity directive. Animals do not attack, receive injuries, die, leave carcasses, or consume live prey in this build. Chickens and goats still have no authored call, track evidence, reproduction, complete schedule, autonomous home return, broad herding behavior, or cross-region migration; goat foliage browsing, milk, and wool are also absent. A guardian search can fail or defer and never proves an animal was found. The working dog adds no bark, attack, harmful protection, companion bond, player command, guaranteed recovery, worldwide population, or cross-region animal ecology. Complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, wider livestock, further species, wider aquatic and scavenger ecology, worldwide populations and storehouses, and the full bestiary are not live yet. Shared invariants, property and bounded-fuzz checks, conservation rules, performance budgets, and representative emergent interactions test the reusable scaffold instead of requiring a species-by-species or N² pair matrix.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "The game maintains one local autosave, using browser storage with a fallback. It saves periodically, when the page hides or closes, when the title opens, and when Quiet Hour begins. Outer save version 21 preserves habitat version 9, aggregate ecology record version 4, settlement ecology version 4, working-animal state version 2, all aggregate populations and signs, persistent herds and flocks, bounded representatives and intent, tidal and domestic anchors, the durable tide-operation clock, deterministic materialization, movement evidence, physical food history, the starting-harbor store, plural domestic custody, one separate dog roster, and the complete earlier world. A sealed version 20 Watch Returns save migrates exactly once: every established population, anchor, actor, group, item, Promise, home, relationship, custody, assignment, task, store fact, evidence record, and world fact stays exact before one empty domestic-animal recovery root is appended. That bounded root stores at most one current case, one pending exact-once transition, and one latest closed outcome. It binds every stable actor ID to its exact population ordinal, retains only authenticated group, sight, report, search, reunion, and confirmation proofs, and cannot treat a search task as proof of finding. Re-saving and reloading cannot reroll an animal or anchor; duplicate a group, provision, relationship, assignment, task, recovery case, transition, acknowledgement, or result; swap two animals' population identities; assign one actor or group to two homes; replay a store loss, chicken meal, working activity, group transition, or tidal-edge opportunity; exceed the materialization cap; or rewrite older ecology. Saved pending working-animal and domestic-recovery transitions each recover exactly once without repeating perception, movement, handler authority, or outcome.",
      },
      {
    ...
    steps: [
      {
        ...
        audience: "all",
        title: "Live now",
        body: "One continuous deterministic world, a bounded moving presentation frame, exact negative coordinates, seamless player and parcel travel beyond the old map extent, seven visual biomes, the original estuary's deterministic field resources, one-unit gathering, exact combined inventory load, component and gear recipes, durable condition, mending and dismantling, authoritative Marsh wraps, Float sash, Ridge cleats and Weather cape effects, persistent Wayknots, tides, global weather, downward screen-space Relief rain, deterministic local river strength and turbulence, ordinary surface streamlines and scan-only analytical arrows, direct terrain-responsive stability percentage, separate broad-terrain and short-detail perception fog, a brief terrain-only visual memory shared by Chart and Relief, transient uncharted sight, dim explored memory, observation-safe EVENTS, cross-layout HUD facts, discovery, depth sounding, player-controlled ADRIFT recovery, promises, reports, routes, projects, and persistent identities, weather condition, restrained emotion cues, greetings, ABOUT inspection, occluded sight, anonymous directional hearing, bounded attention/suspicion, and last-known-area searching for the original harbor country's 42 humans are active. One generated independent dog adds physical movement, food scent, rain/cold condition, knowledge-honest ABOUT, five player choices, exact one-unit provision transfer, bounded memory, and promotion beside one existing porter. One separate settlement-custodied working dog has its own kennel and a generic persisted guardian assignment tied to the existing keeper, two-goat herd, and pen. It uses ordinary dog cognition, needs, exposure, species-neutral direct perception, shared alarm evidence, and terrestrial pathing; actor-owned retreat, shelter, avoidance, and rest can outrank duty. A lawful anonymous alarm can open one bounded task toward a deterministic probe inside only its uncertain perceived area. Reaching that probe completes investigation and sends the dog physically toward the existing pen worksite; a keeper recall requires fresh reciprocal sight, dog cognition or welfare may suspend and resume work, and final arrival waits for lawful handler acknowledgement. A current caused flee or retreat can also split the exact goat bodies. A separated goat may regroup only from current identified sight of its herd mate. The keeper must lawfully notice the separation before reporting its last known area to the guardian; searching is not finding, and closure requires physical reunion plus current keeper sight of every goat inside the pen. A fox still changes course only if it actually sees the dog. One bounded habitat-derived assemblage near the stable starting harbor adds deer, gull, black-bear, brown-rat, domestic-cat, domestic-chicken, domestic-goat, marsh-rabbit, marsh-fox, fish-crow, northern-harrier, southern-leopard-frog, Atlantic-silverside, Atlantic-marsh-fiddler-crab, snowy-egret, American-black-duck, and North American river otter ecology: honest absence, persistent individual representatives, deterministic bounded materialization, deer and goat herds, gull, crow, and chicken flocks, rat/frog/fish/crab aggregates, direct established signs, shared lawful visual contacts, capability-selected anonymous aquatic-activity observations, narrow exposed-food scent pressure, rabbit, crow, chicken, and goat alarms, nonlethal finite fox and harrier pursuit, crow mobbing pressure, bounded perch/quarter/rest/wading/dabbling/diving/roaming activity, explicit air, surface-water, amphibious shore-water, and terrestrial movement, rain-responsive directional chorus, live tide-responsive aquatic activity and redistribution, shared terrain locomotion, generic physical resource claims, and knowledge-honest Chart/Relief ABOUT with mouse, touch, and reduced motion. Saved social groups are indivisible cap units: every member enters detail together or the whole group remains coarse, and an off-frame exact body receives no local sensory or locomotion input. Six reusable activity-affordance profiles own perch/watch, quartering, wading, dabbling, shore-water-foraging, and aerial surface-opportunity semantics; a gull can circle current anonymously observed tidal surface activity by air without gaining swim, wade, aquatic-foraging, or live-prey powers. One starting-harbor store owns a distinct physical fresh-produce lot: an open door exposes it through shared weather-shaped scent, a matching rat attraction can authorize at most one real unit loss, existing cat pressure remains perception-driven, and the actual nearby keeper can persistently secure the door after an in-person report. Its yard supports one stable flock of two or three individual chickens under settlement custody; a hungry member can perceive and approach that exact open-store lot through shared systems, then consume one authenticated physical unit, while a secured store grants neither food knowledge nor a claim. A separate habitat-derived pen supports exactly two individual goats in one persistent herd and second custody relationship. Goats reuse the shared actor, perception, group, locomotion, and presentation owners but do not claim store provisions or browse foliage in this build. The working dog receives a third custody and kennel without joining the herd, and working-animal state version 2 stores only authenticated relationship, cognition, task, transition, worksite, and handler-contact facts. One bounded recovery root stores authenticated topology, keeper knowledge, handler report, search linkage, reunion, and home-confirmation facts without owning movement. Lawful contenders for one physical resource are ordered by reach, current need, and stable identity. At most one addressable duck can float, scan, dabble, rest, swim on the surface, or relocate by air; at most one habitat-supported otter can rest ashore, move between shore and water, scan, swim, dive, or forage. Neither is a flock. Aggregate redistribution is bounded and never duplicates population units; pursuit, wader pressure, otter pressure, and guardian deterrence never attack or consume live prey. The outer game save is version 21 with exact one-time sealed-version-20 adoption of the domestic-recovery root while habitat remains version 9, settlement ecology remains version 4, aggregate ecology remains version 4, working-animal state remains version 2, and the nineteen-record species catalog, both dogs, flock, herd, homes, actors, groups, aggregate populations, items, Promises, evidence, tidal anchors, store state, assignments, and world facts stay exact. Embedded simulation snapshots remain perception-aware format 4 and rules 6. Perpetual play remains active.",
      },
      {
        id: "boundaries-planned-ecology",
        audience: "all",
        title: "Broader ecology is planned",
        body: "The seven named biomes and their rainfall, heat, salinity, exposure, and magical-water signals are visible now. Current rain affects both dogs' ordinary condition and exposure, affects the first dog's food-scent web, masks shared perception, can pressure the local rat aggregate, and raises bounded southern-leopard-frog activity and chorus without changing frog identity. The live tide changes depth and current activity for conserved silverside and fiddler-crab aggregates, changes which saved wading edges a snowy egret may lawfully use, changes which saved water destinations remain eligible for an American black duck, authenticates usable water for a supported North American river otter, and may create current anonymous surface opportunity for an air-moving gull; it does not reroll a population. Exposed loose provisions can create bounded rat scent attraction without being consumed, while a crow, eligible otter, or domestic chicken must physically reach a lawful resource and win deterministic shared arbitration before custody can change. The starting-harbor store owns a distinct physical produce lot; its rat-loss and chicken-feeding transactions each consume only the exact authorized unit, and a secured door contains scent while preventing domestic food perception and claims. Goats and the working dog do not inherit chicken food access merely because all use domestic custody. Wave C and Wave D are closed only as bounded starting-harbor integrations; the store, yard flock, far-paddock herd, guardian assignment, and missing-livestock recovery do not imply worldwide ecology. Further wildlife species, storehouses, worldwide populations and livestock, wider aquatic and scavenger ecology, the full bestiary, broad herding, guaranteed livestock recovery or defense, dog attacks, eggs, nesting, migration, reproduction, injury, death, harmful attacks, live-prey capture or consumption, fishing, carcasses, a working-dog bark, chicken or goat calls and tracks, complete sound, general scent and evidence tracking, broad keeper schedules, autonomous home or kennel return, player-issued livestock searches, remote recovery markers, rumors, foliage consumption, goat milk or wool, complete circadian behavior, cat ownership or companionship, courier exposure, and material-specific magical-water reactions remain planned. The scaffold is exercised through shared invariants, property and bounded-fuzz checks, physical-item and aggregate conservation, performance budgets, and representative emergent scenarios rather than species-by-species or N² pair tests; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 38 as const;
