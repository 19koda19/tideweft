  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Tidal Convergence adds no species. A versioned activity-affordance registry now composes perch/watch, low quartering, tidal wading, dabbling waterfowl, shore-water foraging, and aerial surface opportunity for six existing roles. A gull may approach and circle current anonymous AQUATIC ACTIVITY only when shared terrain-occluded vision lawfully supplies that observation, and it travels there by ordinary air movement rather than gaining swimming, wading, aquatic foraging, or prey pursuit. Threat, escape, alarm, food, guard, pursuit, retreat, and scavenging intents still outrank neutral activity. The outer save remains version 15 because profiles derive from existing identity and are not a new serialized truth. Shared properties, conservation, bounded fuzzing, performance budgets, and representative scenes validate these abstractions instead of a species-by-species or N² test matrix. This closes only the bounded starting-harbor Wave-C integration seam and does not add harmful attacks, injury, mortality, carcasses, live-prey capture or consumption, fishing, reproduction, migration, complete circadian life, general sound, scent or evidence, worldwide ecology, the full bestiary, or completed Directive 04_1.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "The seven Wave-B ecological roles and the Wave-C tidal roles are closed only as one bounded habitat-derived integration near the stable starting harbor. The Tide Table, one-duck waterfowl unit, one-otter amphibious unit, and Tidal Convergence now share versioned role, activity-profile, perception, movement, group, aggregate, tide, item-claim, and presentation contracts instead of hardcoded species or pair lists. This does not create ecology in every distant region or complete Directive 04_1. Animals do not attack, receive injuries, die, leave carcasses, or consume live prey in this build. The duck has no flock, nesting, reproduction, migration, capture, mortality, carcass, or consumption state. The otter likewise has no capture, live-prey consumption, harmful attack, injury, mortality, carcass, fishing, call, track-evidence, reproduction, or migration state. Complete sound, scent and evidence tracking, foliage consumption, complete circadian behavior, further species, wider aquatic and scavenger ecology, worldwide populations, and the full bestiary are not live yet. Shared invariants, property and bounded-fuzz checks, conservation rules, performance budgets, and representative interactions test the reusable scaffold instead of requiring a species-by-species or N² pair matrix.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "The game maintains one local autosave, using browser storage with a fallback. It saves periodically, when the page hides or closes, when the title opens, and when Quiet Hour begins. Outer save version 15 preserves habitat version 7, aggregate ecology record version 4, all four aggregate populations and their signs, persistent herds and flocks, bounded representatives and their saved intent, tidal, waterfowl, and otter anchors, the durable tide-operation clock, deterministic top-K materialization state, movement evidence, and physical food history. Tidal Convergence introduces no save bump or migration: activity profiles derive from existing stable species identity, while current activity and water depths derive again from those authoritative facts, world time, lawful observation, and the live tide. A sealed version 14 Between Water and Sky save migrates exactly once through the already-released Alpha-21 authority: every established habitat-version-6 population and anchor, actor, group, aggregate population, item, Promise, custody record, disturbance, evidence record, and world fact stays exact while deterministic otter habitat and a zero-or-one North American river otter population are appended once. Re-saving and reloading cannot add another population, reroll an animal or anchor, duplicate a group or provision, exceed the 24-actor materialization cap, replay a completed tidal-edge opportunity, or rewrite older ecology.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 32 as const;
