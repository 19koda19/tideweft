  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "A day shared",
        body: "Alpha 51 · A Day Shared is a local unpublished source candidate. All forty-two current original-estuary residents now use the same saved day-active living-circadian contract with stable identity-derived timing. A contract-free person at their real home settlement may settle, become Asleep after the shared interval, and wake through the one civil clock. Active Promise contracts and route travel remain real work and keep their resident awake; the starting-harbor keeper's authenticated porter response remains a real duty override rather than becoming a made-up occupational shift. Current identified, alert, or searching perception is active watch. Weak noticed or suspicious information does not by itself erase rest, while a sufficiently strong current sensory interruption still produces STARTLED. Storms and urgent food, rest, belonging, or exhaustion retain priority, and dusk never forces sleep. The runtime prepares the complete bounded resident roster before committing any receipt, so one invalid state cannot leave a half-updated population. Loading and saving alone preserves historical receipt absence; on the next ordinary authoritative tick, eligible at-home residents adopt the existing optional receipt, while a legacy person already away remains unbound until a lawful home arrival. No house, bed, interior, commute, teleport, or individual production shift is invented. Chart, Relief, quick inspection, and ABOUT may show Resting or Asleep only for a directly observed bound resident and still hide schedule timing, phase, thresholds, destination identity, exact needs, and private attention. The existing settlement working dog continues to use its physical kennel, custody relationship, guardian assignment, stable identity, and ordinary needs across sleep, reload, and dawn; it is the current relationship-bearing domestic-dog continuity witness. The independent dog has no authenticated den or companion bond and remains unchanged. No bonded, named player companion exists yet. Outer save version 32 and simulation save format 4 remain unchanged. Current human breadth remains forty-two residents in the original compatibility region, not infinite human generation or autonomous settlement home life. A courier finishing at a foreign settlement still has no fabricated guest bed or return commute and remains an explicit physical recovery gap. Final multi-day performance/save-growth evidence, packaged desktop/mobile parity, cumulative validation, and Turning Day closure remain before Living Voice. This candidate has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED; Alpha 39 remains the latest verified public release.",
      },
    ],
    callouts: [
      {
...
export const TUTORIAL_CONTENT_VERSION = 61 as const;
