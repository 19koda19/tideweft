  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "The paddock watch",
        body: "The Paddock Watch adds exactly one separate settlement working dog beside the existing two-goat herd. The dog has its own kennel and custody, while one generic persisted working-animal assignment ties its identity, the existing keeper as handler, both custody relationships, the protected herd, and the pen worksite together. It uses ordinary dog cognition, needs, weather exposure, perception, and shared terrestrial locomotion: a lawful anonymous herd or wildlife alarm may justify movement toward only its uncertain perceived area, but the dog's own retreat, shelter, avoidance, or rest can take priority. Chart, Relief, and quick inspection reveal only direct current detail. ABOUT may say that the dog is watching, investigating something nearby, or returning nearby without exposing the alarm source or assignment graph. A representative chain allows a fox to change course only after it actually perceives the dog; there is no invisible protection aura or promised defense. Outer save 19 adopts one sealed version-18 world exactly once while habitat stays version 9, settlement ecology advances to version 4, and the prior flock, herd, homes, store, items, Promises, actors, and world facts remain exact. Shared invariants and representative emergence validate the architecture—there is no species-by-species or N² pair matrix. This is one local working relationship, not worldwide dogs or livestock, herding, attacks, injury, mortality, carcasses, new sound, guaranteed livestock defense, cross-region animal ecology, full Wave D, or completed Directive 04_1.",
      },
    ],
    callouts: [
      {
    ...
    steps: [
      {
        ...
        body: "The game maintains one local autosave, using browser storage with a fallback. It saves periodically, when the page hides or closes, when the title opens, and when Quiet Hour begins. Outer save version 19 preserves habitat version 9, aggregate ecology record version 4, settlement ecology version 4, all four aggregate populations and their signs, persistent herds and flocks, bounded representatives and their saved intent, tidal, waterfowl, otter, domestic-yard, and domestic-pen anchors, the durable tide-operation clock, deterministic top-K core-wildlife materialization state, movement evidence, physical food history, the starting-harbor store's plural domestic custody and food-use history, one separate dog roster, and one generic settlement-working-animal assignment root. A sealed version 18 Far Paddock save migrates exactly once: every established habitat-9 population and anchor, actor, group, aggregate unit, store and lot identity, chicken and goat relationship and home identity, closure, loss event, item, Promise, custody record, disturbance, evidence record, and world fact stays exact before the deterministic working dog, kennel, third custody relationship, and guardian assignment are appended. The store lot remains distinct from abstract settlement food, and neither goats nor the working dog can claim it. Re-saving and reloading cannot reroll a chicken, goat, dog, or anchor; duplicate a group, provision, relationship, or assignment; assign one actor or group to two homes; reopen a secured door; replay a store loss, chicken meal, working activity, or tidal-edge opportunity; exceed the 24-actor core-wildlife materialization cap; or rewrite older ecology. A saved pending work transition recovers exactly once without repeating perception or movement.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 36 as const;
