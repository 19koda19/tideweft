...
export const TUTORIAL_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "High country shadows",
        body: "High Country Shadows appends cougar and brown bear as distinct solitary species at the exact existing Beyond the Harbor remote temperate-upland and forest-edge source. The twenty-four-record catalog gives them stable habitat-population records and, where carrying capacity supports them, persistent individual representatives through the same habitat, population, direct-perception, attention, actor-owned locomotion, bounded materialization, and presentation owners as wild boar, elk, gray wolf, and established wildlife. A cougar may begin a short direct-sight pursuit, but only exact contact with a currently identified solitary addressable marsh rabbit can enter the existing injury or mortality transaction. Brown bear has no live-prey pursuit or harmful contact in this unit; neither species can harm the player, dogs, humans, or social-group members. Either may lawfully see, reach, claim, guard, and consume an already-existing finite physical body. Chart, Relief, quick inspection, and ABOUT expose only current lawful knowledge. Outer save 24 adopts one sealed version-23 Beyond the Harbor world exactly once: its complete habitat-version-10 source and population sequence and all body-bearing state remain exact before habitat version 11 evaluates the two new population records and appends only supported populations. Shared representative, property, conservation, signed-region, and bounded-performance checks validate the reusable architecture without species-by-species or N² pair testing. Both additions remain solitary and have no track evidence, audible voice, species-specific dog-directed behavior, ecological migration, or worldwide distribution; a dog or porter that lawfully sees one may still react non-harmfully through the existing shared large-predator perception path.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    summary: "The original harbor country's 42 humans, its first independent dog, persistent wildlife from the harbor patch and one remote upland source, and directly observed aggregate-population signs use one knowledge-honest boundary; ABOUT reveals only what you can see or have learned.",
    ...
    callouts: [
      ...
      },
      {
        ...
        audience: "all",
        tone: "boundary",
        title: "Regional ecology is bounded, not worldwide",
        body: [
          "The seven Wave-B roles, Wave-C tidal roles, bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices, and one remote Wave-E upland source share versioned role, perception, movement, group, aggregate, tide, physical-item, plural-custody, typed-home, working-assignment, recovery, mortality, body, and presentation contracts instead of hardcoded species or pair lists.",
          "The remote source adds wild boar, elk, gray wolf, cougar, and brown bear; eligible boar, elk, and wolves use SOUNDER, HERD, and PACK while cougar and brown bear remain solitary. It does not create storage, livestock, recovery, or animal ecology in every settlement or distant region. Role-driven wolf or cougar pursuit may pressure eligible prey, while the only harmful live-animal contact in this build remains exact contact with a currently identified solitary addressable marsh rabbit; grouped elk, grouped deer, and every other social-group member cannot be harmed. Brown bear has no live-prey pursuit or contact. Player, dog, human, and broader animal mortality remain absent. A boar, wolf, cougar, or brown bear may claim and consume finite resource from an existing body only after lawful sight and reach.",
          "Chickens and goats still have no authored call, track evidence, reproduction, complete schedule, autonomous home return, broad herding behavior, or cross-region migration; goat foliage browsing, milk, and wool are also absent. A guardian search can fail or defer and never proves an animal was found. The working dog adds no bark, attack, harmful protection, companion bond, player command, guaranteed recovery, worldwide population, or cross-region animal ecology.",
          "Species-directed dog interaction with wild boar, elk, gray wolf, cougar, and brown bear is an intentional no-response and remains unimplemented; ordinary lawful large-predator perception may still drive a non-harmful dog or porter reaction. Boar, elk, and wolf voice patterns are foundation-only and not audible; cougar and brown-bear voice behavior is not implemented. Tactical pack combat, broader mortality, persistent tracks for the two latest additions, population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent and insects, complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, ecological migration, worldwide populations and storehouses, the rest of Wave E, and the full bestiary are not live yet.",
    ...
    steps: [
      {
        ...
        body: [
          ...
          "Outer save version 24 preserves core-ecology patch version 3, aggregate ecology record version 5, settlement ecology version 4, working-animal state version 2, every earlier population, actor, group, item, Promise, home, relationship, task, recovery case, store fact, world fact, and the authoritative mortality, population-reserve, physical-body, claim, and consumption ledgers.",
          "A sealed version 23 Beyond the Harbor save migrates exactly once: its complete habitat-version-10 remote-source and population sequence and body-bearing state remain exact before habitat version 11 evaluates the cougar and brown-bear population records at that same source and appends only populations supported by carrying capacity.",
          "Re-saving and reloading cannot reroll that source; duplicate or renumber an actor, population, group, or allocation; rewrite an existing injury or death; resurrect a retired actor; remove a second population unit; duplicate or move a body; restore consumed resource; replay a claim or meal; or turn an unseen incident into player knowledge. The version-10 boar, elk, and wolf population pressure and trend remain exact, while existing working-animal and domestic-recovery transitions still recover exactly once without repeating perception, movement, handler authority, or outcome.",
        ].join(" "),
      },
      {
    ...
    steps: [
      {
        ...
        body: [
          ...
          "The twenty-four-record species catalog retains the bounded starting-harbor ecology and exact Beyond the Harbor source, adding cougar and brown-bear habitat-population records there beside wild boar, elk, and gray wolf. Only carrying-capacity-supported populations receive actors. Stable SOUNDER, HERD, and PACK groups remain shared for eligible earlier populations; any present cougar or brown bear is solitary and composes the same perception, attention, actor-owned locomotion, physical-resource, and bounded materialization owners.",
          "A present wolf or cougar may create role-driven pursuit pressure, but only exact contact with a currently identified solitary addressable marsh rabbit can enter the current mortality transaction; grouped elk, deer, and all other group members cannot be harmed. Brown bear has no live-prey pursuit or harmful contact. A present boar, wolf, cougar, or brown bear can see, reach, claim, and consume from an existing finite physical body through the same conserved aftermath rules.",
          "Chart, Relief, quick inspection, ABOUT, and EVENTS expose only current lawful knowledge, never a hidden census, target, or retrospective offscreen story. Outer save version 24 adopts a sealed version-23 Beyond the Harbor world exactly once, retaining its complete habitat-version-10 source and population sequence and body-bearing state before habitat version 11 evaluates the two new solitary population records and appends only supported populations. Core ecology remains patch version 3 and aggregate record version 5. Embedded simulation snapshots remain perception-aware format 4 and rules 6. Perpetual play remains active.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. Physical loose provisions, store produce, and finite bodies can be perceived, claimed, and consumed only through their current bounded owners. Role-driven gray-wolf or cougar pursuit may pressure eligible prey, but the only current harmful live-animal seam remains exact contact with a currently identified solitary addressable marsh rabbit. Brown bear has no live-prey pursuit or harmful contact; grouped elk, grouped deer, and every other group member cannot be harmed. Species-directed dog interaction with the five upland species is an intentional no-response, while ordinary lawful large-predator perception remains shared; their voice patterns are not yet audible. Tactical pack combat, ecological migration, worldwide ecology, wider aquatic and scavenger relationships, broader mortality, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent, insects, persistent cougar/brown-bear tracks, broad attack and health systems, complete sound, general scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, and the full bestiary remain planned. Shared invariants, deterministic properties, conservation, bounded fuzzing and performance, and representative emergent scenarios validate the reusable scaffold rather than species-by-species or N² pair tests; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 41 as const;
