    ...
    steps: [
      {
        ...
        body: [
          ...
          "Outer save version 30 and RegionalEcologyStateV6 remain unchanged. A valid epoch-2 state authenticates before epoch 3 appends once at its saved tick; earlier epochs remain an exact prefix and reload cannot reroll the result. This Alpha 39 Saltmarsh Small Worlds SOURCE_CANDIDATE remains strictly local and unpublished: it has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. The bounded 45 / 47 catalog is not worldwide ecology or a complete bestiary. Shared invariants, signed and extreme-coordinate properties, conservation, performance, seamless crossing, and representative visible-versus-occluded scenarios exercise the reusable scaffold rather than species-by-species or N² pair tests. Sea ice, snow behavior, tactical pack combat, ecological migration, broader mortality and capture, reproduction, population recovery, live-time decomposition, body drift, harvesting, fishing, complete scent and evidence, full schedules and autonomous home life, audible Living Voice for the newest species, foliage consumption, and continuous 3D flight remain planned. The next authorized work after this directive's release checkpoint is full day-and-night life in The Turning Day; Living Voice follows after that. Absent systems do not alter a delivery behind the HUD's back.",
      },
      {
