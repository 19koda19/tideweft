...
export const TUTORIAL_PLANNED_MECHANICS = [
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans remain the current human population. One independently generated dog remains paired with a porter without ownership, while one separate settlement-custodied working dog watches near the existing two-goat herd from its own kennel relationship. The starting settlement separately retains its bounded brown-rat population area and anchored chicken and goat homes; its free-ranging domestic cat is habitat-optional. The current twenty-nine-record catalog preserves the exact existing signed-region ecology, adds a sparse Alpine layer where supported mountain goats form a HERD, American pikas remain one conserved non-addressable talus aggregate, and a golden eagle remains solitary, retains one separate sparse polar-shore layer where supported Atlantic capelin remain one conserved non-addressable school, and adds one solitary Arctic fox through a cold-shore sibling only where that exact admitted forage substrate supports it. Every layer shares one group-atomic materialization cap, while honest absence remains valid. Rats, frogs, silversides, fiddler crabs, pikas, and capelin are conserved aggregate populations rather than individual actors; the other eligible wildlife use bounded persistent representatives. Each chicken, domestic goat, mountain goat, dog, eagle, and Arctic-fox representative remains an individual, and domestic groups keep explicit settlement custody. The only current animal mortality is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit, with one conserved finite rabbit body; the Alpine trio, capelin, Arctic fox, brown bears, players, dogs, humans, social-group members, and broader animals cannot enter that harmful path. Additional dogs and wildlife species beyond this bounded roster, remaining polar breadth, complete Waves F and G, worldwide species breadth and domestic ownership, reproduction, population recovery, broader attacks and aftermath, a new guardian sound, general scent and evidence tracking, rumors, companions, complete circadian life, foliage browsing, herding, guaranteed livestock defense, and the full bestiary remain planned.",
    keywords: ["npc", "dog", "cat", "rat", "rabbit", "fox", "Arctic fox", "crow", "harrier", "frog", "silverside", "fiddler crab", "snowy egret", "American black duck", "North American river otter", "otter", "waterfowl", "mountain goat", "American pika", "golden eagle", "talus", "alpine", "chicken", "domestic", "livestock", "bear", "bird", "wildlife", "companion", "identity", "about", "perception", "ecology", "habitat", "population", "herd", "flock", "school", "chorus", "signs", "pursuit", "tide", "surface water", "amphibious", "flight"],
  },
  {
...
export const TUTORIAL_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: "whats-new-arctic-fox",
        audience: "all",
        title: "One fox at the cold shore",
        body: "Alpha 35 is this unpublished local candidate; it has not been pushed, deployed, or LIVE_VERIFIED. It extends the exact twenty-eight-record Coldwater Glint catalog to twenty-nine records with one solitary addressable Arctic fox only where viable cold-shore ground overlaps the exact already-admitted Atlantic-capelin forage substrate. Unsupported shore remains honestly empty. The fox composes shared identity, senses, attention, actor locomotion, condition, dormant autonomy, evidence, projection, and ABOUT owners rather than a species-specific controller. A lawfully perceived domestic dog can become generic pressure that drives ordinary flee or retreat, without a dog-and-fox pair script or invisible deterrence radius. When the fox currently sees anonymous capelin activity, it can apply generic nonlethal pressure that lawfully tightens or redistributes the conserved aggregate; terrain occlusion prevents both observation and response. No exact fish is selected, caught, consumed, injured, killed, or turned into a body, item, or cargo resource. Chart, Relief, quick inspection, and ABOUT disclose only current lawful form, condition, behavior, and small-canid evidence, never private attention, hunger, hidden anchors, counts, or offscreen events. The exact RegionalEcologyStateV3 child is wrapped by version 4 beside a sparse addressable cold-shore sibling, and outer save version 28 authenticates one sealed outer-version-27 Coldwater Glint save for exact-once adoption. Base, Alpine, polar-shore, and cold-shore sources enter one global group-atomic materialization and conservation commit capped at twenty-four addressable actors. This is one bounded actor seam, not complete Wave F, Wave G, or Directive 04_1; it adds no seals, polar bears, new seabirds, snow or ice behavior, new mortality or capture, reproduction, audible Living Voice, or broad migration.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    summary: "The original harbor country's 42 humans, its first independent dog, settlement-home animals, signed-region wildlife, sparse Alpine life, and directly observed aggregate-population signs use one knowledge-honest boundary; ABOUT reveals only what you can see or have learned.",
    keywords: ["person", "resident", "porter", "dog", "cat", "rat", "rabbit", "fox", "crow", "harrier", "frog", "silverside", "fiddler crab", "snowy egret", "American black duck", "duck", "waterfowl", "North American river otter", "otter", "wild boar", "boar", "elk", "gray wolf", "wolf", "cougar", "brown bear", "mountain goat", "American pika", "golden eagle", "alpine", "talus", "ridge", "sounder", "pack", "temperate upland", "forest edge", "amphibious", "diving", "chorus", "quartering", "wading", "dabbling", "surface swimming", "flight", "soaring", "perch", "mobbing", "pursuit", "paired tracks", "pawprints", "burrows", "haypile", "surface dimples", "signs", "deer", "gull", "black bear", "wildlife", "alarm", "food", "scavenge", "scent", "help", "wait", "reroute", "leave", "persistence", "npc", "about", "inspect", "greet", "observed", "known", "identity", "emotion", "weather", "vision", "hearing", "attention", "search", "habitat", "population", "herd", "flock", "school", "tide", "shallow water", "aftermath", "absence", "materialization"],
    ...
    steps: [
      {
        ...
        body: "Click or tap a directly visible resident, traveling porter, dog, deer, gull, black bear, domestic cat, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, golden eagle, brown-rat sign, frog-population sign, silverside-school sign, fiddler-crab sign, or American-pika talus sign. ABOUT closes when that actor or sign leaves exact sight; it is a live field observation, not a remote tracker. Several visible members may be summarized with the same approximate visible group count shown in the world, without revealing animals outside your sight. The black duck, otter, cougar, brown bear, and golden eagle are each one addressable individual rather than a group, while aggregate evidence never invents an individual rat, frog, fish, crab, or pika.",
      ...
      },
      {
        ...
        body: "Each representative—including every free-ranging cat, domestic chicken, domestic goat, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, golden eagle, and Arctic fox—keeps its stable identity and population membership. Flocks, herds, sounders, and packs retain their stable groups; cougar, brown bear, golden eagle, and Arctic fox remain solitary, and domestic groups also retain settlement custody. A saved social group is one indivisible materialization-cap unit: either every member is admitted to detailed simulation or the whole group remains coarse. An exact group member beyond the current frame receives no local observation or locomotion input merely because a peer is visible. Outside the active field, an individual coarse step applies only the remaining saved intent to physiology, ages existing perception without adding facts, and invents no hidden target, food, or player event. If more lawful independent individuals intersect the active field than can receive full detail, exact spatial top-K selection uses distance and stable identity across base, Alpine, polar-shore, and cold-shore owners while every overflow actor remains preserved. Returning restores the same saved actors rather than rolling replacements because the camera moved. Rat, frog, silverside, fiddler-crab, pika, and capelin populations preserve their own stable aggregate identities instead of pretending to be individuals.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: [
          "The seven Wave-B roles, Wave-C tidal roles, bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices, the five Alpha-30/31 additions, the Alpine triad, the polar-shore forage school, and one cold-shore Arctic fox now feed the same role, perception, movement, group, aggregate, ridge-activity, tide, physical-item, plural-custody, typed-home, working-assignment, recovery, mortality, body, and presentation contracts instead of hardcoded species or pair lists.",
          "The current twenty-nine-record catalog preserves the exact signed-region base, derives mountain-goat, American-pika, and golden-eagle populations through one sparse Alpine layer, retains one Atlantic-capelin school through a separate sparse polar-shore layer, and derives one solitary addressable Arctic fox through a cold-shore sibling only where that exact forage substrate supports it. Mountain goats form a HERD, pikas and capelin remain non-addressable aggregates, and golden eagles and Arctic foxes remain solitary. Every base, Alpine, polar-shore, and cold-shore owner shares one global group-atomic materialization cap of 24 addressable actors. This does not create distant settlements, storage, livestock homes, recovery networks, remaining polar breadth, complete Wave F, Wave G, or Directive 04_1. Role-driven wolf or cougar pursuit may pressure eligible prey, while the only harmful live-animal contact in this build remains exact contact with a currently identified solitary addressable marsh rabbit; grouped elk, grouped deer, every social-group member, all three Alpine species, capelin, and Arctic fox cannot be harmed. Brown bear, golden eagle, and Arctic fox have no live-prey pursuit or harmful contact. Player, dog, human, and broader animal mortality remain absent. A boar, wolf, cougar, or brown bear may claim and consume finite resource from an existing body only after lawful sight and reach.",
          ...
          "A lawfully perceived domestic dog can apply generic pressure to an Arctic fox and drive ordinary flee or retreat without a species-pair script; species-directed dog interaction with wild boar, elk, gray wolf, cougar, brown bear, mountain goat, pika, golden eagle, and capelin remains an intentional no-response. Boar, elk, and wolf voice patterns are foundation-only and not audible; cougar, brown-bear, mountain-goat, pika, golden-eagle, capelin, and Arctic-fox voice behavior is not implemented. Tactical pack combat, new mortality, live-prey capture or exact pika or capelin targets, complete evidence tracking, reproduction, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent and insects, complete sound, general scent propagation, foliage consumption, complete circadian behavior, ecological migration, remaining polar breadth, complete Waves F and G, Directive 04_1 completion, worldwide species breadth and storehouses, and the full bestiary are not live yet.",
    ...
    steps: [
      {
        ...
        body: [
          ...
          "Outer save version 28 adds regional ecology root version 4. Its base child is the exact RegionalEcologyStateV3 base, Alpine, and polar-shore composite from Coldwater Glint, which in turn preserves the exact Open Country Ledger lineage, habitat version 11 as sealed compatibility authority, core-ecology patch version 3, aggregate ecology record version 5, settlement ecology version 4, working-animal state version 2, and every earlier population, actor, aggregate, group, item, Promise, home, relationship, task, recovery case, store fact, world fact, mortality record, physical body, claim, and consumption record. One separate sparse cold-shore sibling owns only the addressable Arctic-fox lineage and its true deviations; the exact V3 polar-shore child still owns capelin.",
          "A sealed outer-version-27 Coldwater Glint save is authenticated and adopted exactly once into version 28. Its complete RegionalEcologyStateV3 child and original outer integrity remain the adoption witness; the Arctic-fox lineage is derived alongside it without rewriting, renumbering, redistributing, retiring, or relabeling any base, Alpine, or polar-shore wildlife. Supported older paths perform their existing exact adoptions before this wrapper is applied. All four ecology layers enter one deterministic group-atomic materialization and conservation commit capped at 24 addressable actors.",
          "Re-saving and reloading cannot reroll a regional, Alpine, polar-shore, or cold-shore lineage; duplicate or renumber an actor, aggregate, population, group, allocation, body, item, or claim; rewrite an existing injury or death; restore consumed resource; replay a meal; or turn an unseen incident into player knowledge. Pristine signed-region, Alpine, polar-shore, and cold-shore baselines are rederived instead of saved, while only actual deviations, promoted or migrated identities, bodies, claims, and transaction receipts consume regional storage. The existing Open Country Ledger disposition, Alpine adoption, Coldwater Glint adoption, working-animal transition, and domestic recovery remain exact and cannot replay.",
        ].join(" "),
      },
      {
    ...
    steps: [
      {
        ...
        body: [
          ...
          "The twenty-nine-record species catalog preserves eligible existing wild populations through the exact Open Country Ledger signed-region ecology, the sparse Alpine layer, and the separate sparse polar-shore sibling, then adds a separate addressable cold-shore sibling. Lawful empty country remains empty. Rare supported cold saline shoreline may contain one conserved non-addressable Atlantic-capelin school; only an exact already-admitted school beside suitable dry cold-shore ground can support one solitary Arctic fox. Ridge habitat may support a mountain-goat HERD, an American-pika talus aggregate, and a solitary golden eagle. The settlement home keeps bounded brown rats and anchored chicken and domestic-goat homes; its free-ranging domestic cat appears only when habitat supports it.",
          "Population lineage remains distinct from present residence. Every base, Alpine, polar-shore, and cold-shore owner enters one global group-atomic stable-distance top-K plan capped at twenty-four addressable actors, while authoritative density is measured before that cap; the capelin aggregate consumes no actor slot. Shared tide and density policy moves only conserved school units among authenticated water anchors. A currently seeing Arctic fox can create generic nonlethal capelin pressure, while occlusion prevents both observation and response; a currently perceived domestic dog can likewise drive the fox's generic flee or retreat without an invisible radius. Neither interaction opens a catch, consumption, injury, death, body, item, or cargo transaction. The existing mortality path remains limited to a marsh fox, gray wolf, or cougar exactly contacting a currently identified eligible solitary marsh rabbit; the Alpine, capelin, and Arctic-fox additions cannot enter it.",
          "Chart, Relief, quick inspection, ABOUT, and EVENTS expose only current lawful knowledge, never a hidden census, target, attention state, migration disposition, or retrospective offscreen story. Outer save version 28 adds RegionalEcologyStateV4 around the exact RegionalEcologyStateV3 child plus a sparse addressable cold-shore sibling, and authenticates one sealed outer-version-27 Coldwater Glint world for exact-once adoption. Pristine baselines are rederived and only real deviations persist. Habitat version 11 remains sealed compatibility authority, core ecology remains patch version 3, and aggregate ecology remains record version 5. Embedded simulation snapshots remain perception-aware format 4 and rules 6. This Alpha 35 candidate remains local and unpublished, not pushed, deployed, or LIVE_VERIFIED.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. The bounded twenty-nine-record catalog includes a sparse Alpine triad, one sparse polar-shore forage school, and one substrate-gated solitary Arctic fox, not complete Wave F, Wave G, Directive 04_1, worldwide species breadth, or a complete bestiary. Physical loose provisions, store produce, and finite bodies can be perceived, claimed, and consumed only through current bounded owners. The only current harmful live-animal seam is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit; Alpine species, capelin, Arctic foxes, brown bears, grouped animals, players, humans, dogs, and broader wildlife cannot enter this harmful ecology path. Golden-eagle pressure on pikas and visible Arctic-fox pressure on capelin are nonlethal and cannot capture or select an exact animal. Polar bears, seals, new polar seabirds, snow or ice behavior, tactical pack combat, ecological migration behavior, wider aquatic and scavenger relationships, new mortality or capture, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent, insects, broad attack and health systems, audible Living Voice for the newest species, complete scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, remaining polar breadth, and the full bestiary remain planned. Shared invariants, deterministic properties, conservation, bounded fuzzing and performance, and representative emergent scenarios validate the reusable scaffold rather than species-by-species or N² pair tests; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 45 as const;
