...
export const TUTORIAL_PLANNED_MECHANICS = [
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans remain the current human population. One independently generated dog remains paired with a porter without ownership, while one separate settlement-custodied working dog watches near the existing two-goat herd from its own kennel relationship. The starting settlement separately retains its bounded brown-rat population area and anchored chicken and goat homes; its free-ranging domestic cat is habitat-optional. The current forty-three-record catalog preserves every Alpha-37 layer and appends the epoch-2 Marsh Channel Web cohort. Suitable habitat may support conserved Atlantic-menhaden, mummichog, grass-shrimp, and blue-crab aggregates, one group-atomic greater-yellowlegs flock, one solitary belted kingfisher, and one group-atomic double-crested-cormorant flock; each bird requires its exact local aggregate substrate. Every layer shares one group-atomic materialization cap, while territory, density, and regional quiet preserve honest absence. Rats, frogs, silversides, fiddler crabs, pikas, capelin, anchovies, ghost crabs, menhaden, mummichog, grass shrimp, and blue crabs are conserved aggregates; eligible larger wildlife use bounded persistent representatives. The only current animal mortality remains exact contact by a marsh fox, gray wolf, or cougar against one identified eligible solitary marsh rabbit. The new cohort adds no capture, kill, consumption, mortality, body, player harm, dog harm, or human harm. One final four-profile Wave-G cohort, Directive 04_1 closure, worldwide ecology, reproduction, population recovery, broader attacks, audible Living Voice, sea ice, snow behavior, general scent and evidence tracking, rumors, companions, complete circadian life, foliage browsing, herding, and the full bestiary remain planned.",
...
export const TUTORIAL_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: "whats-new-marsh-channel-web",
        audience: "all",
        title: "The marsh channel fills out",
        body: "Alpha 38 Marsh Channel Web is this local unpublished SOURCE_CANDIDATE; it has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED. It preserves Alpha 37 as the exact thirty-six-record catalog and epoch-1 breadth prefix, then appends Atlantic menhaden, mummichog, grass shrimp, blue crab, greater yellowlegs, belted kingfisher, and double-crested cormorant as records 37 through 43. The four fish and crustacean profiles remain conserved non-addressable aggregates; yellowlegs form one two-to-four-member group-atomic flock, the kingfisher is solitary, and cormorants form one two-to-three-member group-atomic flock. Terrain, salinity, channel and shore structure, water depth, tide, carrying capacity, territory, density, regional quiet, and exact substrate support decide admission. Yellowlegs require grass shrimp, kingfishers require mummichog, and cormorants require menhaden, so unsupported country remains honestly empty. Shared Tide Table and aggregate policy move only conserved units among authenticated anchors. Yellowlegs reuse anchored wading, kingfishers reuse air-only surface-opportunity and perch behavior, and cormorants use a shared diving-waterbird routine; immediate danger still wins. Chart, Relief, quick inspection, and ABOUT reveal only lawful current identities or aggregate evidence on desktop and touch. RegionalEcologyStateV6 and outer save version 30 remain unchanged: valid epoch-1 saves authenticate first, append epoch 2 exactly once at their saved tick, preserve the earlier cohort as an exact prefix, and reload without rerolling. All ecology layers share one global group-atomic cap of twenty-four addressable actors and one atomic commit. One representative clear-versus-ridge-occluded cormorant and menhaden scenario exercises the reusable interaction seam with exact aggregate conservation. This reaches forty-one of the forty-five core-wildlife profiles; one final four-profile cohort and the Directive 04_1 closure gates remain. The candidate adds no sound, capture, consumption, new mortality or bodies, reproduction, full circadian life, or continuously simulated 3D flight, and dedicated Wave-G performance and seamless actor-crossing closure evidence remain open.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Across the signed world, terrain and habitat derive each local population from carrying capacity, food or prey support, territory, and density rather than forcing a fixed roster. The mixed-resolution model records capacity, population pressure, and trend while materializing only a bounded set of representatives; a species with too little support is genuinely absent instead of being rerolled. When present in numbers, deer, elk, and mountain goats persist in herds; gulls, fish crows, common terns, greater yellowlegs, and double-crested cormorants in flocks; wild boar in sounders; and gray wolves in packs. The starting settlement separately retains one stable two-to-three-member domestic-chicken flock, exactly two domestic goats in one herd, and one additional seed-stable working dog under settlement custody; these are homes and relationships, not wild habitat populations. Black bears, cougars, brown bears, northern harriers, golden eagles, Arctic foxes, harbor seals, polar bears, great blue herons, ospreys, and belted kingfishers stay solitary. Snowy egrets, American black ducks, and habitat-supported North American river otters also use persistent individual identities. Free-ranging domestic cats, marsh rabbits, and marsh foxes use persistent individual representatives. Brown rats, southern leopard frogs, Atlantic silversides, Atlantic marsh fiddler crabs, American pikas, Atlantic capelin, bay anchovies, Atlantic ghost crabs, Atlantic menhaden, mummichog, grass shrimp, and blue crabs remain conserved population-area, school, or activity aggregates and never become clouds of fake actors. One global group-atomic plan selects the nearest 24 eligible individuals across every active base, Alpine, polar-shore, cold-shore, polar-consumer, and breadth ecology owner while every overflow actor remains preserved in coarse state.",
      },
      {
      ...
      },
      {
        ...
        body: "The original six neutral-activity archetypes remain exact, and later shared extensions bring the current registry to nine reusable archetypes serving fourteen species. Each profile must match the actor's real capabilities, allowed movement media, authenticated destination, observation boundary, visible signal, and bounded daylight/rest scope. Golden eagle retains ridge-soar/perch; harbor seal reuses authenticated shore-water foraging; great blue heron and greater yellowlegs use anchored-wader behavior at authenticated tide-depth-safe wading ground; gull, common tern, osprey, and belted kingfisher share aerial-surface-opportunist behavior; and double-crested cormorant uses diving-waterbird behavior. Only a current anonymous terrain-occluded AQUATIC ACTIVITY observation can guide a lawful surface opportunity, and each actor returns to an authenticated anchor for rest. These profiles grant no exact fish target, capture, or consumption. Any immediate lawful threat, escape, alarm, food, guard, pursuit, retreat, or scavenging intent outranks neutral activity. These are bounded daylight/rest routines, not full circadian life or continuously simulated 3D flight.",
      },
      {
        id: "shadow-overhead",
        audience: "all",
      ...
      },
      {
        ...
        body: "A directly visible deer, gull, black bear, domestic cat, domestic chicken, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, golden eagle, Arctic fox, harbor seal, polar bear, great blue heron, common tern, osprey, greater yellowlegs, belted kingfisher, or double-crested cormorant offers WAIT AND WATCH, ROUTE AROUND THIS SPOT, and LEAVE. WAIT briefly stops the current automatic route. ROUTE AROUND must keep the same destination and find a real line outside the observed animal's area; if that fails, your previous route and choice history remain unchanged. LEAVE closes the observation rather than moving the animal. Rat, frog, silverside, fiddler-crab, pika, capelin, anchovy, ghost-crab, menhaden, mummichog, grass-shrimp, and blue-crab sign ABOUT is close-only because a population sign is not an actor; rabbit and fox movement signs are not targetable.",
      },
      {
      ...
      },
      {
        ...
        body: "Each representative—including every free-ranging cat, domestic chicken, domestic goat, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, golden eagle, Arctic fox, harbor seal, polar bear, great blue heron, common tern, osprey, greater yellowlegs, belted kingfisher, and double-crested cormorant—keeps its stable identity and population membership. Flocks, herds, sounders, and packs retain their stable groups; cougar, brown bear, golden eagle, Arctic fox, harbor seal, polar bear, great blue heron, osprey, and kingfisher remain solitary, and domestic groups also retain settlement custody. A saved social group is one indivisible materialization-cap unit: either every member is admitted to detailed simulation or the whole group remains coarse. An exact group member beyond the current frame receives no local observation or locomotion input merely because a peer is visible. Outside the active field, an individual coarse step applies only the remaining saved intent to physiology, ages existing perception without adding facts, and invents no hidden target, food, or player event. If more lawful independent individuals intersect the active field than can receive full detail, exact spatial top-K selection uses distance and stable identity across base, Alpine, polar-shore, cold-shore, polar-consumer, and breadth owners while every overflow actor remains preserved. Returning restores the same saved actors rather than rolling replacements because the camera moved. Rat, frog, silverside, fiddler-crab, pika, capelin, anchovy, ghost-crab, menhaden, mummichog, grass-shrimp, and blue-crab populations preserve their own stable aggregate identities instead of pretending to be individuals.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: [
          "The seven Wave-B roles, Wave-C tidal roles, bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices, the five Alpha-30/31 additions, the Alpine triad, the polar-shore forage school, one cold-shore Arctic fox, the polar-consumer seal-and-bear vertical, and both Wave-G breadth cohorts now feed the same role, perception, movement, group, aggregate, ridge-activity, tide, amphibious-activity, physical-item, plural-custody, typed-home, working-assignment, recovery, mortality, body, and presentation contracts instead of hardcoded species or pair lists.",
          "The current forty-three-record catalog preserves the exact thirty-six-record Alpha-37 prefix and appends the Marsh Channel Web as breadth epoch 2. The new cohort may derive conserved Atlantic-menhaden, mummichog, grass-shrimp, and blue-crab aggregates, a greater-yellowlegs flock, one belted kingfisher, and one double-crested-cormorant flock where habitat and exact substrate dependencies support them. Mountain goats form a HERD; common terns, yellowlegs, and cormorants form group-atomic flocks; pikas, capelin, anchovies, ghost crabs, menhaden, mummichog, grass shrimp, and blue crabs remain non-addressable aggregates; golden eagles, Arctic foxes, harbor seals, polar bears, great blue herons, ospreys, and kingfishers remain solitary. Every base, Alpine, polar-shore, cold-shore, polar-consumer, and breadth owner shares one global group-atomic materialization cap of 24 addressable actors. Alpha 38 reaches forty-one of the directive's forty-five core-wildlife profiles but does not complete Directive 04_1, worldwide ecology, or the full bestiary. Role-driven wolf or cougar pursuit may pressure eligible prey, while the only harmful live-animal contact in this build remains exact contact with a currently identified solitary addressable marsh rabbit; every Wave-G addition fails closed outside that path. Player, dog, human, and broader animal mortality remain absent. A boar, wolf, cougar, or brown bear may claim and consume finite resource from an existing body only after lawful sight and reach.",
          "Chickens and goats still have no authored call, track evidence, reproduction, complete schedule, autonomous home return, broad herding behavior, or ecological migration; goat foliage browsing, milk, and wool are also absent. A guardian search can fail or defer and never proves an animal was found. The working dog adds no bark, attack, harmful protection, companion bond, player command, guaranteed recovery, worldwide dog breadth, or cross-region animal ecology.",
          "A lawfully perceived domestic dog can apply generic pressure to an Arctic fox and drive ordinary flee or retreat without a species-pair script; species-directed dog interaction with wild boar, elk, gray wolf, cougar, brown bear, mountain goat, pika, golden eagle, capelin, harbor seal, and polar bear remains an intentional no-response. Direct sight can yield seal-to-capelin conserved nonlethal pressure, polar-bear pursuit with seal flight, or cormorant-to-menhaden conserved pressure, while occlusion removes those response paths. Boar, elk, and wolf voice patterns are foundation-only and not audible; cougar, brown-bear, mountain-goat, pika, golden-eagle, capelin, Arctic-fox, harbor-seal, polar-bear, and every Wave-G species have no new audible Living Voice. Tactical pack combat, new mortality, live-prey capture or exact aggregate-animal targets, seal capture, consumption, sea ice, snow behavior, complete evidence tracking, reproduction, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent and insects, complete sound, general scent propagation, foliage consumption, complete circadian behavior, ecological migration, the final four-profile Wave-G cohort, continuously simulated 3D flight, Directive 04_1 completion, worldwide species breadth and storehouses, and the full bestiary are not live yet.",
          "Shared invariants, signed and extreme-coordinate property checks, conservation rules, and representative visible-versus-ridge-occluded food-web witnesses exercise the reusable scaffold instead of requiring a species-by-species or N² pair matrix. Dedicated Wave-G performance and seamless actor-crossing closure evidence remain open.",
        ].join(" "),
      },
    ],
  },
    ...
    steps: [
      {
        ...
        audience: "all",
        title: "Present in this local candidate",
        body: [
          "One continuous deterministic world, seamless signed-region travel, Chart and Relief, terrain-aware stability, tides, weather, downward Relief rain, river turbulence and ADRIFT recovery, fog and brief terrain memory, deterministic resources, physical cargo, crafting, equipment, Promises, projects, observation-safe EVENTS, persistent humans, ABOUT inspection, one independent dog, and one settlement working dog are live.",
          "The forty-three-record species catalog preserves the exact thirty-six-record Alpha-37 prefix, then appends Atlantic menhaden, mummichog, grass shrimp, blue crab, greater yellowlegs, belted kingfisher, and double-crested cormorant in breadth epoch 2. Lawful empty country remains empty. The first four remain conserved non-addressable aggregates; yellowlegs and cormorants form group-atomic flocks, while the kingfisher is solitary. Yellowlegs require exact grass-shrimp support, kingfishers require mummichog, and cormorants require menhaden. Every earlier ecology layer and habitat gate remains unchanged.",
          "Population lineage remains distinct from present residence. Every base, Alpine, polar-shore, cold-shore, polar-consumer, and breadth owner enters one global group-atomic stable-distance top-K plan capped at twenty-four addressable actors, while authoritative density is measured before that cap; every aggregate consumes no actor slot. Shared tide and density policy moves only conserved aggregate units among authenticated anchors. Yellowlegs reuse anchored wading, kingfishers reuse air-only surface-opportunity and perch behavior, and cormorants use the shared diving-waterbird routine. No new Marsh Channel Web relationship opens a capture, consumption, injury, death, body, item, cargo, player-harm, or dog-harm transaction. The existing mortality path remains limited to a marsh fox, gray wolf, or cougar exactly contacting a currently identified eligible solitary marsh rabbit; every Wave-G addition fails closed outside it.",
          "Chart, Relief, quick inspection, ABOUT, and EVENTS expose only current lawful knowledge, never a hidden census, target, attention state, migration disposition, or retrospective offscreen story. Outer save version 30 and RegionalEcologyStateV6 remain unchanged around the exact RegionalEcologyStateV5 Alpha-36 child plus one append-only sparse breadth root. Valid epoch-1 saves authenticate first and append epoch 2 exactly once at their saved tick; pristine baselines are rederived and only real deviations persist. Habitat version 11 remains sealed compatibility authority, core ecology remains patch version 3, and aggregate ecology remains record version 5. Embedded simulation snapshots remain perception-aware format 4 and rules 6. This Alpha 38 Marsh Channel Web SOURCE_CANDIDATE remains strictly local and unpublished: it has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. The bounded forty-three-record catalog contains forty-one core-wildlife profiles plus the human and domestic-dog foundations. One final coherent four-profile cohort remains before the directive's 45 / 47 catalog boundary and closure gates; this is not worldwide ecology or a complete bestiary. Physical loose provisions, store produce, and finite bodies can be perceived, claimed, and consumed only through current bounded owners. The only current harmful live-animal seam is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit; every Wave-G addition remains outside it. Existing pressure and pursuit examples, including cormorant pressure on menhaden, remain nonlethal. Later sea ice, snow behavior, tactical pack combat, ecological migration, wider aquatic and scavenger relationships, new mortality or capture, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent, insects, broad attack and health systems, audible Living Voice for the newest species, complete scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, continuously simulated 3D flight, and the full bestiary remain planned. Shared invariants, signed and extreme-coordinate properties, conservation, and representative visible-versus-ridge-occluded scenarios exercise the reusable scaffold rather than species-by-species or N² pair tests. Dedicated Wave-G performance and seamless actor-crossing closure evidence remain open; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 48 as const;
