...
export const TUTORIAL_PLANNED_MECHANICS = [
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans remain the current human population. One independently generated dog remains paired with a porter without ownership, while one separate settlement-custodied working dog watches near the existing two-goat herd from its own kennel relationship. The starting settlement separately retains its bounded brown-rat population area and anchored chicken and goat homes; its free-ranging domestic cat is habitat-optional. The current thirty-six-record catalog preserves every Alpha-36 layer and appends one Estuary Surface Break breadth cohort. Suitable estuary habitat may support conserved bay-anchovy and Atlantic-ghost-crab aggregates, one solitary great blue heron, one group-atomic common-tern flock, and one solitary osprey; the three birds require the exact local anchovy substrate. Every layer shares one group-atomic materialization cap, while territory, density, and regional quiet preserve honest absence. Rats, frogs, silversides, fiddler crabs, pikas, capelin, anchovies, and ghost crabs are conserved aggregates; eligible larger wildlife use bounded persistent representatives. The only current animal mortality remains exact contact by a marsh fox, gray wolf, or cougar against one identified eligible solitary marsh rabbit. The new cohort adds no capture, kill, consumption, mortality, body, player harm, dog harm, or human harm. Additional Wave-G cohorts, Directive 04_1 completion, worldwide ecology, reproduction, population recovery, broader attacks, audible Living Voice, sea ice, snow behavior, general scent and evidence tracking, rumors, companions, complete circadian life, foliage browsing, herding, and the full bestiary remain planned.",
...
export const TUTORIAL_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: "whats-new-estuary-surface-break",
        audience: "all",
        title: "The estuary surface breaks",
        body: "Alpha 37 Estuary Surface Break is this local unpublished SOURCE_CANDIDATE; it has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED. It preserves Alpha 36 as the exact thirty-one-record RegionalEcologyStateV5 and outer-version-29 child, then appends bay anchovy, Atlantic ghost crab, great blue heron, common tern, and osprey as records 32 through 36 in one habitat-gated breadth cohort. Anchovies and ghost crabs remain conserved non-addressable aggregates; heron and osprey are solitary persistent individuals, while two to four terns form one group-atomic flock. Terrain, salinity, carrying capacity, territory, density, regional quiet, and exact anchovy prey support decide admission, so unsupported estuary country remains honestly empty. The shared Tide Table keeps anchovies in usable submerged schooling water and exposes ghost-crab activity on suitable tidal flat without creating exact fish or crabs. Authenticated shared neutral activity lets a heron fly to its tide-depth-safe wading ground to wait, scan, or search, while terns and ospreys reuse an air-only surface-opportunity and rest loop; immediate danger still wins. Chart, Relief, quick inspection, and ABOUT reveal only lawful current identities or aggregate evidence on desktop and touch. RegionalEcologyStateV6 wraps the exact V5 child beside one append-only sparse breadth root, and outer save version 30 authenticates one sealed outer-version-29 Alpha-36 save for exact-once adoption. All six ecology layers share one global group-atomic cap of twenty-four addressable actors and one atomic commit. One representative visible-versus-ridge-occluded common-tern and anchovy scenario exercises the reusable interaction seam with exact aggregate conservation. This opens Wave G with one cohort; it does not complete Wave G or Directive 04_1 and adds no sound, capture, consumption, mortality, reproduction, full circadian life, or continuous 3D flight physics. Dedicated Wave-G performance and seamless actor-crossing proof remain open.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Across the signed world, terrain and habitat derive each local population from carrying capacity, food or prey support, territory, and density rather than forcing a fixed roster. The mixed-resolution model records capacity, population pressure, and trend while materializing only a bounded set of representatives; a species with too little support is genuinely absent instead of being rerolled. When present in numbers, deer, elk, and mountain goats persist in herds, gulls, fish crows, and common terns in flocks, wild boar in sounders, and gray wolves in packs. The starting settlement separately retains one stable two-to-three-member domestic-chicken flock, exactly two domestic goats in one herd, and one additional seed-stable working dog under settlement custody; these are homes and relationships, not wild habitat populations. Black bears, cougars, brown bears, northern harriers, golden eagles, Arctic foxes, harbor seals, polar bears, great blue herons, and ospreys stay solitary. Snowy egrets, American black ducks, and habitat-supported North American river otters also use persistent individual identities. Free-ranging domestic cats, marsh rabbits, and marsh foxes use persistent individual representatives. Brown rats, southern leopard frogs, Atlantic silversides, Atlantic marsh fiddler crabs, American pikas, Atlantic capelin, bay anchovies, and Atlantic ghost crabs remain conserved population-area or school aggregates and never become clouds of fake actors. One global group-atomic plan selects the nearest 24 eligible individuals across every active base, Alpine, polar-shore, cold-shore, polar-consumer, and breadth ecology owner while every overflow actor remains preserved in coarse state.",
      },
      {
      ...
      },
      {
        ...
        body: "The original six neutral-activity archetypes remain exact, and later shared extensions bring the current registry to eight reusable archetypes serving eleven species. Each profile must match the actor's real capabilities, allowed movement media, authenticated destination, observation boundary, visible signal, and bounded daylight/rest scope. Golden eagle retains ridge-soar/perch, harbor seal reuses authenticated shore-water foraging, and great blue heron adds anchored-wader behavior at one tide-depth-safe wading ground. Gull, common tern, and osprey share aerial-surface-opportunist behavior: only a current anonymous terrain-occluded AQUATIC ACTIVITY observation can draw one from its habitat anchor to circle by air, and it returns to an authenticated anchor for rest. That profile grants no swimming, wading, exact fish target, capture, or consumption. Any immediate lawful threat, escape, alarm, food, guard, pursuit, retreat, or scavenging intent outranks neutral activity. These are bounded daylight/rest routines, not full circadian life or continuously simulated 3D flight.",
      },
      {
        id: "shadow-overhead",
        audience: "all",
      ...
      },
      {
        ...
        body: "A directly visible deer, gull, black bear, domestic cat, domestic chicken, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, golden eagle, Arctic fox, harbor seal, polar bear, great blue heron, common tern, or osprey offers WAIT AND WATCH, ROUTE AROUND THIS SPOT, and LEAVE. WAIT briefly stops the current automatic route. ROUTE AROUND must keep the same destination and find a real line outside the observed animal's area; if that fails, your previous route and choice history remain unchanged. LEAVE closes the observation rather than moving the animal. Rat, frog, silverside, fiddler-crab, pika, capelin, anchovy, and ghost-crab sign ABOUT is close-only because a population sign is not an actor; rabbit and fox movement signs are not targetable.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: [
          "The seven Wave-B roles, Wave-C tidal roles, bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices, the five Alpha-30/31 additions, the Alpine triad, the polar-shore forage school, one cold-shore Arctic fox, the polar-consumer seal-and-bear vertical, and the five-profile Estuary Surface Break cohort now feed the same role, perception, movement, group, aggregate, ridge-activity, tide, amphibious-activity, physical-item, plural-custody, typed-home, working-assignment, recovery, mortality, body, and presentation contracts instead of hardcoded species or pair lists.",
          "The current thirty-six-record catalog preserves the exact thirty-one-record Alpha-36 prefix and its signed-region, Alpine, polar-shore, cold-shore, and polar-consumer layers, then appends one sparse breadth root. That root may derive conserved bay-anchovy and Atlantic-ghost-crab aggregates, a solitary great blue heron, one common-tern flock, and a solitary osprey where estuary habitat and exact prey dependencies support them. Mountain goats form a HERD; common terns form one group-atomic flock; pikas, capelin, anchovies, and ghost crabs remain non-addressable aggregates; and golden eagles, Arctic foxes, harbor seals, polar bears, great blue herons, and ospreys remain solitary. Every base, Alpine, polar-shore, cold-shore, polar-consumer, and breadth owner shares one global group-atomic materialization cap of 24 addressable actors. Alpha 36 completed the directive's bounded Wave-F role coverage; Alpha 37 opens Wave G with one cohort but does not complete Wave G, Directive 04_1, worldwide ecology, biodiversity breadth, or the full bestiary. Role-driven wolf or cougar pursuit may pressure eligible prey, while the only harmful live-animal contact in this build remains exact contact with a currently identified solitary addressable marsh rabbit; grouped elk, grouped deer, every social-group member, all Alpine species, capelin, Arctic fox, harbor seal, polar bear, and every Estuary Surface Break addition cannot be harmed. Brown bear, golden eagle, Arctic fox, harbor seal, polar bear, great blue heron, common tern, and osprey have no harmful live-prey contact. Player, dog, human, and broader animal mortality remain absent. A boar, wolf, cougar, or brown bear may claim and consume finite resource from an existing body only after lawful sight and reach.",
          ...
          "A lawfully perceived domestic dog can apply generic pressure to an Arctic fox and drive ordinary flee or retreat without a species-pair script; species-directed dog interaction with wild boar, elk, gray wolf, cougar, brown bear, mountain goat, pika, golden eagle, capelin, harbor seal, and polar bear remains an intentional no-response. Direct sight can yield seal-to-capelin conserved nonlethal pressure or polar-bear pursuit with seal flight, while occlusion removes both response paths. Boar, elk, and wolf voice patterns are foundation-only and not audible; cougar, brown-bear, mountain-goat, pika, golden-eagle, capelin, Arctic-fox, harbor-seal, polar-bear, bay-anchovy, Atlantic-ghost-crab, great-blue-heron, common-tern, and osprey voice behavior is not implemented. Tactical pack combat, new mortality, live-prey capture or exact pika, capelin, anchovy, or ghost-crab targets, seal capture, consumption, sea ice, snow behavior, complete evidence tracking, reproduction, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent and insects, complete sound, general scent propagation, foliage consumption, complete circadian behavior, ecological migration, later Wave-G cohorts, continuous 3D flight physics, Directive 04_1 completion, worldwide species breadth and storehouses, and the full bestiary are not live yet.",
          "Shared invariants, signed and extreme-coordinate property checks, conservation rules, and one representative visible-versus-ridge-occluded common-tern and anchovy scenario exercise this cohort's reusable scaffold instead of requiring a species-by-species or N² pair matrix. Dedicated Wave-G performance and seamless actor-crossing proof remain open.",
        ].join(" "),
      },
    ],
  },
    ...
    steps: [
      {
        ...
        body: [
          ...
          "Outer save version 30 adds RegionalEcologyStateV6. Its first child is the exact RegionalEcologyStateV5 Alpha-36 composite, preserving the complete V5 base, Alpine, polar-shore, cold-shore, and polar-consumer lineage and, through it, every exact earlier Open Country Ledger and Coldwater Glint adoption. Habitat version 11 remains sealed compatibility authority, core-ecology patch version 3, aggregate ecology record version 5, settlement ecology version 4, and working-animal state version 2 remain unchanged. One separate version-1 sparse breadth root owns only cohort activations and genuine Estuary Surface Break resident deviations; the exact V5 child still owns capelin, Arctic fox, harbor seal, and polar bear.",
    ...
    steps: [
      {
        ...
        body: [
          ...
          "The thirty-six-record species catalog preserves the exact thirty-one-record Alpha-36 prefix and its Open Country Ledger, Alpine, polar-shore, cold-shore, and polar-consumer layers, then appends one Estuary Surface Break breadth cohort. Lawful empty country remains empty. Suitable estuary habitat may contain one conserved non-addressable bay-anchovy school, one conserved Atlantic-ghost-crab shore aggregate, one solitary great blue heron, one common-tern flock, and one solitary osprey; every bird population requires the exact local anchovy substrate. The earlier capelin, Arctic fox, harbor seal, polar bear, Alpine triad, settlement animals, and habitat gates remain unchanged.",
          "Population lineage remains distinct from present residence. Every base, Alpine, polar-shore, cold-shore, polar-consumer, and breadth owner enters one global group-atomic stable-distance top-K plan capped at twenty-four addressable actors, while authoritative density is measured before that cap; aggregate capelin, anchovies, and ghost crabs consume no actor slot. Shared tide and density policy moves only conserved aggregate units among authenticated anchors. Bay-anchovy activity needs usable submerged water, while ghost-crab signs favor exposed tidal flat. No new Estuary Surface Break relationship opens a capture, consumption, injury, death, body, item, cargo, player-harm, or dog-harm transaction. The existing mortality path remains limited to a marsh fox, gray wolf, or cougar exactly contacting a currently identified eligible solitary marsh rabbit; every Wave-G addition fails closed outside it.",
          "Chart, Relief, quick inspection, ABOUT, and EVENTS expose only current lawful knowledge, never a hidden census, target, attention state, migration disposition, or retrospective offscreen story. Outer save version 30 adds RegionalEcologyStateV6 around the exact RegionalEcologyStateV5 Alpha-36 child plus one append-only sparse breadth root, and authenticates one sealed outer-version-29 Alpha-36 world for exact-once adoption. Pristine baselines are rederived and only real deviations persist. Habitat version 11 remains sealed compatibility authority, core ecology remains patch version 3, and aggregate ecology remains record version 5. Embedded simulation snapshots remain perception-aware format 4 and rules 6. This Alpha 37 Estuary Surface Break SOURCE_CANDIDATE remains strictly local and unpublished: it has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. The bounded thirty-six-record catalog includes every completed Wave-F layer plus the first five-profile Wave-G estuary cohort. This opens Wave G but does not complete Wave G, Directive 04_1, the approximately seventy-five-profile breadth target, worldwide ecology, or a complete bestiary. Physical loose provisions, store produce, and finite bodies can be perceived, claimed, and consumed only through current bounded owners. The only current harmful live-animal seam is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit; Alpine species, capelin, Arctic foxes, harbor seals, polar bears, brown bears, grouped animals, players, humans, dogs, and every Wave-G addition cannot enter this harmful ecology path. Golden-eagle pressure on pikas, visible Arctic-fox or harbor-seal pressure on capelin, and visible polar-bear pursuit with seal flight remain nonlethal. Bay anchovies and Atlantic ghost crabs respond to the shared Tide Table as conserved aggregates; the new heron, tern, and osprey profiles use bounded shared neutral activity but have no harmful predation outcome. Later breadth cohorts, sea ice, snow behavior, tactical pack combat, ecological migration behavior, wider aquatic and scavenger relationships, new mortality or capture, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent, insects, broad attack and health systems, audible Living Voice for the newest species, complete scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, continuous 3D flight physics, remaining worldwide polar breadth, and the full bestiary remain planned. Shared invariants, signed and extreme-coordinate properties, conservation, and one representative visible-versus-ridge-occluded common-tern and anchovy scenario exercise this cohort's reusable scaffold rather than species-by-species or N² pair tests. Dedicated Wave-G performance and seamless actor-crossing proof remain open; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 47 as const;
