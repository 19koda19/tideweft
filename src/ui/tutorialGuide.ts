  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Beyond the Harbor adds wild boar, elk, and gray wolf to one deterministic remote temperate-upland and forest-edge source beyond the compatibility harbor. The twenty-two-record catalog gives them stable populations and individual representatives, with boar in a SOUNDER, elk in a HERD, and wolves in a PACK through the same shared group and bounded materialization owners. All three use shared direct perception, attention, and actor-owned locomotion. A gray wolf may create role-driven pursuit pressure, but only a solitary addressable marsh rabbit can receive the current exact-contact injury or mortality transaction; grouped elk, deer, and every other group member cannot be harmed. A wild boar may feed from an existing physical body only after it currently sees and reaches that exact body, wins its claim, and consumes one unit from the finite conserved resource. Chart, Relief, quick inspection, and ABOUT expose the same current knowledge without a hidden census, target, offscreen event, or retrospective story. Outer save 23 adopts one sealed version-22 What Remains world exactly once: the complete habitat-version-9 prefix and body-bearing state remain exact before habitat version 10 appends the remote source and new populations/groups. Shared representative, property, conservation, and bounded-performance checks validate the reusable architecture without species-by-species or N² pair testing. Dog interaction with these three species is an intentional no-response and remains unimplemented. Their authored voice patterns are foundation-only and not audible. Tactical pack combat, group-member mortality, cougar, additional bear ecotypes, ecological migration, worldwide ecology, and full Wave E remain absent.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "One seed-stable source is selected from a bounded ring beyond the compatibility harbor, using meadow and ridge signals for a temperate-upland and forest-edge assemblage. Wild boar, elk, and gray wolf receive stable populations and exact representatives there; eligible boar form a SOUNDER, elk a HERD, and wolves a PACK through the shared group owner. They use the same current direct perception, attention, locomotion, and full-or-coarse materialization rules as established wildlife. A wolf may pursue eligible prey by role, but only a solitary addressable marsh rabbit can enter today's exact-contact mortality transaction. Grouped elk, grouped deer, and every other social-group member cannot be injured or killed. Wolves do not coordinate tactical pack attacks. A boar may scavenge an existing body only after seeing it, reaching it, and winning the conserved physical claim. This source does not create ecological migration or worldwide animal coverage.",
      },
      {
      ...
      },
      {
        ...
        body: "If direct fox contact kills an individual marsh rabbit, that exact actor retires once and exactly one population unit is removed. Any other abstract units it represented remain reserve. One stable physical carcass remains at the death place with a finite conserved resource. A fox or fish crow must lawfully see and physically reach that same body before feeding; each meal consumes one unit, and a fox may guard its claim. Chart, Relief, and EVENTS reveal only what you currently perceive: finding a body later does not tell you who killed it, why, what happened offscreen, who claimed it, or how much remains.",
      },
      {
        id: "marsh-edge-about",
        audience: "all",
    ...
    callouts: [
      ...
      },
      {
        ...
        body: [
          ...
          "The remote source adds wild boar, elk, and gray wolf through SOUNDER, HERD, and PACK, but does not create storage, livestock, recovery, or animal ecology in every settlement or distant region. Role-driven wolf pursuit may pressure eligible prey, while the only harmful live-animal contact in this build remains exact contact with a solitary addressable marsh rabbit; grouped elk, grouped deer, and every other social-group member cannot be harmed. Player, dog, human, and broader animal mortality remain absent. A boar may claim and consume finite resource from an existing body only after lawful sight and reach.",
          ...
          "Dog interaction with wild boar, elk, and gray wolf is an intentional no-response and remains unimplemented. Their voice patterns are foundation-only and not audible. Tactical pack combat, cougar and additional bear ecotypes, population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent and insects, complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, worldwide populations and storehouses, the rest of Wave E, and the full bestiary are not live yet.",
    ...
    steps: [
      {
        ...
        body: [
          ...
          "Outer save version 23 preserves core-ecology patch version 3, aggregate ecology record version 5, settlement ecology version 4, working-animal state version 2, every earlier population, actor, group, item, Promise, home, relationship, task, recovery case, store fact, world fact, and the authoritative mortality, population-reserve, and physical-body ledgers.",
          "A sealed version 22 What Remains save migrates exactly once: its complete habitat-version-9 record and body-bearing state remain exact before habitat version 10 appends the remote upland source, wild-boar, elk, and gray-wolf populations, and eligible SOUNDER, HERD, and PACK records.",
          "Re-saving and reloading cannot reroll that source; duplicate or renumber an actor, population, group, or allocation; rewrite an existing injury or death; resurrect a retired actor; remove a second population unit; duplicate or move a body; restore consumed resource; replay a claim or meal; or turn an unseen incident into player knowledge. Existing working-animal and domestic-recovery transitions still recover exactly once without repeating perception, movement, handler authority, or outcome.",
        ].join(" "),
      },
      {
    ...
    steps: [
      {
        ...
        body: [
          ...
          "The twenty-two-record species catalog retains the bounded starting-harbor ecology and adds wild boar, elk, and gray wolf in one deterministic remote temperate-upland and forest-edge source. Stable SOUNDER, HERD, and PACK groups compose shared perception, attention, actor-owned locomotion, group, physical-resource, and bounded materialization owners.",
          "A wolf may create role-driven pursuit pressure, but only exact contact with a solitary addressable marsh rabbit can enter the current mortality transaction; grouped elk, deer, and all other group members cannot be harmed. A boar can see, reach, claim, and consume from an existing finite physical body through the same conserved aftermath rules.",
          "Chart, Relief, quick inspection, ABOUT, and EVENTS expose only current lawful knowledge, never a hidden census, target, or retrospective offscreen story. Outer save version 23 adopts a sealed version-22 What Remains world exactly once, retaining its complete habitat-version-9 prefix and body-bearing state before habitat version 10 appends the remote source and new populations/groups. Core ecology remains patch version 3 and aggregate record version 5. Embedded simulation snapshots remain perception-aware format 4 and rules 6. Perpetual play remains active.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. Physical loose provisions, store produce, and finite bodies can be perceived, claimed, and consumed only through their current bounded owners. Role-driven gray-wolf pursuit may pressure eligible prey, but the only current harmful live-animal seam remains exact contact with a solitary addressable marsh rabbit. Grouped elk, grouped deer, and every other group member cannot be harmed. Dog interaction with the three upland species is an intentional no-response, and their voice patterns are not yet audible. Tactical pack combat, cougar, additional bear ecotypes, ecological migration, worldwide ecology, wider aquatic and scavenger relationships, broader mortality, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent, insects, broad attack and health systems, complete sound, general scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, and the full bestiary remain planned. Shared invariants, deterministic properties, conservation, bounded fuzzing and performance, and representative emergent scenarios validate the reusable scaffold rather than species-by-species or N² pair tests; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 40 as const;
