  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "Many rhythms",
        body: "Alpha 50 · Many Rhythms is a local unpublished source candidate. The circadian registry now exactly covers all seventeen current wildlife activity profiles through one shared arrival-gated routine contract. Fish crow, northern harrier, American black duck, gull, golden eagle, harbor seal, great blue heron, common tern, osprey, greater yellowlegs, belted kingfisher, double-crested cormorant, seaside sparrow, and diamondback terrapin retain day-active base clocks; North American river otter remains night-active; snowy egret remains adaptive to clock, tide, and current lawful opportunity; marsh rabbit remains twilight-active. American black duck also composes current weather: qualifying ordinary rain may activate it outside its base clock window, while a dangerous storm drives physical travel to and rest at its authenticated refuge. The duck, river otter, greater yellowlegs, and diamondback terrapin keep clock-based wake policy; their existing action and destination projections remain tide- and depth-responsive only where dabbling water, foraging water, wading ground, or wet margin is physically usable. Tide does not independently wake them. A dry terrapin margin remains an awake tide wait rather than falsely presenting rest while its clock profile prefers activity. The thirteen formerly bounded day-window profiles now declare truthful circadian-activity capability and circadian-routine scope. All twelve reusable activity archetypes use their existing authenticated perch, refuge, habitat anchor, wading ground, haulout, or cover and their already-declared air, amphibious, surface-water-capable, or land locomotion. Transit remains Awake; physical arrival alone permits Resting, and the shared settling interval alone permits Asleep. STARTLED response, current danger, lawful disturbance, urgent needs, and retained commitments still win. No profile receives a private scheduler, detector, pathfinder, or teleport, and routine travel mints no unsupported track evidence, food, feeding result, target, knowledge, or choice. Direct inspection may show only a lawfully observed current activity or posture, never hidden policy, phase, destination, wake threshold, or private target. Southern leopard frog separately remains a real non-addressable rain-responsive aggregate: rain can raise its lawful activity and chorus while masking hearing, but no individual frog actor, destination, posture, or circadian binding is fabricated. No species, actor, population unit, habitat allocation, encounter density, item, cargo, attack, mortality path, or reward is added. Outer save version 32, RegionalEcologyStateV6, and wildlife actor schema/version 1 remain unchanged. The current catalog derives rhythm and cadence from the shared binding registry while frozen Alpha 32 through Alpha 39 catalogs retain their exact historical bytes and hashes. The existing optional wildlife circadian receipt remains unchanged; legacy absence remains valid, full detail reauthenticates current body and destination before use, and coarse absence may conserve only an already committed bounded rest bout without inventing travel or decisions. This exact seventeen-profile boundary is not all forty-five wildlife profiles, complete driver coverage, validated broad coarse-time advancement, complete autonomous animal life, or Turning Day closure. The candidate has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED; Alpha 39 remains the latest verified public release.",
      },
    ],
    callouts: [
      {
...
export const TUTORIAL_CONTENT_VERSION = 60 as const;
