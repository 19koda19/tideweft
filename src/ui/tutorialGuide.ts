  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "The far paddock",
        body: "The Far Paddock adds exactly two individual domestic goats in one persistent herd at a habitat-derived pen separated from the storehouse yard and prior animal placements. They reuse the Living Weft's direct perception, attention, terrestrial movement, broad ecological roles, and group alarm instead of receiving goat-only AI. Settlement ecology now supports several canonical custody relationships and typed coop or pen homes while preserving the chickens' existing flock, keeper, coop, and physical store-food behavior. Goats do not claim those provisions, and foliage browsing is not live yet. Shared resource contention is settled by physical reach, current need, and stable identity rather than source order. Chart, Relief, quick inspection, and ABOUT reveal only directly visible goats. Outer save 18 adopts one sealed version-17 world exactly once, appending habitat 9 and settlement ecology 3 while preserving the earlier habitat, flock, home, store, items, Promises, and world facts. Shared invariants, signed-coordinate properties, conservation, deterministic migration, bounded performance, and representative composition validate the architecture—there is no species-by-species or N² pair matrix. This is one local herd and flock, not worldwide livestock, foliage browsing, herding, guardian behavior, schedules, mortality, carcasses, milk, wool, reproduction, the full bestiary, or completed Directive 04_1.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Near the stable starting harbor, terrain and habitat derive each local population rather than forcing a fixed roster. The mixed-resolution model records capacity, population pressure, and trend while materializing only a bounded set of representatives; a species with too little support is genuinely absent instead of being rerolled. When present in numbers, deer persist in herds, gulls in flocks, and up to three fish-crow representatives in one CROW-FLOCK. One storehouse-yard anchor supports exactly one stable two-to-three-member domestic-chicken flock, while a deliberately separated pen supports exactly two domestic goats in one HERD; every bird and goat retains its own identity inside the group. Black bears and the northern harrier stay solitary; at most one snowy egret, American black duck, and habitat-supported North American river otter use persistent individual identities. Free-ranging domestic cats, marsh rabbits, and marsh foxes also use persistent individual representatives. Brown rats, southern leopard frogs, Atlantic silversides, and Atlantic marsh fiddler crabs remain conserved population-area or school aggregates and never become clouds of fake actors. When more individuals are eligible than the active field can hold, deterministic distance and stable identity select the nearest 24 while every overflow actor remains preserved in coarse state.",
      },
      {
      ...
      },
      {
        ...
        audience: "all",
        title: "The flock uses the same living rules",
        body: "Two or three domestic chickens share one stable flock, coop, and settlement-custody relationship around the storehouse yard. Exactly two domestic goats share a different herd, pen, and custody relationship. Both groups use ordinary animal senses, attention, group alarm, terrain movement, and broad ecological roles rather than private detection or pair scripts. A hungry chicken can investigate the exact open-store lot, walk into its structural access area, and consume one physical unit through a staged transaction. A goat cannot claim that store lot, and foliage browsing is not active yet. When lawful animals compete for the same physical resource, reach, current need, and stable identity settle one winner. A secured store cannot become food knowledge or a claim. You receive a feeding event only when it is directly in view at that moment; later sight does not reveal it retroactively.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "The seven Wave-B roles, Wave-C tidal roles, and first Wave-D flock-and-herd slices remain one bounded habitat-derived integration near the stable starting harbor. The Tide Table, one-duck waterfowl unit, one-otter amphibious unit, reusable activity profiles, Storehouse Door, domestic chickens, and domestic goats share versioned role, perception, movement, group, aggregate, tide, physical-item, plural-custody, typed-home, and presentation contracts instead of hardcoded species or pair lists. The Storehouse Door, Yard Flock, and Far Paddock do not create storage or livestock ecology in every settlement. This does not create ecology in every distant region or complete Directive 04_1. Animals do not attack, receive injuries, die, leave carcasses, or consume live prey in this build. Chickens and goats have no authored call, track evidence, reproduction, complete schedule, autonomous home return, guardian behavior, herding behavior, or cross-region migration; goat foliage browsing, milk, and wool are also absent. Complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, wider livestock, further species, wider aquatic and scavenger ecology, worldwide populations and storehouses, and the full bestiary are not live yet. Shared invariants, property and bounded-fuzz checks, conservation rules, performance budgets, and representative emergent interactions test the reusable scaffold instead of requiring a species-by-species or N² pair matrix.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "The game maintains one local autosave, using browser storage with a fallback. It saves periodically, when the page hides or closes, when the title opens, and when Quiet Hour begins. Outer save version 18 preserves habitat version 9, aggregate ecology record version 4, settlement ecology version 3, all four aggregate populations and their signs, persistent herds and flocks, bounded representatives and their saved intent, tidal, waterfowl, otter, domestic-yard, and domestic-pen anchors, the durable tide-operation clock, deterministic top-K materialization state, movement evidence, physical food history, and the starting-harbor store's plural domestic custody and food-use history. A sealed version 17 Yard Flock save migrates exactly once: every established habitat-8 population and anchor, actor, group, aggregate unit, store and lot identity, chicken relationship and coop identity, closure, loss event, item, Promise, custody record, disturbance, evidence record, and world fact stays exact before the two-goat herd, pen, and second custody relationship are appended. The store lot remains distinct from abstract settlement food, and goats cannot claim it. Re-saving and reloading cannot reroll a chicken, goat, or anchor, duplicate a group or provision, assign one group to two homes, reopen a secured door, replay a store loss, chicken meal, or tidal-edge opportunity, exceed the 24-actor materialization cap, or rewrite older ecology.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 35 as const;
