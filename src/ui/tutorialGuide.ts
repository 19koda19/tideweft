...
export const TUTORIAL_PLANNED_MECHANICS = [
  {
    ...
    clarification: "Terrain now continues seamlessly beyond the original harbor country. Its authored harbors, Promise economy, and natural material patches remain local to that known estuary. Generated distant settlements, humans, dogs, Promise economies, causal finds, and extension of living-network services are planned rather than cloned into empty country. Bounded signed-region wildlife already appears only where authenticated habitat supports it; this does not imply seamless actor migration between regions.",
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans, independent porter-scene dog, settlement working dog, bounded domestic groups, and every earlier wildlife layer remain intact. The current forty-seven-record catalog contains exactly forty-five core-wildlife profiles plus the separate human and domestic-dog foundations. Saltmarsh Small Worlds appends conserved eastern-saltmarsh-mosquito and marsh-periwinkle aggregates, one group-atomic seaside-sparrow flock, and one solitary diamondback terrapin through breadth epoch 3. Sparrow admission depends on the local mosquito substrate and terrapin admission on periwinkle; territory, density, and regional quiet preserve honest absence. Every layer still shares one group-atomic materialization cap. The only current animal mortality remains exact contact by a marsh fox, gray wolf, or cougar against one identified eligible solitary marsh rabbit. The final cohort adds no bites, disease, capture, consumption, mortality, body, player harm, dog harm, or human harm. Worldwide ecology, reproduction, population recovery, broader attacks, audible Living Voice, sea ice, snow behavior, general scent and evidence tracking, rumors, companions, complete circadian life, foliage browsing, herding, and the full bestiary remain planned.",
    keywords: ["npc", "dog", "cat", "rat", "rabbit", "fox", "Arctic fox", "crow", "harrier", "frog", "silverside", "fiddler crab", "snowy egret", "American black duck", "North American river otter", "otter", "waterfowl", "mountain goat", "American pika", "golden eagle", "harbor seal", "polar bear", "bay anchovy", "Atlantic ghost crab", "great blue heron", "common tern", "osprey", "haulout", "talus", "alpine", "chicken", "domestic", "livestock", "bear", "bird", "wildlife", "companion", "identity", "about", "perception", "ecology", "habitat", "population", "herd", "flock", "school", "chorus", "signs", "pursuit", "tide", "surface water", "amphibious", "flight"],
  },
  {
...
export const TUTORIAL_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Alpha 52 · Rest Between Harbors is a local unpublished source candidate. All forty-two current original-estuary residents retain the same saved day-active living-circadian contract and stable identity-derived timing. A contract-free person physically present at any existing settlement may now settle, become Asleep after the shared interval, recover, and wake through the one civil clock. Their home identity anchors reciprocal settlement-network membership, while their actual current location alone says which refuge they occupy. A resident courier still accepts real Promise cargo at its origin, travels the actual route, conserves and delivers that cargo, and remains the same person at the destination. A later onward or reverse Promise can select that physically present visitor and route them again; there is no automatic return, invisible commute, or teleport. Active Promise work, route travel, the keeper's authenticated response duty, storms, urgent needs, current identified, alert, or searching attention, and strong lawful disturbance retain priority. Leaving settlement refuge or accepting work wakes a resting visitor. The runtime still prepares the complete bounded resident roster before committing any receipt. Loading and saving alone invents no travel; an Alpha 51 Awake or STARTLED foreign visitor with the former home-only arrival flag receives no free recovery and reconciles on the next ordinary tick, while impossible false-arrival Resting or Asleep state remains invalid. No house, room, guest bed, interior, guaranteed backhaul, or individual production shift is invented. Chart, Relief, quick inspection, and ABOUT may show Resting or Asleep only for a directly observed resident whose body is actually at a settlement and still hide schedule timing, phase, thresholds, reciprocal-network identity, exact needs, private attention, and unseen people. The existing settlement working dog remains the current relationship-bearing domestic-dog continuity witness. No bonded, named player companion exists yet. Outer save version 32 and simulation format 4 remain unchanged, including the exact existing resident receipt bytes. Current human breadth remains forty-two residents in the original compatibility region, not infinite human generation or autonomous settlement home life. Final multi-day CPU and save-growth evidence, automatic WAIT-interruption and frame-cadence witnesses, upgraded packaged desktop and mobile parity checks, cumulative validation, and the Turning Day release checkpoint remain before Breathing Room begins. This candidate has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED; Alpha 39 remains the latest verified public release.",
      },
    ],
    callouts: [
      {
        ...
        audience: "all",
        tone: "boundary",
        title: "Only implemented candidate behavior belongs here",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Procedural terrain, water, weather, footing, Wayknots, carried cargo, loose-parcel drift, local saves, and the current bounded wildlife catalog continue beyond the old map extent. Currents and terrain carry the same recoverable object onward without changing its identity, condition, momentum, history, or Promise custody. Habitat throughout the continuous world may support an existing wild population or honest absence, while the original settlement retains its bounded home animals. Generated distant settlements and humans, broader species breadth, causal wilderness finds, and natural material patches are not live yet.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    summary: "The original harbor country's 42 humans, its first independent dog, settlement-home animals, signed-region wildlife, sparse Alpine and polar life, and directly observed aggregate-population signs use one knowledge-honest boundary; ABOUT reveals only what you can see or have learned.",
    keywords: ["person", "resident", "porter", "dog", "cat", "rat", "rabbit", "fox", "crow", "harrier", "frog", "silverside", "fiddler crab", "snowy egret", "American black duck", "duck", "waterfowl", "North American river otter", "otter", "wild boar", "boar", "elk", "gray wolf", "wolf", "cougar", "brown bear", "mountain goat", "American pika", "golden eagle", "harbor seal", "polar bear", "haulout", "alpine", "talus", "ridge", "sounder", "pack", "temperate upland", "forest edge", "amphibious", "diving", "chorus", "quartering", "wading", "dabbling", "surface swimming", "flight", "soaring", "perch", "mobbing", "pursuit", "paired tracks", "pawprints", "burrows", "haypile", "surface dimples", "signs", "deer", "gull", "black bear", "wildlife", "alarm", "food", "scavenge", "scent", "help", "wait", "reroute", "leave", "persistence", "npc", "about", "inspect", "greet", "observed", "known", "identity", "emotion", "weather", "vision", "hearing", "attention", "search", "habitat", "population", "herd", "flock", "school", "tide", "shallow water", "aftermath", "absence", "materialization"],
    ...
    steps: [
      {
        ...
        body: "Click or tap a directly visible resident, traveling porter, dog, deer, gull, black bear, domestic cat, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, golden eagle, Arctic fox, harbor seal, polar bear, great blue heron, common tern, osprey, greater yellowlegs, belted kingfisher, double-crested cormorant, brown-rat sign, frog-population sign, silverside-school sign, fiddler-crab sign, American-pika talus sign, capelin surface sign, bay-anchovy sign, Atlantic-ghost-crab sign, Atlantic-menhaden school sign, mummichog sign, grass-shrimp sign, or blue-crab sign. ABOUT closes when that actor or sign leaves exact sight; it is a live field observation, not a remote tracker. Several visible members may be summarized with the same approximate visible group count shown in the world, without revealing animals outside your sight. The black duck, otter, cougar, brown bear, golden eagle, Arctic fox, harbor seal, polar bear, great blue heron, osprey, and kingfisher are each one addressable individual rather than a group, while aggregate evidence never invents an individual rat, frog, fish, crab, pika, capelin, anchovy, ghost crab, menhaden, mummichog, or grass shrimp.",
      ...
      },
      {
        ...
        body: "Across the signed world, terrain and habitat derive each local population from carrying capacity, food or prey support, territory, and density rather than forcing a fixed roster. The mixed-resolution model records capacity, population pressure, and trend while materializing only a bounded set of representatives; a species with too little support is genuinely absent instead of being rerolled. When present in numbers, deer, elk, and mountain goats persist in herds; gulls, fish crows, common terns, greater yellowlegs, double-crested cormorants, and seaside sparrows in flocks; wild boar in sounders; and gray wolves in packs. The starting settlement separately retains one stable two-to-three-member domestic-chicken flock, exactly two domestic goats in one herd, and one additional seed-stable working dog under settlement custody; these are homes and relationships, not wild habitat populations. Black bears, cougars, brown bears, northern harriers, golden eagles, Arctic foxes, harbor seals, polar bears, great blue herons, ospreys, belted kingfishers, and diamondback terrapins stay solitary. Snowy egrets, American black ducks, and habitat-supported North American river otters also use persistent individual identities. Free-ranging domestic cats, marsh rabbits, and marsh foxes use persistent individual representatives. Brown rats, southern leopard frogs, Atlantic silversides, Atlantic marsh fiddler crabs, American pikas, Atlantic capelin, bay anchovies, Atlantic ghost crabs, Atlantic menhaden, mummichog, grass shrimp, blue crabs, eastern saltmarsh mosquitoes, and marsh periwinkles remain conserved population-area, school, or activity aggregates and never become clouds of fake actors. One global group-atomic plan selects the nearest 24 eligible individuals across every active base, Alpine, polar-shore, cold-shore, polar-consumer, and breadth ecology owner while every overflow actor remains preserved in coarse state.",
      },
      {
        id: "wildlife-regional-upland",
        audience: "all",
        title: "Open country adds pressure, not omniscience",
        body: "Wild boar, elk, gray wolf, cougar, and brown bear now use the same deterministic signed-region habitat and density rules as the rest of the current wild catalog; Alpha-30/31's one remote source remains only as sealed compatibility history. Eligible boar form a SOUNDER, elk a HERD, and wolves a PACK, while cougar and brown bear remain solitary. All use the same current direct perception, attention, locomotion, and full-or-coarse materialization rules as established wildlife. A wolf or cougar may pursue eligible prey by role, but only a currently identified solitary addressable marsh rabbit can enter today's exact-contact mortality transaction. Grouped elk, grouped deer, and every other social-group member cannot be injured or killed. Brown bear has no live-prey pursuit or harmful contact in this unit, and wolves do not coordinate tactical pack attacks. A boar, wolf, cougar, or brown bear may scavenge an existing body only after seeing it, reaching it, and winning the conserved physical claim; the cougar or bear may then guard that claim. Regional distribution does not create ecological migration behavior or worldwide species breadth.",
      },
      {
        id: "wildlife-alpine-talus-ridge",
        audience: "all",
        title: "Talus and sky share one lawful ridge",
        body: "A separate sparse Alpine ecology layer leaves the exact signed-region base untouched and admits life only where authoritative ridge habitat supports it. Mountain goats form one persistent group-atomic HERD and use the common terrain resolver with grade-aware ridge footing. One solitary golden eagle uses the shared aerial activity owner to choose authenticated ridge soaring and perching lines. American pikas remain one conserved non-addressable talus aggregate, visible only through nearby haypiles or talus signs. A currently visible eagle can create role-based predator pressure that quiets the pika area or redistributes at most one existing unit on its fixed opportunity; an occluding ridge prevents that knowledge and response. This interaction captures no pika, selects no exact pika target, creates no body, and causes no injury or death.",
      },
      {
        id: "wildlife-cold-shore-fox",
        audience: "all",
        title: "Cold shore composes one actor with one aggregate",
        body: "A separate sparse addressable cold-shore sibling leaves the exact polar-shore forage owner untouched. It admits one solitary Arctic fox only where viable cold dry ground and the exact already-admitted Atlantic-capelin substrate coincide. The fox uses the shared identity, senses, attention, condition, locomotion, dormant, and evidence rules. If it lawfully perceives a domestic dog, generic pressure can make it flee or retreat; there is no fox-specific dog detector or invisible protection radius. If it currently sees anonymous capelin activity, shared rules can apply nonlethal pressure to the conserved aggregate, but an occluding landform removes both observation and response. No exact fish exists to be targeted, caught, or consumed. Chart, Relief, quick inspection, and ABOUT reveal only current lawful actor or small-canid evidence detail, never private intent, hidden counts, anchors, or offscreen outcomes.",
      },
      {
        id: "wildlife-polar-consumer-shore",
        audience: "all",
        title: "A seal joins water to dry shore",
        body: "A separate sparse polar-consumer sibling depends on the exact existing capelin-backed cold saline shore. Where authoritative foraging water and a distinct dry haulout both exist, one solitary harbor seal may use their shared amphibious route; a rarer solitary polar bear is eligible only after that exact seal candidate exists. Direct sight can let a seal apply conserved nonlethal pressure to capelin, or let a bear pursue while the seal flees. An occluding landform removes both actors' knowledge and response. These are shared intents and physical movement, not capture, kill, consumption, injury, mortality, a body, or a resource. Chart, Relief, quick inspection, and ABOUT reveal only what is currently visible, with the same pointer and touch boundary.",
      },
      {
        id: "wildlife-estuary-surface-break",
        audience: "all",
        title: "One estuary cohort shares the old rules",
        body: "The append-only breadth owner admits its first five-profile cohort only where the same signed terrain supports it. Bay anchovies occupy up to four authenticated schooling-water anchors as one conserved aggregate; Atlantic ghost crabs occupy up to four suitable tidal-flat anchors as another. Current Tide Table depth makes submerged anchovy activity and exposed-flat ghost-crab signs available without inventing individual animals. Great blue heron and osprey remain solitary persistent actors, while common terns form one indivisible flock of two to four; all three bird populations require the exact local anchovy substrate. Territory ownership, density, trophic ceilings, and a regional-quiet gate can leave suitable-looking regions empty, so this cohort is not camera- or start-centered. The heron uses one authenticated tide-depth-safe wading ground, while terns and ospreys reuse air-only surface-opportunity and rest behavior. Immediate danger still wins. This cohort uses shared identity, group, tide, perception, neutral activity, locomotion, persistence, projection, and ABOUT rules and creates no capture, consumption, injury, death, body, item, or cargo effect.",
      },
      {
        id: "wildlife-marsh-channel-web",
        audience: "all",
        title: "A second cohort reuses the same channel",
        body: "Breadth epoch 2 appends Atlantic menhaden, mummichog, grass shrimp, blue crab, greater yellowlegs, belted kingfisher, and double-crested cormorant without rewriting the first cohort or adding another save wrapper. Menhaden, mummichog, shrimp, and blue crabs remain conserved non-addressable aggregates. Yellowlegs form one two-to-four-member group-atomic flock, the kingfisher is solitary, and cormorants form one two-to-three-member group-atomic flock. Yellowlegs require the exact local grass-shrimp substrate, kingfishers require mummichog, and cormorants require menhaden. Shared tide, activity, perception, movement, group, aggregate, persistence, projection, and ABOUT owners keep those relationships lawful. One clear cormorant can create bounded nonlethal pressure on menhaden; a ridge removes the observation and response. No exact prey, capture, consumption, injury, death, body, item, or cargo effect is created.",
      },
      {
        id: "wildlife-saltmarsh-small-worlds",
        audience: "all",
        title: "Small lives use the same living web",
        body: "Breadth epoch 3 appends two conserved non-addressable aggregates and two persistent actor profiles without rewriting either earlier cohort. Mosquito and periwinkle signs remain anonymous evidence over at most two authenticated anchors; they are not exact targets. Seaside sparrows form one indivisible flock of two to four and use shared perch-and-forage behavior only where their mosquito substrate exists. One solitary diamondback terrapin uses shared amphibious margin movement only where periwinkles support it. A visible terrapin can apply bounded nonlethal pressure to periwinkle activity; a ridge blocks both observation and response. These rules create no bite, disease, capture, consumption, injury, death, body, item, or cargo effect.",
      },
      {
        id: "settlement-shadows-pressure",
        audience: "all",
        title: "Population areas respond to roles, not name lists",
        body: "Lawfully perceived predators, dogs, people, and other supported animal roles can pressure an eligible rat or frog population area through the shared ecological resolver; a neutral animal such as a rabbit cannot disturb one merely by being nearby. Exposed loose provisions can attract the rat area, while rain and terrain exposure also change lawful pressure. On each fixed eight-tick opportunity, at most one existing population unit moves between saved anchors. No rat or frog is spawned, killed, or turned into loot. Loose-provision attraction still does not eat, move, or duplicate that physical parcel; the starting-harbor store uses its separate authenticated one-unit loss transaction described below.",
      },
      {
        id: "settlement-storehouse-door",
        audience: "all",
        title: "An open door joins the living web",
        body: "One store at the starting harbor owns a persistent physical fresh-produce lot; it is not another view of the settlement's abstract food stock. An open door exposes that lot through the existing scent system, so wind, rain, distance, and packaging leakage shape what reaches the existing brown-rat aggregate. A matching authenticated attraction event can remove at most one actual produce unit. The same event cannot replay after save or reload, and the rat population remains conserved. An existing cat's lawfully visible presence can pressure that aggregate through shared perception policy, but the cat gains no hidden rat knowledge or new investigation behavior. When you are physically near both store and keeper, the contextual action lets you ask that actual keeper to secure the door through your direct report. Closure persists and contains scent. An unseen loss does not appear in EVENTS merely because you return later.",
      },
      {
        id: "settlement-domestic-flock",
        audience: "all",
        title: "The flock, herd, and watch share living rules",
        body: "Two or three domestic chickens share one stable flock, coop, and settlement-custody relationship around the storehouse yard. Exactly two domestic goats share a different herd, pen, and custody relationship. One distinct domestic dog has a third custody relationship and kennel; a generic working-animal assignment binds that dog and the existing keeper to the protected goat custody, herd, and pen worksite. All remain ordinary actors using shared senses, attention, terrain movement, and broad ecological roles rather than private detection or pair scripts. A current caused escape can physically split the herd; a goat can attempt to regroup only from fresh identified sight of its herd mate, and self-preservation still wins. The keeper must see enough current evidence to notice the separation before reporting the last known area to the guardian. That report can begin an ordinary bounded investigation, not prove a find or guarantee recovery. The exact goats must physically rejoin and later be seen together inside the pen before the recovery closes. A fox is deterred only if it actually perceives the dog. A hungry chicken can investigate the exact open-store lot, walk into its structural access area, and consume one physical unit through a staged transaction. A goat and the working dog cannot claim that store lot, and foliage browsing is not active yet. When lawful animals compete for the same physical resource, reach, current need, and stable identity settle one winner. A secured store cannot become food knowledge or a claim. You receive an animal event only when you directly cause or witness it; later sight does not reveal hidden history retroactively.",
      },
      {
        id: "settlement-working-dog-kennel-night",
        audience: "all",
        title: "The working dog rests only at its real kennel",
        body: "That one settlement-custodied working dog uses the shared day-active circadian policy. During its night-rest preference it travels physically through ordinary terrain movement to the actual kennel in its custody and stays awake without restorative physiology until arrival. At the kennel it can become Resting and then Asleep; it wakes at its stable-ID active boundary. Lawful danger or strong current disturbance, urgent needs and self-preservation, and retained investigation or return work still outrank the neutral routine. Chart and Relief use its authoritative resting body pose, while directly visible ABOUT inspection may say Resting or Asleep but never reveals schedule timing, phase offset, wake threshold, stable identity, destination ID, custody, or assignment internals. That Alpha45 dog adapter itself does not change the independent porter-scene dog or create a bonded/player companion, human schedule, player REST, or player SLEEP.",
      },
      {
        id: "settlement-keeper-home-night",
        audience: "all",
        title: "The keeper rests only while truly home",
        body: "The existing starting-harbor food-store keeper uses the same day-active routine architecture with their authoritative settlement as a bounded home-rest anchor. Neutral night preference can become Resting and then Asleep only while that exact resident is physically at home and free of a Promise contract. Route work, non-neutral porter response, storm, urgent needs, and qualifying current strong sensory evidence outrank rest; dawn wakes the same stable person. An asleep keeper gains no new visual observations, but shared hearing and scent can still provide lawful wake evidence. Exhaustion and rest need recover only from the authenticated home posture, never from travel, shelter alone, or stale state. Directly observable quick inspection and ABOUT may show Resting or Asleep without exposing schedule, phase, destination identity, needs, or hidden perceptions. This creates no house, bed, interior path, shop hours, autonomous commute, every-human routine, or player REST/SLEEP action.",
      },
      {
        id: "settlement-shadows-signs",
        audience: "all",
        title: "Signs are evidence, not a census",
        body: "Gnaw marks, small tracks, and shelter signs are physical evidence of the rat population. They appear, label, select, and open ABOUT only in current direct-detail sight in both Chart and Relief, with mouse or touch. The sign may identify brown rats when the view is clear enough, but it never reveals an exact count, hidden anchor, pressure value, cause, or individual rat identity.",
      },
      {
        id: "settlement-shadows-cats",
        audience: "all",
        title: "Cats respond without becoming companions",
        body: "A hungry free-ranging cat can forage a loose provision it directly sees. Another visible cat can make it guard that food instead, and sufficiently strong rain can make it retreat and leave bounded wet pawprints. Those tracks appear only in current direct-detail sight, are not selectable, and do not reveal the cat's hidden thoughts or become a remote tracker.",
      },
      {
        id: "settlement-shadows-sound",
        audience: "all",
        title: "Only witnessed activity reaches you",
        body: "A rat rustle, cat call, rabbit thump, fox yip, or fish-crow double call is a restrained cue for a newly visible event. A chorus instead travels through shared directional hearing from its actual strongest heard anchor; rain can both stir it and mask the sound. Until you learn its source, the bottom-right caption remains anonymous. It gives a coarse direction only when the shared hearing band supports one, otherwise saying direction unclear or all around; stereo pan is softened by that same uncertainty. Offscreen movement and hidden animal decisions remain world state rather than entering EVENTS or granting remote hearing, and the northern harrier has no invented cry in this build. Boar, elk, and wolf voice patterns are foundation-only and inaudible; cougar, brown-bear, mountain-goat, pika, golden-eagle, capelin, Arctic-fox, harbor-seal, polar-bear, bay-anchovy, Atlantic-ghost-crab, great-blue-heron, common-tern, and osprey Living Voice behavior is not implemented.",
      },
      {
        id: "rain-chorus-aggregate",
        audience: "all",
        title: "Rain changes the chorus, not the frogs' identity",
      ...
      },
      {
        ...
        body: "A snowy egret uses one persistent individual identity, a saved dry refuge, and only currently depth-safe wading edges. Its shared adaptive-active routine combines the one civil clock with current authoritative tide and current anonymous AQUATIC ACTIVITY learned through shared vision. A usable wading edge or lawful opportunity can favor activity; otherwise the awake bird physically returns to refuge, becomes Resting only after arrival, and becomes Asleep only after the shared settling interval. Immediate danger, urgent needs, and retained commitments still win. If the egret is lawfully visible to a school or crab area, shared ecological policy can cause pressure and conserved avoidance. This interaction cannot capture, injure, kill, consume, create a carcass, or implement fishing.",
      },
      {
        id: "marsh-edge-twilight",
        audience: "all",
        title: "Twilight belongs to the rabbit",
        body: "The existing marsh rabbit uses its stable individual twilight-active clock and shared ground-cover-forager activity. In an active window it may move through a bounded deterministic local foraging area on explicit land paths. Outside that window it physically seeks its authenticated habitat cover, remains Awake while travelling, becomes Resting only after arrival, and becomes Asleep only after the shared settling interval. Danger, lawful disturbance, urgent needs, and active commitments still outrank the neutral schedule. The local activity is not proof of food, feeding, a burrow, or a den, and coarse simulation cannot invent a commute or new decision.",
      },
      {
        id: "tidal-waterfowl",
        audience: "all",
        title: "One activity can cross two movement media",
        body: "An American black duck may use one persistent addressable identity, two saved dabbling-water destinations, and one dry refuge. Its current activity can present FLOATING, WATER SCAN, DABBLING, RESTING, SURFACE SWIMMING, or RELOCATION FLIGHT without exposing a private target. A lawful anonymous AQUATIC ACTIVITY observation may guide a dabbling choice, while unobserved choices still come from deterministic eligible habitat. Relocation from refuge uses bounded air travel; movement already on water selects surface-water travel through the shared traversability and path resolver. This exercises the reusable capability-driven ecology seam rather than adding a duck-only detection or pathing system.",
      },
      {
        id: "tidal-otter",
        audience: "all",
        title: "Shore and channel share one route",
        body: "A supported North American river otter owns one persistent identity, one saved water-foraging place, and one distinct dry shore haulout. Shared amphibious locomotion—not an otter-only pathfinder—can carry that same actor from shore into surface water and back. In water it may scan, swim, dive, or forage; a specific aquatic cue influences it only when current terrain-occluded vision supplies an anonymous AQUATIC ACTIVITY observation. Its broad roles can create nonlethal fish or crab pressure, and the common physical-item claim resolver can settle one loose-food contest without cloning the item. None of this is a live-prey capture or meal, harmful attack, injury, death, carcass, fishing, call, or track-evidence system.",
      },
      {
        id: "tidal-convergence",
        audience: "all",
        title: "Activity profiles compose; danger still comes first",
        body: "The original six neutral-activity archetypes remain exact, and later shared extensions bring the current registry to twelve reusable archetypes serving seventeen species. Each profile must match the actor's real capabilities, allowed movement media, authenticated destination, observation boundary, visible signal, and bounded schedule scope. Golden eagle retains ridge-soar/perch; harbor seal reuses authenticated shore-water foraging; great blue heron and greater yellowlegs use anchored-wader behavior; gull, common tern, osprey, and belted kingfisher share aerial-surface-opportunist behavior; double-crested cormorant uses diving-waterbird behavior; seaside sparrow uses perch-forage; diamondback terrapin uses amphibious-margin-forager; and marsh rabbit uses ground-cover-forager. Legacy profiles keep their bounded daylight/rest scope, while the rabbit declares a circadian routine and explicit land movement. Only a current lawful observation can guide an eligible opportunity, and each actor returns to an authenticated habitat anchor for rest. These profiles grant no exact aggregate target, capture, consumption, or implied food. Any immediate lawful threat, escape, alarm, food, guard, pursuit, retreat, or scavenging intent outranks neutral activity. This is not catalog-wide daily life or continuously simulated 3D movement.",
      },
      {
        id: "shadow-overhead",
        audience: "all",
        title: "A shadow overhead can change the whole web",
        body: "During its bounded daytime window, the northern harrier follows a deterministic low quartering search and may begin a finite nonlethal pursuit of a directly perceived small prey animal. A fish crow must first directly identify the aerial predator before alarming; only a crow actually mobbing it becomes pressure that can break the pursuit. Mere proximity cannot fake the interaction. At rest time, crows seek authenticated habitat perches and the harrier settles, but danger and immediate needs still take priority.",
      },
      {
        id: "marsh-edge-pursuit",
        audience: "all",
        title: "A fox must reach the rabbit it pursued",
        body: "A marsh rabbit that directly perceives a fox can alarm and flee. A hungry marsh fox may pursue only a rabbit it currently identifies, while a lawfully perceived dog or black bear can become the more urgent pressure. The shared terrain resolver gives rabbit flight and fox pursuit distinct bounded gaits, and escape, lost contact, interruption, or finite opportunity can end the attempt. Only exact physical contact between that current pursuer and that exact rabbit may cause injury or death; a radius, stale target, anonymous alarm, or hidden actor cannot.",
      },
      {
        id: "marsh-edge-aftermath",
        audience: "all",
        title: "One lost life leaves one finite body",
        body: "If exact supported predator contact kills an individual marsh rabbit, that exact actor retires once and exactly one population unit is removed. Any other abstract units it represented remain reserve. One stable physical carcass remains at the death place with a finite conserved resource. A fox, fish crow, wild boar, gray wolf, cougar, or brown bear must lawfully see and physically reach that same body before feeding; each meal consumes one unit, and an eligible solitary predator may guard its claim. Chart, Relief, and EVENTS reveal only what you currently perceive: finding a body later does not tell you who killed it, why, what happened offscreen, who claimed it, or how much remains.",
      },
      {
        id: "marsh-edge-about",
        audience: "all",
        title: "Distance limits what ABOUT can name",
        body: "An uncertain glimpse remains SMALL ANIMAL, UNKNOWN CANID, UNKNOWN SMALL CANID, UNKNOWN LARGE CAT, AQUATIC MAMMAL, or LARGE BEAR. Clear direct observation can identify a marsh rabbit, marsh fox, Arctic fox, cougar, brown bear, harbor seal, or polar bear and describe only approximate visible form, morph, life stage, condition, and current behavior. ABOUT never reveals a hidden statistic, private target, population pressure, or habitat calculation.",
      },
      {
        id: "marsh-edge-movement-signs",
        audience: "all",
        title: "Movement can leave a sign where it happened",
        body: "Actual marsh-rabbit movement can leave paired tracks, while actual marsh-fox or Arctic-fox movement can leave canid pawprints. Arctic-fox authorship stays anonymous until a future knowledge owner can support a learned identification receipt. The saved sign stays at that movement site rather than following the animal, loses identifying clarity as it ages, and disappears after three in-world hours. It appears only in current direct-detail sight, has a distinct Chart and Relief form, and is not selectable or usable as a remote locator.",
      },
      {
        id: "wildlife-player-choices",
        audience: "all",
        title: "Watch, route around, or leave",
        body: "A directly visible addressable animal—including a seaside sparrow or diamondback terrapin—offers WAIT AND WATCH, ROUTE AROUND THIS SPOT, and LEAVE. WAIT AND WATCH briefly stops the current automatic route for this actor observation; it is not the player's WAIT 10 MIN action and does not advance ten displayed minutes. ROUTE AROUND must keep the same destination and find a real line outside the observed animal's area; if that fails, your previous route and choice history remain unchanged. LEAVE closes the observation rather than moving the animal. Aggregate signs, including mosquito and periwinkle evidence, are close-only because a population sign is not an actor; rabbit and fox movement signs are not targetable.",
      },
      {
      ...
      },
      {
        ...
        body: "When the local assemblage includes a hungry black bear or fish crow, it can reach and consume one exposed dried-fish parcel through ordinary physical custody. A supported otter uses the same generic loose-food claim and competition boundary rather than a private loot table. Every claimant must lawfully reach the object; stable conflict ordering grants one custody path, and the same parcel cannot be consumed twice, duplicated, or silently reappear after reload. A completed meal writes one animal-consumption record for that exact physical item.",
      },
      {
        id: "wildlife-persistence",
        audience: "all",
        title: "Distance changes detail, not identity",
        body: "Every addressable representative, including each seaside sparrow and diamondback terrapin, keeps its stable identity and population membership. Flocks, herds, sounders, and packs retain stable groups; solitary animals remain solitary, and domestic groups retain settlement custody. A saved social group is one indivisible materialization-cap unit: either every member is admitted to detailed simulation or the whole group remains coarse. An exact group member beyond the current frame receives no local observation or locomotion input merely because a peer is visible. Outside the active field, an individual coarse step applies only remaining saved intent to physiology, ages existing perception without adding facts, and invents no hidden target, food, or player event. If more lawful independent individuals intersect the active field than can receive full detail, exact spatial top-K selection uses distance and stable identity across every ecology owner while overflow actors remain preserved. Returning restores the same saved actors rather than rolling replacements because the camera moved. Aggregate populations, including mosquitoes and periwinkles, preserve stable conserved identities instead of pretending to be individual animals.",
      },
      {
        id: "wildlife-player-absent-aftermath",
        audience: "all",
        title: "An absent group can leave bounded aftermath",
        body: "When an entire saved herd or flock is outside full simulation, bounded habitat pressure can advance its persistent group state and record nonlethal player-absent aftermath: displacement, separation, or reunion. A retained domestic recovery can follow an authenticated group transition across that coarse interval without pretending the keeper saw it; current direct evidence is still required for keeper knowledge and final home confirmation. Coarse aftermath causes no harm or cargo interaction and never enters player EVENTS by itself.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        audience: "all",
        tone: "boundary",
        title: "The current catalog remains bounded",
        body: [
          "The current forty-seven-record catalog contains exactly forty-five core-wildlife profiles plus separate human and domestic-dog foundation records. Earlier catalog and breadth epochs remain exact prefixes; Saltmarsh Small Worlds is append-only epoch 3.",
          "Mosquitoes and periwinkles are conserved non-addressable aggregates over at most two anchors. Seaside sparrows are one group-atomic flock of two to four, and the diamondback terrapin is solitary. Their substrate dependencies and the shared territory, density, and quiet gates preserve honest absence.",
          "All wildlife still uses shared identity, perception, movement, activity, group, aggregate, persistence, knowledge, and presentation rules. One global group-atomic plan remains capped at 24 addressable actors, and aggregate populations consume no actor slot. Shared invariants, conservation, performance, seamless-crossing checks, and representative emergent scenarios replace a species-by-species or N² pair matrix.",
          "The final cohort adds no bites, disease, exact insect or snail actors, capture, consumption, injury, mortality, body, sound, reproduction, complete circadian life, or continuous 3D flight. The existing narrow rabbit mortality path is unchanged; player, dog, human, and broader animal mortality remain absent.",
        ].join(" "),
      },
    ],
  },
  {
    ...
    keywords: ["chart", "2d", "relief", "3d", "view", "hud", "promises", "mobile", "inspector", "camera", "compass", "north", "twist", "spin", "clock", "time", "wait", "dawn", "day", "dusk", "night", "j", "l"],
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The HUD clock names Dawn, Day, Dusk, or Night beside the exact time. One saved world tick is one displayed minute, and every 1,440 ticks begins a new day. Fresh expeditions begin at 07:00; existing saves keep their exact recorded tick. Sky color, Relief sunlight direction, ambient light, bounded wildlife activity, resident rest pressure, event times, and both views read the same clock. Weather and terrain filter physical outdoor illumination; completed beacon projects light nearby unobstructed ground and blue water after dusk, and that currently observed pool is visible in both views. Ridges or substantial structures block the same light through the line-of-sight geometry used for perception. Loading a region, changing views, stopping at the title or Quiet Hour, or closing the game cannot advance or reset the day, and midnight does not reset tide or weather. WAIT 10 MIN, REST 30 MIN, and settlement SLEEP TO DAWN all advance this same clock through ordinary fixed steps. All forty-two current original-estuary residents now use that shared reciprocal settlement-rest routine. A contract-free person can rest only while physically present at a real settlement; their current location remains authoritative, and any onward or return travel still requires real Promise work. Promise work, route travel, storms, urgent needs, and current identified/alert/searching attention keep a person active; weak uncertainty does not force wakefulness, and dusk never forces sleep. The settlement working dog retains its separate physical kennel routine and relationships; the independent dog and future bonded player companion remain outside this slice. All seventeen current wildlife activity profiles use the same arrival-gated routine contract: fourteen retain day-active base clocks, North American river otter is night-active, snowy egret is adaptive to clock, tide, and lawful opportunity, and marsh rabbit is twilight-active. Qualifying ordinary rain can activate American black duck outside its base clock window, while a dangerous storm drives it toward authenticated refuge and rest. The duck, otter, greater yellowlegs, and diamondback terrapin keep clock-based wake policy while existing physical actions and destinations respond to usable tide and depth; tide does not independently wake them. Each uses existing physical rest destinations and locomotion; transit stays Awake, and danger, urgent needs, lawful disturbance, and retained commitments retain priority. Southern leopard frog separately remains a weather-responsive aggregate whose rain activity and chorus are real, not a fabricated individual posture. Wildlife outside those seventeen profiles, the independent dog, bonded/player companions, broader driver coverage, houses and interiors, guaranteed return travel, and validated broad coarse-time advancement remain later work.",
      },
      {
    ...
    steps: [
      {
        ...
        body: [
          "One continuous deterministic world, seamless signed-region travel, one saved civil clock, a bounded ten-displayed-minute player WAIT, thirty-minute REST, and settlement-anchored SLEEP TO DAWN through the ordinary authoritative simulation, smooth Chart and Relief outdoor light, physical low-light perception, completed-beacon settlement lamps, terrain-aware stability, tides, weather, downward Relief rain, river turbulence and ADRIFT recovery, fog and brief terrain memory, deterministic resources, physical cargo, crafting, equipment, Promises, projects, observation-safe EVENTS, persistent humans, ABOUT inspection, one independent dog, one settlement working dog with an arrival-gated day-active kennel routine, and all forty-two current original-estuary residents with an overrideable reciprocal settlement-rest routine are present. Real Promise work, route travel, storms, urgent needs, and current watch/search cognition outrank human rest; the keeper retains its separately authenticated duty response. A visiting courier can recover only while physically present at a settlement, and any onward or homeward leg remains ordinary Promise transport. All seventeen current declared wildlife activity profiles share the arrival-gated living-circadian routine contract: fourteen retain day-active base clocks, the North American river otter is night-active, the snowy egret is adaptive to clock, tide, and lawful opportunity, and the marsh rabbit is twilight-active. Qualifying rain can activate the American black duck beyond its base clock window, while dangerous storm drives authenticated refuge and rest. Duck, otter, greater yellowlegs, and terrapin keep clock-based wake policy while their existing actions and destinations remain tide- and depth-responsive where physically usable.",
          ...
          "Outer save version 32 is current; RegionalEcologyStateV6 and wildlife actor schema/version 1 remain unchanged inside it. Exact authenticated outer-v30/V6 worlds preserve their nested ecology bytes when adopted through version 31; version 31 then adopts once with no active player recovery action. A valid epoch-2 state authenticates before epoch 3 appends once at its saved tick; earlier epochs remain an exact prefix and reload cannot reroll the result. Each of the seventeen bound wildlife profiles may use the existing optional wildlife circadian receipt only after a lawful current projection, so legacy absence remains valid and no migration invents sleep history. The already-optional resident receipt now binds every eligible current human physically present at a settlement on an ordinary authoritative tick without an outer migration. Its reciprocal-network identity preserves the exact Alpha 51 resident-home digest bytes; actual current location and absence of active work authenticate rest. Alpha 51 Awake or STARTLED foreign-arrival receipts reconcile on the next tick without free recovery, while false-arrival Resting or Asleep remains invalid. Circadian receipts store policy, the authenticated rest-network receipt, and posture with its entered tick; actor identity remains separately stable and phase is deterministically rederived. Raw parsing preserves canonical receipt data without proving current location or refuge; full-detail activity reauthenticates before behavioral use. Coarse wildlife absence conserves an already committed bounded rest bout without inventing travel or decisions; current drivers are evaluated after rematerialization. The current catalog derives rhythm and cadence from the binding registry while exact Alpha 32 through Alpha 39 historical catalogs remain unchanged. Alpha 39 Saltmarsh Small Worlds is the released LIVE_VERIFIED biodiversity checkpoint; Alpha 52 Rest Between Harbors remains a local unpublished source candidate.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, the American black duck's shared individual routine, and the real southern leopard frog aggregate's activity and chorus; tide changes conserved aquatic activity and lawful habitat without rerolling populations. Qualifying rain may activate the duck beyond its base clock window, dangerous storm drives its authenticated refuge/rest response, and the frog remains non-addressable with no fabricated individual posture. Duck, otter, greater yellowlegs, and terrapin keep clock-based wake policy while their existing action and destination projections remain tide- and depth-responsive only when the physical affordance is usable; tide does not independently wake them. All seventeen current wildlife activity profiles now share physical circadian routines, but the bounded 45 / 47 catalog is not worldwide ecology or a complete bestiary. Shared invariants, signed and extreme-coordinate properties, conservation, performance, seamless crossing, and representative visible-versus-occluded scenarios exercise the reusable scaffold rather than species-by-species or N² pair tests. Fire and lantern light, independent canopy and interior cover, shadow maps, astronomy, sea ice, snow behavior, tactical pack combat, ecological migration, broader mortality and capture, reproduction, population recovery, live-time decomposition, body drift, harvesting, fishing, complete scent and evidence, wildlife outside the current seventeen activity profiles, independent-dog and bonded/player-companion routines, broader driver coverage, autonomous home life, infinite regional human populations, physical guest rest/return travel, validated broad coarse-time advancement, audible Living Voice for the newest species, foliage consumption, and continuous 3D flight remain planned. Turning Day must still complete its multi-day CPU/save-growth proof, packaged parity/performance witness, cumulative gate, and release checkpoint before Living Voice begins. Absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 62 as const;
