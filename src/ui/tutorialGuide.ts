  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "Between water and sky",
        body: "The second bounded Wave-C unit may add at most one persistent American black duck near the stable starting harbor. During its bounded activity it can float, scan, dabble, rest, swim on the surface, or relocate by air. A current anonymous AQUATIC ACTIVITY observation can guide it only after shared terrain-occluded vision lawfully produces that fact; otherwise deterministic habitat and tide state govern its eligible water or refuge. Activity chooses air or surface-water movement explicitly, with the water route using the shared traversability and path resolver. This is one representative use of the common species scaffold—not a flock, nesting, migration, capture, mortality, carcass, consumption, worldwide ecology, or completed Wave C.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "A directly visible deer, gull, black bear, domestic cat, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, or American black duck offers WAIT AND WATCH, ROUTE AROUND THIS SPOT, and LEAVE. WAIT briefly stops the current automatic route. ROUTE AROUND must keep the same destination and find a real line outside the observed animal's area; if that fails, your previous route and choice history remain unchanged. LEAVE closes the observation rather than moving the animal. Rat, frog, silverside, and fiddler-crab sign ABOUT is close-only because a population sign is not an actor; rabbit and fox movement signs are not targetable.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "The seven Wave-B ecological roles remain closed only for one bounded habitat-derived assemblage near the stable starting harbor. The Tide Table and this one-duck waterfowl unit are the first two bounded Wave-C slices there. Shared role, capability, perception, movement, group, aggregate, tide, and presentation contracts replace hardcoded pair lists, but do not create ecology in every distant region or complete Wave C. Animals do not attack, receive injuries, die, leave carcasses, or consume live prey in this build. The duck has no flock, nesting, reproduction, migration, capture, mortality, carcass, or consumption state. Fishing, the otter-like predator, complete scent and evidence tracking, foliage consumption, complete circadian behavior, further species, worldwide populations, the full bestiary, and an exhaustive species-pair interaction matrix are not live yet.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "The game maintains one local autosave, using browser storage with a fallback. It saves periodically, when the page hides or closes, when the title opens, and when Quiet Hour begins. Outer save version 14 preserves habitat version 6, aggregate ecology record version 4, all four aggregate populations and their signs, persistent herds and flocks, bounded representatives and their saved intent, tidal and waterfowl anchors, the durable tide-operation clock, movement evidence, and physical food history. Bird activity and current water depths are derived again from those authoritative facts, world time, and the live tide. A sealed version 13 Tide Table save migrates exactly once: every established habitat-version-5 population and tidal anchor, actor, group, aggregate population, item, Promise, disturbance, evidence record, and world fact stays exact while deterministic waterfowl habitat and a zero-or-one American-black-duck population are appended once. Re-saving and reloading cannot add another population, reroll an animal or anchor, duplicate a group or consumed provision, replay a completed tidal-edge opportunity, or rewrite older ecology.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 30 as const;
