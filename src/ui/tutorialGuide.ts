  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The Watch Returns adds no animal. It gives the existing settlement guardian dog one bounded persisted work-task lifecycle. A committed lawful alarm investigation opens a task with only its source observation, uncertain perceived area, and deterministic shared-locomotion search probe. Reaching that probe completes the investigation and sends the dog physically toward the existing pen worksite; arrival waits for the existing keeper's lawful acknowledgement before the latest completed or cancelled result closes. The keeper can recall an investigating dog outside its duty area only when dog and keeper have fresh reciprocal identified sight—there is no remote command. Dog cognition and welfare can suspend work and later resume it. Chart, Relief, quick inspection, and pane-free ABOUT continue to reveal only direct current detail, never hidden task state. Outer save 20 adopts one sealed version-19 Paddock Watch world exactly once while habitat remains version 9, settlement ecology remains version 4, aggregate ecology remains version 4, and every established actor, home, relationship, item, Promise, and world fact stays exact. Shared invariants and representative emergence validate this reusable seam without species-by-species or N² pair testing. This is not a new species, herding, separated-livestock search or rescue, full schedule, autonomous kennel-life routine, player command, attack, injury, mortality, carcass, guaranteed defense, worldwide ecology, or broader settlement-animal simulation.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Each representative—including every free-ranging cat, domestic chicken, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, and North American river otter—keeps its stable identity and population membership. The chicken flock also retains its stable group and settlement custody. Outside the active field, an individual coarse step applies only the remaining saved intent to physiology, ages existing perception without adding facts, and invents no hidden perception, target, food, or player event. If more lawful individuals intersect the active field than can receive full detail, exact spatial top-K selection chooses the nearest 24 with a stable-ID tie break; overflow actors remain authoritative in coarse state. Returning restores the same saved actors rather than rolling replacements because the camera moved. Rat, frog, silverside, and fiddler-crab populations preserve their own stable aggregate identities instead of pretending to be individuals.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "The seven Wave-B roles, Wave-C tidal roles, and first Wave-D flock, herd, and working-animal slices remain one bounded integration near the stable starting harbor. The Tide Table, one-duck waterfowl unit, one-otter amphibious unit, reusable activity profiles, Storehouse Door, domestic chickens, domestic goats, and one separate working dog share versioned role, perception, movement, group, aggregate, tide, physical-item, plural-custody, typed-home, working-assignment, and presentation contracts instead of hardcoded species or pair lists. The Storehouse Door, Yard Flock, Far Paddock, and Paddock Watch do not create storage, livestock, or dog ecology in every settlement. This does not create ecology in every distant region or complete Directive 04_1. Animals do not attack, receive injuries, die, leave carcasses, or consume live prey in this build. Chickens and goats still have no authored call, track evidence, reproduction, complete schedule, autonomous home return, herding behavior, or cross-region migration; goat foliage browsing, milk, and wool are also absent. The working dog adds no bark or other sound, attack, harmful protection, herding, companion bond, player command, guaranteed defense, worldwide population, or cross-region animal ecology. Complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, wider livestock, further species, wider aquatic and scavenger ecology, worldwide populations and storehouses, and the full bestiary are not live yet. Shared invariants, property and bounded-fuzz checks, conservation rules, performance budgets, and representative emergent interactions test the reusable scaffold instead of requiring a species-by-species or N² pair matrix.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "The game maintains one local autosave, using browser storage with a fallback. It saves periodically, when the page hides or closes, when the title opens, and when Quiet Hour begins. Outer save version 20 preserves habitat version 9, aggregate ecology record version 4, settlement ecology version 4, all four aggregate populations and their signs, persistent herds and flocks, bounded representatives and their saved intent, tidal, waterfowl, otter, domestic-yard, and domestic-pen anchors, the durable tide-operation clock, deterministic top-K core-wildlife materialization state, movement evidence, physical food history, the starting-harbor store's plural domestic custody and food-use history, one separate dog roster, and working-animal state version 2. A sealed version 19 Paddock Watch save migrates exactly once: every established habitat-9 population and anchor, actor, group, aggregate unit, store and lot identity, chicken, goat, and dog identity, relationship, home, working assignment and activity, closure, loss event, item, Promise, custody record, disturbance, evidence record, and world fact stays exact before empty task-lifecycle fields are appended. The lifecycle stores one current task, one pending exact-once transition, and only the latest closed outcome; its search probe remains derived from lawful uncertain evidence, handler recall requires current mutual sight, and return remains physical travel. The store lot remains distinct from abstract settlement food, and neither goats nor the working dog can claim it. Re-saving and reloading cannot reroll an animal or anchor; duplicate a group, provision, relationship, assignment, task, transition, acknowledgement, or result; assign one actor or group to two homes; reopen a secured door; replay a store loss, chicken meal, working activity, task transition, or tidal-edge opportunity; exceed the 24-actor core-wildlife materialization cap; or rewrite older ecology. A saved pending work or task transition recovers exactly once without repeating perception, movement, handler authority, or outcome.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 37 as const;
