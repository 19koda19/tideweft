  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "What remains",
        body: "What Remains adds no animal, habitat, population, or actor. A marsh fox already pursuing a currently identified marsh rabbit can injure or kill it only when its exact body physically reaches that exact rabbit; stale sight, an anonymous alarm, or proximity alone cannot substitute for contact. Death retires that rabbit once, removes exactly one population unit, and leaves every other represented unit as abstract reserve. One stable physical carcass then holds a finite conserved resource. A fox or fish crow may discover it only through ordinary current vision, must physically reach it to feed, and consumes one real unit; a fox may claim and guard the remaining body. Chart and Relief show the body or remains, and EVENTS reports direct injury, death, or feeding, only from the player's current lawful perception—returning later does not grant a retrospective account. Outer save 22 adopts one sealed version-21 world exactly once, advances the core-ecology patch to version 3 and aggregate record to version 5, and appends empty mortality, population-reserve, and body ledgers without rewriting earlier state. Shared invariants and representative emergence validate the reusable architecture without species-by-species or N² pair testing. Only fox contact and an individual rabbit body are live: player, dog, human, other-animal, and group-member mortality; reproduction, recruitment, population recovery; live-time decomposition; body drift, dragging, harvesting, scent, and insects; worldwide ecology; and later Wave-E species remain absent.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "The seven Wave-B roles, Wave-C tidal roles, and bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices remain one integration near the stable starting harbor. They share versioned role, perception, movement, group, aggregate, tide, physical-item, plural-custody, typed-home, working-assignment, recovery, mortality, body, and presentation contracts instead of hardcoded species or pair lists. This does not create storage, livestock, recovery, or animal ecology in every settlement or distant region. The only harmful animal contact in this build is a current identified marsh fox physically reaching its exact pursued marsh rabbit; only that individual rabbit can be injured, die, and leave the bounded finite carcass used by foxes and fish crows. Player, dog, human, other-animal, and social-group-member mortality remain absent. Chickens and goats still have no authored call, track evidence, reproduction, complete schedule, autonomous home return, broad herding behavior, or cross-region migration; goat foliage browsing, milk, and wool are also absent. A guardian search can fail or defer and never proves an animal was found. The working dog adds no bark, attack, harmful protection, companion bond, player command, guaranteed recovery, worldwide population, or cross-region animal ecology. Population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent and insects, complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, wider livestock, further species, wider ecology, worldwide populations and storehouses, and the full bestiary are not live yet. Shared invariants, property and bounded-fuzz checks, conservation rules, performance budgets, and representative emergent interactions test the reusable scaffold instead of requiring a species-by-species or N² pair matrix.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "The game maintains one local autosave, using browser storage with a fallback. It saves periodically, when the page hides or closes, when the title opens, and when Quiet Hour begins. Outer save version 22 preserves habitat version 9, core-ecology patch version 3, aggregate ecology record version 5, settlement ecology version 4, working-animal state version 2, every earlier population, actor, group, item, Promise, home, relationship, task, recovery case, store fact, and world fact, plus authoritative mortality, population-reserve, and physical-body ledgers. A sealed version 21 Missing Goat save migrates exactly once: all established state stays exact before those empty ledgers are appended. A valid fox-contact death seals the retired rabbit, one-unit population consequence, named cause, stable carcass, finite remaining resource, current claim, and consumption ordinals. Re-saving and reloading cannot reroll the injury or death; resurrect the retired actor; remove a second population unit; duplicate or move the body; restore consumed resource; replay a claim or meal; or turn an unseen incident into player knowledge. Existing working-animal and domestic-recovery transitions still recover exactly once without repeating perception, movement, handler authority, or outcome.",
      },
      {
    ...
    steps: [
      {
        ...
        audience: "all",
        title: "Live now",
        body: "One continuous deterministic world, seamless signed-region travel, Chart and Relief, terrain-aware stability, tides, weather, downward Relief rain, river turbulence and ADRIFT recovery, fog and brief terrain memory, deterministic resources, physical cargo, crafting, equipment, Promises, projects, observation-safe EVENTS, persistent humans, ABOUT inspection, one independent dog, and one settlement working dog are live. The bounded starting-harbor ecology retains the same nineteen-record species catalog, including individual rabbit, fox, fish-crow, chicken, goat, duck, egret, and otter representatives plus conserved rat, frog, fish, and crab aggregates. Shared perception, attention, locomotion, group, activity, physical-resource, custody, work-task, and recovery owners remain authoritative. What Remains adds no species or actor: only a marsh fox already pursuing a currently identified marsh rabbit may cause injury or death, and only after their exact bodies make physical contact. Death retires that rabbit once, removes one population unit while other represented units remain abstract reserve, and creates one stable finite physical carcass. A fox or fish crow must currently see and physically reach that same body to feed; each meal consumes one conserved unit, and a fox may guard its claim. Chart, Relief, and EVENTS expose the body and direct events only through current lawful perception, never retrospective or remote knowledge. Saved social groups remain indivisible detail-cap units. Outer save version 22 adopts a sealed version-21 world exactly once, core ecology uses patch version 3 and aggregate record version 5, habitat remains version 9, and every prior actor, population, group, home, relationship, item, Promise, and world fact remains exact. Embedded simulation snapshots remain perception-aware format 4 and rules 6. Perpetual play remains active.",
      },
      {
        id: "boundaries-planned-ecology",
        audience: "all",
        title: "Broader ecology is planned",
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. Physical loose provisions and store produce can be perceived, claimed, and consumed only through their current bounded owners. The only current harmful live-animal seam is direct identified marsh-fox contact with an individual marsh rabbit, followed by one stable finite rabbit body that a fox or fish crow may lawfully see, reach, feed from, and—in the fox's case—guard. No player, dog, human, other-animal, or social-group-member mortality is live. Further species, worldwide ecology, wider aquatic and scavenger relationships, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent, insects, broad attack and health systems, complete sound, general scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, and the full bestiary remain planned. Shared invariants, deterministic properties, conservation, bounded fuzzing and performance, and representative emergent scenarios validate the reusable scaffold rather than species-by-species or N² pair tests; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 39 as const;
