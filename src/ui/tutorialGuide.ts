  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Alpha 48 · Tide at the Roost is a local unpublished source candidate. The existing snowy egret now composes the shared adaptive-active circadian policy with the same saved civil clock, current authoritative tide, and a current lawful anonymous AQUATIC ACTIVITY observation. A usable depth-safe wading edge or lawful opportunity can favor activity; when the routine instead prefers rest, ordinary aerial locomotion carries the same bird toward its authenticated saved dry refuge. Travel remains Awake, Resting begins only after physical arrival, and Asleep begins only after the shared settling interval. Immediate danger, urgent needs, and retained commitments still win, and no routine signal creates prey, knowledge, safety, or a feeding result. The slice adds no egret, population unit, density, cargo, item, capture, injury, death, consumption, carcass, fishing, player harm, dog harm, or human harm. Direct inspection may show only current observable posture and established wading behavior, never hidden policy, phase, driver, refuge, tide internals, or unseen opportunity. The egret actor's identity remains separately stable and its phase is deterministically rederived from identity plus policy. The existing optional wildlife circadian receipt stores only policy, the authenticated rest-destination receipt, and posture with its entered tick after lawful commitment. Raw save parsing preserves those canonical receipt fields but does not prove the live refuge or current body location; full-detail activity projection reauthenticates those world facts before behavioral use. While coarse, the egret conserves only an already committed bounded rest bout and does not resample tide or opportunity; current environmental drivers are evaluated again after full-detail rematerialization. Outer save version 32 and RegionalEcologyStateV6 remain unchanged, legacy absence remains valid, and reload cannot reroll the separately stable actor or population. Alpha 47 REST 30 MIN and settlement SLEEP TO DAWN remain live through ordinary fixed steps with no offline advance. This is one representative adaptive tide-and-opportunity binding, not validated broad coarse-time advancement, a production crepuscular profile, full catalog schedule, broader autonomous life, or Turning Day closure. The candidate has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED; Alpha 39 remains the latest verified public release.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The original six neutral-activity archetypes remain exact, and later shared extensions bring the current registry to eleven reusable archetypes serving sixteen species. Each profile must match the actor's real capabilities, allowed movement media, authenticated destination, observation boundary, visible signal, and bounded daylight/rest scope. Golden eagle retains ridge-soar/perch; harbor seal reuses authenticated shore-water foraging; great blue heron and greater yellowlegs use anchored-wader behavior; gull, common tern, osprey, and belted kingfisher share aerial-surface-opportunist behavior; double-crested cormorant uses diving-waterbird behavior; seaside sparrow uses perch-forage; and diamondback terrapin uses amphibious-margin-forager. Only a current lawful observation can guide an eligible opportunity, and each actor returns to an authenticated habitat anchor for rest. These profiles grant no exact aggregate target, capture, or consumption. Any immediate lawful threat, escape, alarm, food, guard, pursuit, retreat, or scavenging intent outranks neutral activity. These are bounded daylight/rest routines, not full circadian life or continuously simulated 3D flight.",
      },
      {
        id: "shadow-overhead",
        audience: "all",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. The existing snowy egret now composes those current tide and lawful aquatic-opportunity signals with the shared adaptive-active clock policy, but no other animal inherits that binding implicitly. The bounded 45 / 47 catalog is not worldwide ecology or a complete bestiary. Shared invariants, signed and extreme-coordinate properties, conservation, performance, seamless crossing, and representative visible-versus-occluded scenarios exercise the reusable scaffold rather than species-by-species or N² pair tests. Fire and lantern light, independent canopy and interior cover, shadow maps, astronomy, sea ice, snow behavior, tactical pack combat, ecological migration, broader mortality and capture, reproduction, population recovery, live-time decomposition, body drift, harvesting, fishing, complete scent and evidence, remaining-human, independent-dog, bonded/player companion, production crepuscular and weather-driven bindings, catalog-wide schedules and autonomous home life, validated coarse-time advancement, audible Living Voice for the newest species, foliage consumption, and continuous 3D flight remain planned. The Turning Day must still connect those remaining schedules, human and companion continuity, parity/performance proof, and its directive-level gate before Living Voice begins. Absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 58 as const;
