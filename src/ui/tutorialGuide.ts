...
export const TUTORIAL_PLANNED_MECHANICS = [
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans remain the current human population, alongside one independently generated dog. Near the stable starting harbor, one bounded habitat-derived local assemblage now includes deer, gulls, black bears, brown-rat population areas, free-ranging domestic cats, marsh rabbits, marsh foxes, fish crows, one northern harrier, a southern leopard-frog population area, an Atlantic-silverside school aggregate, an Atlantic-marsh-fiddler-crab area aggregate, at most one snowy egret, at most one American black duck, and—only when fish, crab, water, and dry-shore habitat all support it—at most one North American river otter. Rats, frogs, silversides, and fiddler crabs remain conserved aggregate populations rather than individual actors; the other listed wildlife use bounded persistent representatives. The duck and otter are each one addressable individual, not a flock or hidden family. Tidal Convergence adds no species: it gives six existing roles reusable activity profiles and lets gulls respond by air to lawful anonymous tidal-surface observation. The Storehouse Door also adds no species: it composes one starting-harbor physical produce store with the existing rat aggregate, free-ranging cat, shared scent, weather, keeper knowledge, and physical-item owners. Further dogs and wildlife species, worldwide populations and storehouses, reproduction, animal death and carcasses, attacks, complete sound, general scent and evidence tracking, rumors, companions, complete circadian life, and the full bestiary remain planned.",
    keywords: ["npc", "dog", "cat", "rat", "rabbit", "fox", "crow", "harrier", "frog", "silverside", "fiddler crab", "snowy egret", "American black duck", "North American river otter", "otter", "waterfowl", "bear", "bird", "wildlife", "companion", "identity", "about", "perception", "ecology", "habitat", "population", "herd", "flock", "school", "chorus", "signs", "pursuit", "tide", "surface water", "amphibious", "flight"],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "The storehouse door",
        body: "The Storehouse Door adds no species. One starting-harbor store owns one persistent physical fresh-produce lot, separate from the settlement's abstract food economy. While its door is open, the ordinary scent owner lets wind, rain, distance, and packaging leakage determine whether the existing brown-rat aggregate is attracted. A matching authenticated event may remove at most one real produce unit; rat population units remain conserved. An existing cat's lawfully visible presence can pressure that aggregate through shared perception policy, but the cat gains no hidden rat knowledge or new investigation behavior. In person, you can ask the actual nearby keeper to secure the door; this release's playable closure path is your direct report to that keeper. Closure persists and contains scent. Unseen losses stay world truth rather than entering EVENTS later. Outer save 16 adopts one sealed version-15 world exactly once while habitat 7 and aggregate 4 remain unchanged. Shared abstraction checks, a bounded signed-coordinate property sweep, physical-item and aggregate conservation, deterministic replay and migration checks, and one representative store-rat-visible-cat scene validate this seam. Existing shared bounded-fuzz and performance gates remain in regression; no exhaustive species-by-species or pair matrix is required. This is one local store, not worldwide settlement ecology, livestock, schedules, mortality, carcasses, live-prey consumption, broad rumors, the full bestiary, or completed Directive 04_1.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Near the stable starting harbor, terrain and habitat derive each local population rather than forcing a fixed roster. The mixed-resolution model records capacity, population pressure, and trend while materializing only a bounded set of representatives; a species with too little support is genuinely absent instead of being rerolled. When present in numbers, deer persist in herds, gulls in flocks, and up to three fish-crow representatives in one CROW-FLOCK. Black bears and the northern harrier stay solitary; at most one snowy egret, at most one American black duck, and at most one North American river otter use persistent individual identities. The otter exists only when the same habitat supports fish, crab, usable deep or tidal water, and a distinct dry shore haulout. Free-ranging domestic cats, marsh rabbits, and marsh foxes also use persistent individual representatives. Brown rats, southern leopard frogs, Atlantic silversides, and Atlantic marsh fiddler crabs remain conserved population-area or school aggregates and never become clouds of fake actors. When more individuals are eligible than the active field can hold, deterministic distance and stable identity select the nearest 24 while every overflow actor remains preserved in coarse state.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "The seven Wave-B ecological roles and the Wave-C tidal roles are closed only as one bounded habitat-derived integration near the stable starting harbor. The Tide Table, one-duck waterfowl unit, one-otter amphibious unit, and Tidal Convergence share versioned role, activity-profile, perception, movement, group, aggregate, tide, item-claim, and presentation contracts instead of hardcoded species or pair lists. The Storehouse Door composes those existing owners with one local settlement-owned physical produce store and actual keeper; it neither adds a species nor creates storage ecology in every settlement. This does not create ecology in every distant region or complete Directive 04_1. Animals do not attack, receive injuries, die, leave carcasses, or consume live prey in this build. The duck has no flock, nesting, reproduction, migration, capture, mortality, carcass, or consumption state. The otter likewise has no capture, live-prey consumption, harmful attack, injury, mortality, carcass, fishing, call, track-evidence, reproduction, or migration state. Complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, livestock, further species, wider aquatic and scavenger ecology, worldwide populations and storehouses, and the full bestiary are not live yet. Shared invariants, property and bounded-fuzz checks, conservation rules, performance budgets, and representative emergent interactions test the reusable scaffold instead of requiring a species-by-species or N² pair matrix.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "The game maintains one local autosave, using browser storage with a fallback. It saves periodically, when the page hides or closes, when the title opens, and when Quiet Hour begins. Outer save version 16 preserves habitat version 7, aggregate ecology record version 4, all four aggregate populations and their signs, persistent herds and flocks, bounded representatives and their saved intent, tidal, waterfowl, and otter anchors, the durable tide-operation clock, deterministic top-K materialization state, movement evidence, physical food history, and one settlement-ecology root for the starting-harbor store. A sealed version 15 Tidal Convergence save migrates exactly once: every established habitat, actor, group, aggregate population, item, Promise, custody record, disturbance, evidence record, and world fact stays exact while the same stable store, keeper and rat binding, physical fresh-produce carrier, open door, and empty bounded loss history are derived once. The store lot is distinct from the settlement's abstract food stock, so migration neither adds to nor subtracts from that economy. Re-saving and reloading cannot reroll an animal or anchor, duplicate a group or provision, reopen a secured door, replay a store loss or tidal-edge opportunity, exceed the 24-actor materialization cap, or rewrite older ecology.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 33 as const;
