...
export const TUTORIAL_PLANNED_MECHANICS = [
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans remain the current human population. One independently generated dog remains paired with a porter without ownership, while one separate settlement-custodied working dog watches near the existing two-goat herd from its own kennel relationship. The starting settlement separately retains its bounded brown-rat population area and anchored chicken and goat homes; its free-ranging domestic cat is habitat-optional. The current twenty-eight-record catalog preserves the exact existing signed-region ecology, adds a sparse Alpine layer where supported mountain goats form a HERD, American pikas remain one conserved non-addressable talus aggregate, and a golden eagle remains solitary, and adds one separate sparse polar-shore layer where supported Atlantic capelin remain one conserved non-addressable school. Every layer shares one group-atomic materialization cap, while honest absence remains valid. Rats, frogs, silversides, fiddler crabs, pikas, and capelin are conserved aggregate populations rather than individual actors; the other eligible wildlife use bounded persistent representatives. Each chicken, domestic goat, mountain goat, dog, and eagle representative remains an individual, and domestic groups keep explicit settlement custody. The only current animal mortality is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit, with one conserved finite rabbit body; the Alpine trio, capelin, brown bears, players, dogs, humans, social-group members, and broader animals cannot enter that harmful path. Additional dogs and wildlife species beyond this bounded roster, remaining polar breadth, complete Wave F, worldwide species breadth and domestic ownership, reproduction, population recovery, broader attacks and aftermath, a new guardian sound, general scent and evidence tracking, rumors, companions, complete circadian life, foliage browsing, herding, guaranteed livestock defense, and the full bestiary remain planned.",
    keywords: ["npc", "dog", "cat", "rat", "rabbit", "fox", "crow", "harrier", "frog", "silverside", "fiddler crab", "snowy egret", "American black duck", "North American river otter", "otter", "waterfowl", "mountain goat", "American pika", "golden eagle", "talus", "alpine", "chicken", "domestic", "livestock", "bear", "bird", "wildlife", "companion", "identity", "about", "perception", "ecology", "habitat", "population", "herd", "flock", "school", "chorus", "signs", "pursuit", "tide", "surface water", "amphibious", "flight"],
  },
  {
...
export const TUTORIAL_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: "whats-new-coldwater-glint",
        audience: "all",
        title: "Coldwater glint",
        body: "Coldwater Glint is this unpublished local candidate. It extends the catalog to twenty-eight records through a separate sparse polar-shore ecology layer beside the exact Open Country Ledger and Alpine children. Rare seed-stable cold saline shoreline habitat may support one conserved non-addressable Atlantic-capelin school; unsupported coast remains honestly empty. The school uses the same policy-driven tidal aggregate owner as established shoreline ecology, so current water depth controls usable anchors and visible activity while its entire admitted population—up to sixty-four units—remains conserved through tide, density cadence, dormant time, save, reload, and region streaming. A lawfully placed aerial surface observer can notice only anonymous aquatic activity through current line of sight and apply bounded nonlethal pressure through shared rules; occlusion prevents both observation and response, and no exact fish, capture, injury, death, body, item, or cargo effect appears. Chart and Relief render low-cost surface dimples and brief glints, while quick inspection and ABOUT reveal only observed aquatic signs, never the hidden species, count, anchor, or offscreen event. Base, Alpine, and polar layers enter one global group-atomic materialization and conservation commit capped at twenty-four addressable actors; the school itself receives no actor allowance. Outer save 27 adds regional ecology root version 3 around the exact version-2 child and authenticates one sealed outer-version-26 save for exact-once adoption. This is one polar forage seam, not complete Wave F: it adds no Arctic fox, polar bear, seal, new seabird, snow or ice behavior, mortality, capture, reproduction, audible Living Voice, fishing, or worldwide bestiary.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "A directly visible deer, gull, black bear, domestic cat, domestic chicken, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, or golden eagle offers WAIT AND WATCH, ROUTE AROUND THIS SPOT, and LEAVE. WAIT briefly stops the current automatic route. ROUTE AROUND must keep the same destination and find a real line outside the observed animal's area; if that fails, your previous route and choice history remain unchanged. LEAVE closes the observation rather than moving the animal. Rat, frog, silverside, fiddler-crab, and pika sign ABOUT is close-only because a population sign is not an actor; rabbit and fox movement signs are not targetable.",
      },
      {
      ...
      },
      {
        ...
        body: "Each representative—including every free-ranging cat, domestic chicken, domestic goat, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, and golden eagle—keeps its stable identity and population membership. Flocks, herds, sounders, and packs retain their stable groups; cougar, brown bear, and golden eagle remain solitary, and domestic groups also retain settlement custody. A saved social group is one indivisible materialization-cap unit: either every member is admitted to detailed simulation or the whole group remains coarse. An exact group member beyond the current frame receives no local observation or locomotion input merely because a peer is visible. Outside the active field, an individual coarse step applies only the remaining saved intent to physiology, ages existing perception without adding facts, and invents no hidden target, food, or player event. If more lawful independent individuals intersect the active field than can receive full detail, exact spatial top-K selection uses distance and stable identity across both base and Alpine owners while every overflow actor remains preserved. Returning restores the same saved actors rather than rolling replacements because the camera moved. Rat, frog, silverside, fiddler-crab, and pika populations preserve their own stable aggregate identities instead of pretending to be individuals.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: [
          "The seven Wave-B roles, Wave-C tidal roles, bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices, the five Alpha-30/31 additions, the Alpine triad, and the polar-shore forage school now feed the same role, perception, movement, group, aggregate, ridge-activity, tide, physical-item, plural-custody, typed-home, working-assignment, recovery, mortality, body, and presentation contracts instead of hardcoded species or pair lists.",
          "The current twenty-eight-record catalog preserves the exact signed-region base, derives mountain-goat, American-pika, and golden-eagle populations through one sparse Alpine layer, and derives one Atlantic-capelin school through a separate sparse polar-shore layer. Mountain goats form a HERD, pikas and capelin remain non-addressable aggregates, and golden eagles remain solitary. Every base, Alpine, and polar owner shares one global group-atomic materialization cap. This does not create distant settlements, storage, livestock homes, recovery networks, remaining polar breadth, or complete Wave F. Role-driven wolf or cougar pursuit may pressure eligible prey, while the only harmful live-animal contact in this build remains exact contact with a currently identified solitary addressable marsh rabbit; grouped elk, grouped deer, every social-group member, all three Alpine species, and capelin cannot be harmed. Brown bear and golden eagle have no live-prey pursuit or contact. Player, dog, human, and broader animal mortality remain absent. A boar, wolf, cougar, or brown bear may claim and consume finite resource from an existing body only after lawful sight and reach.",
          ...
          "Species-directed dog interaction with wild boar, elk, gray wolf, cougar, brown bear, mountain goat, pika, golden eagle, and capelin is an intentional no-response and remains unimplemented; ordinary lawful large-predator perception may still drive a non-harmful dog or porter reaction. Boar, elk, and wolf voice patterns are foundation-only and not audible; cougar, brown-bear, mountain-goat, pika, golden-eagle, and capelin voice behavior is not implemented. Tactical pack combat, new mortality, live-prey capture or exact pika or capelin targets, persistent tracks for the latest additions, reproduction, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent and insects, complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, ecological migration, remaining polar breadth, complete Wave F, worldwide species breadth and storehouses, and the full bestiary are not live yet.",
    ...
    steps: [
      {
        ...
        body: [
          ...
          "Outer save version 27 adds regional ecology root version 3. Its base child is the exact version-2 base-and-Alpine composite, which in turn preserves the exact version-1 Open Country Ledger ecology, habitat version 11 as sealed compatibility authority, core-ecology patch version 3, aggregate ecology record version 5, settlement ecology version 4, working-animal state version 2, and every earlier population, actor, group, item, Promise, home, relationship, task, recovery case, store fact, world fact, mortality record, physical body, claim, and consumption record. One separate sparse polar-shore child owns only the capelin lineage and true deviations.",
          "A sealed outer-version-26 Talus and Sky save is authenticated and adopted exactly once into version 27. Its complete version-2 child and original outer integrity remain the adoption witness; the capelin lineage is derived alongside it without rewriting, renumbering, redistributing, or retiring any base or Alpine wildlife. The supported version-25 path first performs its existing exact version-2 adoption and then wraps that result. All three children enter one deterministic group-atomic materialization and conservation commit.",
          "Re-saving and reloading cannot reroll a regional, Alpine, or polar lineage; duplicate or renumber an actor, aggregate, population, group, allocation, body, item, or claim; rewrite an existing injury or death; restore consumed resource; replay a meal; or turn an unseen incident into player knowledge. Pristine signed-region, Alpine, and polar baselines are rederived instead of saved, while only actual deviations, promoted or migrated identities, bodies, claims, and transaction receipts consume regional storage. The existing Open Country Ledger disposition, Alpine adoption, working-animal transition, and domestic recovery remain exact and cannot replay.",
        ].join(" "),
      },
      {
    ...
    steps: [
      {
        ...
        body: [
          ...
          "The twenty-eight-record species catalog preserves eligible existing wild populations through the exact Open Country Ledger signed-region ecology, the sparse Alpine layer, and one separate sparse polar-shore sibling. Lawful empty country remains empty. Rare supported cold saline shoreline may contain one conserved non-addressable Atlantic-capelin school; ridge habitat may support a mountain-goat HERD, an American-pika talus aggregate, and a solitary golden eagle. The settlement home keeps bounded brown rats and anchored chicken and domestic-goat homes; its free-ranging domestic cat appears only when habitat supports it.",
          "Population lineage remains distinct from present residence. Every base, Alpine, and polar owner enters one global group-atomic stable-distance top-K plan capped at twenty-four addressable actors, while authoritative density is measured before that cap; the capelin aggregate consumes no actor slot. Shared tide and density policy moves only conserved school units among authenticated water anchors. A lawfully seeing aerial observer can create bounded nonlethal pressure, while occlusion prevents that response. The existing mortality path remains limited to a marsh fox, gray wolf, or cougar exactly contacting a currently identified eligible solitary marsh rabbit; the Alpine and polar additions cannot enter it.",
          "Chart, Relief, quick inspection, ABOUT, and EVENTS expose only current lawful knowledge, never a hidden census, target, migration disposition, or retrospective offscreen story. Outer save version 27 adds regional ecology root version 3 around the exact version-2 base-and-Alpine composite plus a sparse polar-shore child, and authenticates one sealed outer-version-26 world for exact-once adoption. Pristine baselines are rederived and only real deviations persist. Habitat version 11 remains sealed compatibility authority, core ecology remains patch version 3, and aggregate ecology remains record version 5. Embedded simulation snapshots remain perception-aware format 4 and rules 6. Perpetual play remains active.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. The bounded twenty-eight-record catalog includes a sparse Alpine triad and one sparse polar-shore forage school, not complete Wave F, worldwide species breadth, or a complete bestiary. Physical loose provisions, store produce, and finite bodies can be perceived, claimed, and consumed only through current bounded owners. The only current harmful live-animal seam is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit; Alpine species, capelin, brown bears, grouped animals, players, humans, dogs, and broader wildlife cannot enter this harmful ecology path. Golden-eagle pressure on pikas and lawful aerial pressure on capelin are nonlethal and cannot capture or select an exact animal. Arctic foxes, polar bears, seals, new polar seabirds, tactical pack combat, ecological migration behavior, wider aquatic and scavenger relationships, broader mortality, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent, insects, broad attack and health systems, complete audible Living Voice, complete scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, remaining polar breadth, and the full bestiary remain planned. Shared invariants, deterministic properties, conservation, bounded fuzzing and performance, and representative emergent scenarios validate the reusable scaffold rather than species-by-species or N² pair tests; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 44 as const;
