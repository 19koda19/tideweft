  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The final bounded starting-harbor Wave-C role slice may add at most one persistent North American river otter only where fish, crab, usable water, and a dry shore haulout all support it. Shared amphibious locomotion carries the same actor between shore and surface water; a current anonymous AQUATIC ACTIVITY observation can guide its water behavior only after shared terrain-occluded vision lawfully produces that fact. The same broad role policy supplies nonlethal fish and crab pressure, while ordinary physical-item claims resolve one representative loose-food contest without duplication. Exact spatial top-K selection keeps the active field at 24 individuals. Shared invariants, property and bounded-fuzz checks, and representative scenarios validate these abstractions instead of a species-by-species or N² test matrix. This does not add live-prey capture or consumption, harmful attacks, injury, mortality, carcasses, fishing, sound or track evidence, reproduction, migration, worldwide ecology, completed Wave C, or completed Directive 04_1.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "The seven Wave-B ecological roles remain closed only for one bounded habitat-derived assemblage near the stable starting harbor. The Tide Table, one-duck waterfowl unit, and one-otter amphibious unit are three bounded Wave-C slices there. Shared role, capability, perception, movement, group, aggregate, tide, item-claim, and presentation contracts replace hardcoded pair lists, but do not create ecology in every distant region or complete Wave C. Animals do not attack, receive injuries, die, leave carcasses, or consume live prey in this build. The duck has no flock, nesting, reproduction, migration, capture, mortality, carcass, or consumption state. The otter likewise has no capture, live-prey consumption, harmful attack, injury, mortality, carcass, fishing, call, track-evidence, reproduction, or migration state. Complete sound, scent and evidence tracking, foliage consumption, complete circadian behavior, further species, wider aquatic and scavenger ecology, worldwide populations, the full bestiary, and Directive 04_1 completion are not live yet. Shared invariants, property and bounded-fuzz checks, conservation rules, and representative interactions test the reusable scaffold instead of requiring a species-by-species or N² pair matrix.",
      },
    ],
  },
  {
...
export const TUTORIAL_CONTENT_VERSION = 31 as const;
