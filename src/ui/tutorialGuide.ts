...
export const TUTORIAL_PLANNED_MECHANICS = [
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans remain the current human population. One independently generated dog remains paired with a porter without ownership, while one separate settlement-custodied working dog watches near the existing two-goat herd from its own kennel relationship. The starting settlement separately retains its bounded brown-rat population area and anchored chicken and goat homes; its free-ranging domestic cat is habitat-optional. Eligible existing wild populations from the current twenty-four-record catalog now derive across signed regions from habitat, capacity, food or prey support, territory, and density rather than being piled around the starting harbor, and a region may be honestly empty. Rats, frogs, silversides, and fiddler crabs remain conserved aggregate populations rather than individual actors; the other eligible wildlife use bounded persistent representatives. Each chicken, goat, and dog remains an individual, and the domestic groups use explicit settlement-custody relationships. The only current animal mortality is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit, with one conserved finite rabbit body; brown bears, players, dogs, humans, social-group members, and broader animals cannot enter that harmful path. Additional dogs and wildlife species beyond this bounded roster, worldwide species breadth and domestic ownership, reproduction, population recovery, broader attacks and aftermath, a new guardian sound, general scent and evidence tracking, rumors, companions, complete circadian life, foliage browsing, herding, guaranteed livestock defense, and the full bestiary remain planned.",
    keywords: ["npc", "dog", "cat", "rat", "rabbit", "fox", "crow", "harrier", "frog", "silverside", "fiddler crab", "snowy egret", "American black duck", "North American river otter", "otter", "waterfowl", "chicken", "domestic", "livestock", "bear", "bird", "wildlife", "companion", "identity", "about", "perception", "ecology", "habitat", "population", "herd", "flock", "school", "chorus", "signs", "pursuit", "tide", "surface water", "amphibious", "flight"],
  },
  {
...
export const TUTORIAL_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "Open country ledger",
        body: "Open Country Ledger adds no species. This release distributes eligible existing wildlife through deterministic signed-region habitat, carrying capacity, food or prey support, territory, and density budgets; a region may be honestly empty and unused capacity stays unused. Fresh-world starting density is measured before materialization instead of hiding a wildlife pile behind the visual cap. The settlement home retains its brown-rat population and anchored chicken and goat homes, while a free-ranging domestic cat is habitat-optional. Population lineage remains separate from present residence, and every active ecology owner contributes to one global group-atomic stable-distance top-K plan capped at twenty-four actors. One root-wide snapshot allows lawful visual, tidal-activity, and alarm perception across owner boundaries. The existing narrow mortality seam can cross the same boundary only when a marsh fox, gray wolf, or cougar exactly contacts a currently identified eligible solitary marsh rabbit; the victim owner retires it once and owns the conserved physical body. Chart, Relief, quick inspection, ABOUT, and EVENTS reveal only current lawful knowledge. Outer save 25 adds regional ecology root version 1 and authenticates one normalized sealed version-24 High Country Shadows save exactly once. Its deterministic group-atomic disposition retains, redistributes, or explicitly retires compatibility wildlife without changing stable identity, population truth, history, mortality, bodies, items, cargo, or Promises. Compatibility retirement is a non-death record; pristine regional baselines are rederived, while only real deviations persist. The catalog remains twenty-four records. Worldwide species breadth, ecological migration behavior, reproduction, population recovery, general tactical mortality, complete scent tracking, and the full bestiary remain outside this release.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    summary: "The original harbor country's 42 humans, its first independent dog, settlement-home animals, signed-region wildlife, and directly observed aggregate-population signs use one knowledge-honest boundary; ABOUT reveals only what you can see or have learned.",
    keywords: ["person", "resident", "porter", "dog", "cat", "rat", "rabbit", "fox", "crow", "harrier", "frog", "silverside", "fiddler crab", "snowy egret", "American black duck", "duck", "waterfowl", "North American river otter", "otter", "wild boar", "boar", "elk", "gray wolf", "wolf", "cougar", "brown bear", "sounder", "pack", "temperate upland", "forest edge", "amphibious", "diving", "chorus", "quartering", "wading", "dabbling", "surface swimming", "flight", "perch", "mobbing", "pursuit", "paired tracks", "pawprints", "burrows", "surface dimples", "signs", "deer", "gull", "black bear", "wildlife", "alarm", "food", "scavenge", "scent", "help", "wait", "reroute", "leave", "persistence", "npc", "about", "inspect", "greet", "observed", "known", "identity", "emotion", "weather", "vision", "hearing", "attention", "search", "habitat", "population", "herd", "flock", "school", "tide", "shallow water", "aftermath", "absence", "materialization"],
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Across the signed world, terrain and habitat derive each local population from carrying capacity, food or prey support, territory, and density rather than forcing a fixed roster. The mixed-resolution model records capacity, population pressure, and trend while materializing only a bounded set of representatives; a species with too little support is genuinely absent instead of being rerolled. When present in numbers, deer and elk persist in herds, gulls and fish crows in flocks, wild boar in sounders, and gray wolves in packs. The starting settlement separately retains one stable two-to-three-member domestic-chicken flock, exactly two domestic goats in one herd, and one additional seed-stable working dog under settlement custody; these are homes and relationships, not wild habitat populations. Black bears, cougars, brown bears, and northern harriers stay solitary; snowy egrets, American black ducks, and habitat-supported North American river otters use persistent individual identities. Free-ranging domestic cats, marsh rabbits, and marsh foxes also use persistent individual representatives. Brown rats, southern leopard frogs, Atlantic silversides, and Atlantic marsh fiddler crabs remain conserved population-area or school aggregates and never become clouds of fake actors. One global group-atomic plan selects the nearest 24 eligible individuals across all active ecology owners while every overflow actor remains preserved in coarse state.",
      },
      {
      ...
      },
      {
        ...
        body: "Each representative—including every free-ranging cat, domestic chicken, domestic goat, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, and brown bear—keeps its stable identity and population membership. Flocks, herds, sounders, and packs retain their stable groups; cougar and brown bear remain solitary, and domestic groups also retain settlement custody. A saved social group is one indivisible materialization-cap unit: either every member is admitted to detailed simulation or the whole group remains coarse. An exact group member beyond the current frame receives no local observation or locomotion input merely because a peer is visible. Outside the active field, an individual coarse step applies only the remaining saved intent to physiology, ages existing perception without adding facts, and invents no hidden target, food, or player event. If more lawful independent individuals intersect the active field than can receive full detail, exact spatial top-K selection uses distance and stable identity while every overflow actor remains preserved. Returning restores the same saved actors rather than rolling replacements because the camera moved. Rat, frog, silverside, and fiddler-crab populations preserve their own stable aggregate identities instead of pretending to be individuals.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: [
          "The seven Wave-B roles, Wave-C tidal roles, bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices, and the five Alpha-30/31 additions now feed the same signed-region role, perception, movement, group, aggregate, tide, physical-item, plural-custody, typed-home, working-assignment, recovery, mortality, body, and presentation contracts instead of hardcoded species or pair lists.",
          "The current twenty-four-record catalog can derive eligible wild populations across signed regions while the starting settlement separately retains bounded rats and anchored chicken and goat homes. Eligible boar, elk, and wolves use SOUNDER, HERD, and PACK while cougar and brown bear remain solitary. This does not create distant settlements, storage, livestock homes, or recovery networks. Role-driven wolf or cougar pursuit may pressure eligible prey, while the only harmful live-animal contact in this build remains exact contact with a currently identified solitary addressable marsh rabbit; grouped elk, grouped deer, and every other social-group member cannot be harmed. Brown bear has no live-prey pursuit or contact. Player, dog, human, and broader animal mortality remain absent. A boar, wolf, cougar, or brown bear may claim and consume finite resource from an existing body only after lawful sight and reach.",
          ...
          "Species-directed dog interaction with wild boar, elk, gray wolf, cougar, and brown bear is an intentional no-response and remains unimplemented; ordinary lawful large-predator perception may still drive a non-harmful dog or porter reaction. Boar, elk, and wolf voice patterns are foundation-only and not audible; cougar and brown-bear voice behavior is not implemented. Tactical pack combat, broader mortality, persistent tracks for the two latest additions, population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent and insects, complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, ecological migration, worldwide species breadth and storehouses, and the full bestiary are not live yet.",
    ...
    steps: [
      {
        ...
        body: [
          ...
          "Outer save version 25 adds regional ecology root version 1 while preserving core-ecology patch version 3, aggregate ecology record version 5, settlement ecology version 4, working-animal state version 2, habitat version 11 as sealed compatibility authority, and every earlier population, actor, group, item, Promise, home, relationship, task, recovery case, store fact, world fact, mortality record, physical body, claim, and consumption record.",
          "A normalized sealed version 24 High Country Shadows save migrates exactly once. One deterministic group-atomic disposition retains, redistributes, or explicitly retires each compatibility wildlife unit while stable identity, population conservation, group membership, origin, history, bodies, items, cargo, Promises, and cross-owner references remain exact. Compatibility retirement is a persisted non-death tombstone, not a hidden kill or fabricated carcass.",
          "Re-saving and reloading cannot reroll the regional baseline or compatibility disposition; duplicate or renumber an actor, population, group, allocation, body, item, or claim; rewrite an existing injury or death; restore consumed resource; replay a meal; or turn an unseen incident into player knowledge. Pristine signed-region baselines are rederived instead of saved, while only actual deviations, promoted or migrated identities, bodies, claims, and transaction receipts consume regional storage. The existing working-animal and domestic-recovery transitions still recover exactly once.",
        ].join(" "),
      },
      {
    ...
    steps: [
      {
        ...
        body: [
          ...
          "The twenty-four-record species catalog now distributes eligible existing wild populations through deterministic signed-region habitat, carrying capacity, food or prey support, territory, and density budgets. Lawful empty country remains empty. The settlement home keeps bounded brown rats and anchored chicken and goat homes; its free-ranging domestic cat appears only when habitat supports it. No species is added in Open Country Ledger.",
          "Population lineage remains distinct from present residence. Every active owner enters one global group-atomic stable-distance top-K plan capped at twenty-four actors, while authoritative density is measured before that cap. One root-wide current snapshot lets visual actors, anonymous tidal activity, and alarms cross owner boundaries lawfully. The existing mortality path may cross that boundary only when a marsh fox, gray wolf, or cougar exactly contacts a currently identified eligible solitary marsh rabbit; the victim owner commits the one retirement and conserved body.",
          "Chart, Relief, quick inspection, ABOUT, and EVENTS expose only current lawful knowledge, never a hidden census, target, migration disposition, or retrospective offscreen story. Outer save version 25 adds regional ecology root version 1 and adopts one normalized sealed version-24 world through a deterministic retain, redistribute, or non-death-retire transaction. Pristine regional baselines are rederived and only real deviations persist. Habitat version 11 remains sealed compatibility authority, core ecology remains patch version 3, and aggregate ecology remains record version 5. Embedded simulation snapshots remain perception-aware format 4 and rules 6. Perpetual play remains active.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. Regional distribution covers the current bounded twenty-four-record catalog, not worldwide species breadth, and Open Country Ledger adds no species. Physical loose provisions, store produce, and finite bodies can be perceived, claimed, and consumed only through current bounded owners. The only current harmful live-animal seam is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit; brown bears, grouped animals, players, humans, dogs, and broader wildlife cannot enter this harmful ecology path. Tactical pack combat, ecological migration behavior, wider aquatic and scavenger relationships, broader mortality, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent, insects, broad attack and health systems, complete sound, scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, and the full bestiary remain planned. Shared invariants, deterministic properties, conservation, bounded fuzzing and performance, and representative emergent scenarios validate the reusable scaffold rather than species-by-species or N² pair tests; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 42 as const;
