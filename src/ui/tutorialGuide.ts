  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        audience: "all",
        title: "The yard flock",
        body: "The Yard Flock adds one stable group of two or three individual domestic chickens beside the starting-harbor store. The settlement's real keeper, physical store lot, bounded yard anchor, and custody relationship give them a home without creating chicken-only perception or pathfinding. A hungry flock member must directly perceive accessible food, approach through shared terrestrial locomotion, and win the ordinary authenticated claim before exactly one produce unit leaves the open store. Securing the door removes that opportunity. Chickens share broad human, dog, predator, food, and flock-alarm behavior through the Living Weft abstractions; hidden activity stays world truth rather than becoming player narration. Chart, Relief, quick inspection, and ABOUT show only what is currently visible. Outer save 17 adopts one sealed version-16 world exactly once, appending habitat 8 and settlement ecology 2 while preserving the entire earlier habitat and store record. Shared invariants, signed-coordinate properties, physical conservation, deterministic replay and migration attacks, bounded performance, and one representative witnessed yard event validate the architecture—there is no species-by-species or N² pair matrix. This is one local flock, not worldwide livestock, herding, guardian behavior, schedules, mortality, carcasses, eggs, nesting, reproduction, live-prey consumption, the full bestiary, or completed Directive 04_1.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Two or three domestic chickens share one stable flock and one settlement-custody relationship around the storehouse yard. They use the ordinary animal senses, attention, group alarm, terrain movement, and broad ecological roles rather than private detection or pair scripts. A hungry member can investigate the exact open-store lot, walk into its structural access area, and consume one physical unit through a staged transaction. A secured store cannot become food knowledge or a claim. You receive the feeding event only when the bird is directly in view at that moment; later sight does not reveal it retroactively.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "The seven Wave-B roles, Wave-C tidal roles, and first Wave-D yard flock remain one bounded habitat-derived integration near the stable starting harbor. The Tide Table, one-duck waterfowl unit, one-otter amphibious unit, reusable activity profiles, Storehouse Door, and domestic chickens share versioned role, perception, movement, group, aggregate, tide, physical-item, custody, and presentation contracts instead of hardcoded species or pair lists. The Storehouse Door and Yard Flock do not create storage or livestock ecology in every settlement. This does not create ecology in every distant region or complete Directive 04_1. Animals do not attack, receive injuries, die, leave carcasses, or consume live prey in this build. Chickens have no authored call, track evidence, eggs, nesting, reproduction, complete schedule, autonomous home return, guardian behavior, herding behavior, or cross-region migration. Complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, wider livestock, further species, wider aquatic and scavenger ecology, worldwide populations and storehouses, and the full bestiary are not live yet. Shared invariants, property and bounded-fuzz checks, conservation rules, performance budgets, and representative emergent interactions test the reusable scaffold instead of requiring a species-by-species or N² pair matrix.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "The game maintains one local autosave, using browser storage with a fallback. It saves periodically, when the page hides or closes, when the title opens, and when Quiet Hour begins. Outer save version 17 preserves habitat version 8, aggregate ecology record version 4, settlement ecology version 2, all four aggregate populations and their signs, persistent herds and flocks, bounded representatives and their saved intent, tidal, waterfowl, otter, and domestic-yard anchors, the durable tide-operation clock, deterministic top-K materialization state, movement evidence, physical food history, and the starting-harbor store's domestic custody and food-use history. A sealed version 16 Storehouse Door save migrates exactly once: every established habitat-7 population and anchor, actor, group, aggregate unit, store and lot identity, closure, loss event, item, Promise, custody record, disturbance, evidence record, and world fact stays exact before the stable two-to-three-chicken flock and its one settlement relationship are appended. The store lot remains distinct from abstract settlement food. Re-saving and reloading cannot reroll a chicken or anchor, duplicate a group or provision, reopen a secured door, replay a store loss, chicken meal, or tidal-edge opportunity, exceed the 24-actor materialization cap, or rewrite older ecology.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 34 as const;
