...
export const TUTORIAL_PLANNED_MECHANICS = [
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans remain the current human population. One independently generated dog remains paired with a porter without ownership, while one separate settlement-custodied working dog watches near the existing two-goat herd from its own kennel relationship. The starting settlement separately retains its bounded brown-rat population area and anchored chicken and goat homes; its free-ranging domestic cat is habitat-optional. The current thirty-one-record catalog preserves the signed-region base, Alpine, polar-shore, and Arctic-fox layers, then adds one sparse polar-consumer sibling. Supported capelin-backed cold saline shore may admit one solitary harbor seal with an exact foraging-water and dry-haulout pair, then a rarer solitary polar bear only where that seal candidate exists. Every layer shares one group-atomic materialization cap, while honest absence remains valid. Rats, frogs, silversides, fiddler crabs, pikas, and capelin are conserved aggregates; eligible larger wildlife use bounded persistent representatives. The only current animal mortality remains exact contact by a marsh fox, gray wolf, or cougar against one identified eligible solitary marsh rabbit. Harbor seals and polar bears add no capture, kill, consumption, mortality, body, player harm, dog harm, or human harm. Additional wildlife beyond this bounded roster, Wave-G breadth, Directive 04_1 completion, worldwide ecology, reproduction, population recovery, broader attacks, audible Living Voice, sea ice, snow behavior, general scent and evidence tracking, rumors, companions, complete circadian life, foliage browsing, herding, and the full bestiary remain planned.",
    keywords: ["npc", "dog", "cat", "rat", "rabbit", "fox", "Arctic fox", "crow", "harrier", "frog", "silverside", "fiddler crab", "snowy egret", "American black duck", "North American river otter", "otter", "waterfowl", "mountain goat", "American pika", "golden eagle", "harbor seal", "polar bear", "haulout", "talus", "alpine", "chicken", "domestic", "livestock", "bear", "bird", "wildlife", "companion", "identity", "about", "perception", "ecology", "habitat", "population", "herd", "flock", "school", "chorus", "signs", "pursuit", "tide", "surface water", "amphibious", "flight"],
  },
  {
...
export const TUTORIAL_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: "whats-new-polar-consumers",
        audience: "all",
        title: "Breath between tide and shore",
        body: "Alpha 36 Breath Between Tides is this local unpublished SOURCE_CANDIDATE; it has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED. It preserves the exact twenty-nine-record Alpha-35 catalog, appends harbor seal as record 30 and polar bear as record 31, and adds one sparse capelin-backed polar-consumer sibling. Viable cold saline shore may admit one solitary seal with an authenticated foraging-water and dry-haulout pair; only an exact seal candidate can support the rarer solitary bear. The seal uses shared amphibious activity, and both animals compose shared identity, condition, perception, attention, locomotion, dormant autonomy, projection, and ABOUT owners rather than species controllers. Direct current sight can yield conserved nonlethal seal pressure on capelin or polar-bear pursuit with seal flight; occluding terrain removes those observations and responses. No capture, kill, consumption, new mortality, body, player harm, dog harm, item, or cargo effect is created. Chart, Relief, quick inspection, and ABOUT reveal only lawfully observed approximate form, condition, size, and behavior on desktop and touch. RegionalEcologyStateV5 wraps the exact V4 child beside the sparse polar-consumer root, and outer save version 29 authenticates one sealed outer-version-28 Alpha-35 save for exact-once adoption. All five ecology layers share one global group-atomic cap of twenty-four addressable actors and one atomic commit. This completes bounded Wave-F role coverage, not Wave G or Directive 04_1, and adds no sea ice, snow behavior, reproduction, or audible Living Voice.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Across the signed world, terrain and habitat derive each local population from carrying capacity, food or prey support, territory, and density rather than forcing a fixed roster. The mixed-resolution model records capacity, population pressure, and trend while materializing only a bounded set of representatives; a species with too little support is genuinely absent instead of being rerolled. When present in numbers, deer, elk, and mountain goats persist in herds, gulls and fish crows in flocks, wild boar in sounders, and gray wolves in packs. The starting settlement separately retains one stable two-to-three-member domestic-chicken flock, exactly two domestic goats in one herd, and one additional seed-stable working dog under settlement custody; these are homes and relationships, not wild habitat populations. Black bears, cougars, brown bears, northern harriers, golden eagles, Arctic foxes, harbor seals, and polar bears stay solitary. Snowy egrets, American black ducks, and habitat-supported North American river otters use persistent individual identities; harbor seals and polar bears do too. Free-ranging domestic cats, marsh rabbits, and marsh foxes also use persistent individual representatives. Brown rats, southern leopard frogs, Atlantic silversides, Atlantic marsh fiddler crabs, American pikas, and Atlantic capelin remain conserved population-area or school aggregates and never become clouds of fake actors. One global group-atomic plan selects the nearest 24 eligible individuals across every active base, Alpine, polar-shore, cold-shore, and polar-consumer ecology owner while every overflow actor remains preserved in coarse state.",
      },
      {
      ...
      },
      {
        ...
        body: "Six existing roles now select neutral activity through reusable perch/watch, low-quartering, tidal-wader, dabbling-waterfowl, shore-water-forager, and aerial-surface-opportunist profiles. Each profile must match the actor's real capabilities, allowed movement media, authenticated destination, observation boundary, visible signal, and bounded daylight/rest scope. The gull is the aerial surface opportunist: only a current anonymous terrain-occluded AQUATIC ACTIVITY observation can draw it from its habitat anchor to circle by air. It does not swim, wade, aquatic-forage, capture prey, or inherit another profile's powers. Any immediate lawful threat, escape, alarm, food, guard, pursuit, retreat, or scavenging intent outranks this neutral routine.",
      },
      {
        id: "shadow-overhead",
        audience: "all",
      ...
      },
      {
        ...
        body: "A directly visible deer, gull, black bear, domestic cat, domestic chicken, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, golden eagle, Arctic fox, harbor seal, or polar bear offers WAIT AND WATCH, ROUTE AROUND THIS SPOT, and LEAVE. WAIT briefly stops the current automatic route. ROUTE AROUND must keep the same destination and find a real line outside the observed animal's area; if that fails, your previous route and choice history remain unchanged. LEAVE closes the observation rather than moving the animal. Rat, frog, silverside, fiddler-crab, pika, and capelin sign ABOUT is close-only because a population sign is not an actor; rabbit and fox movement signs are not targetable.",
      },
      {
      ...
      },
      {
        ...
        body: "Each representative—including every free-ranging cat, domestic chicken, domestic goat, marsh rabbit, marsh fox, fish crow, northern harrier, snowy egret, American black duck, North American river otter, wild boar, elk, gray wolf, cougar, brown bear, mountain goat, golden eagle, Arctic fox, harbor seal, and polar bear—keeps its stable identity and population membership. Flocks, herds, sounders, and packs retain their stable groups; cougar, brown bear, golden eagle, Arctic fox, harbor seal, and polar bear remain solitary, and domestic groups also retain settlement custody. A saved social group is one indivisible materialization-cap unit: either every member is admitted to detailed simulation or the whole group remains coarse. An exact group member beyond the current frame receives no local observation or locomotion input merely because a peer is visible. Outside the active field, an individual coarse step applies only the remaining saved intent to physiology, ages existing perception without adding facts, and invents no hidden target, food, or player event. If more lawful independent individuals intersect the active field than can receive full detail, exact spatial top-K selection uses distance and stable identity across base, Alpine, polar-shore, cold-shore, and polar-consumer owners while every overflow actor remains preserved. Returning restores the same saved actors rather than rolling replacements because the camera moved. Rat, frog, silverside, fiddler-crab, pika, and capelin populations preserve their own stable aggregate identities instead of pretending to be individuals.",
      },
      {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: [
          "The seven Wave-B roles, Wave-C tidal roles, bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices, the five Alpha-30/31 additions, the Alpine triad, the polar-shore forage school, one cold-shore Arctic fox, and the polar-consumer seal-and-bear vertical now feed the same role, perception, movement, group, aggregate, ridge-activity, tide, amphibious-activity, physical-item, plural-custody, typed-home, working-assignment, recovery, mortality, body, and presentation contracts instead of hardcoded species or pair lists.",
          "The current thirty-one-record catalog preserves the exact signed-region base, derives mountain-goat, American-pika, and golden-eagle populations through one sparse Alpine layer, retains one Atlantic-capelin school through a separate sparse polar-shore layer, derives one solitary addressable Arctic fox through a cold-shore sibling only where that exact forage substrate supports it, and adds a sparse polar-consumer sibling. An authenticated foraging-water and dry-haulout pair may support one solitary harbor seal; a rarer solitary polar bear exists only where that exact seal candidate exists. Mountain goats form a HERD, pikas and capelin remain non-addressable aggregates, and golden eagles, Arctic foxes, harbor seals, and polar bears remain solitary. Every base, Alpine, polar-shore, cold-shore, and polar-consumer owner shares one global group-atomic materialization cap of 24 addressable actors. This completes the directive's bounded Wave-F role coverage, not Wave G, Directive 04_1, worldwide polar ecology, biodiversity breadth, or the full bestiary. Role-driven wolf or cougar pursuit may pressure eligible prey, while the only harmful live-animal contact in this build remains exact contact with a currently identified solitary addressable marsh rabbit; grouped elk, grouped deer, every social-group member, all Alpine species, capelin, Arctic fox, harbor seal, and polar bear cannot be harmed. Brown bear, golden eagle, Arctic fox, harbor seal, and polar bear have no harmful live-prey contact. Player, dog, human, and broader animal mortality remain absent. A boar, wolf, cougar, or brown bear may claim and consume finite resource from an existing body only after lawful sight and reach.",
          ...
          "A lawfully perceived domestic dog can apply generic pressure to an Arctic fox and drive ordinary flee or retreat without a species-pair script; species-directed dog interaction with wild boar, elk, gray wolf, cougar, brown bear, mountain goat, pika, golden eagle, capelin, harbor seal, and polar bear remains an intentional no-response. Direct sight can yield seal-to-capelin conserved nonlethal pressure or polar-bear pursuit with seal flight, while occlusion removes both response paths. Boar, elk, and wolf voice patterns are foundation-only and not audible; cougar, brown-bear, mountain-goat, pika, golden-eagle, capelin, Arctic-fox, harbor-seal, and polar-bear voice behavior is not implemented. Tactical pack combat, new mortality, live-prey capture or exact pika or capelin targets, seal capture, consumption, sea ice, snow behavior, complete evidence tracking, reproduction, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent and insects, complete sound, general scent propagation, foliage consumption, complete circadian behavior, ecological migration, Wave G, Directive 04_1 completion, worldwide species breadth and storehouses, and the full bestiary are not live yet.",
          "Shared invariants, property and bounded-fuzz checks, conservation rules, performance budgets, and representative emergent interactions test the reusable scaffold instead of requiring a species-by-species or N² pair matrix.",
        ].join(" "),
      },
    ],
  },
    ...
    steps: [
      {
        ...
        body: [
          ...
          "Outer save version 29 adds RegionalEcologyStateV5. Its first child is the exact RegionalEcologyStateV4 Alpha-35 composite, preserving the complete V4 base, Alpine, polar-shore, and cold-shore lineage and, through it, every exact earlier Open Country Ledger and Coldwater Glint adoption. Habitat version 11 remains sealed compatibility authority, core-ecology patch version 3, aggregate ecology record version 5, settlement ecology version 4, and working-animal state version 2 remain unchanged. One separate sparse polar-consumer sibling owns only harbor-seal and polar-bear resident deviations; the exact V4 child still owns Arctic fox and capelin.",
          "A sealed outer-version-28 Alpha-35 save is authenticated and adopted exactly once into version 29. Its complete RegionalEcologyStateV4 child and original outer integrity remain the adoption witness; the polar-consumer lineage is derived alongside it without rewriting, renumbering, redistributing, retiring, or relabeling any base, Alpine, polar-shore, or cold-shore wildlife. Supported older paths perform their existing exact adoptions before this wrapper is applied. All five ecology layers enter one deterministic group-atomic materialization and conservation commit capped at 24 addressable actors.",
          "Re-saving and reloading cannot reroll a regional, Alpine, polar-shore, cold-shore, or polar-consumer lineage; duplicate or renumber an actor, aggregate, population, group, allocation, body, item, or claim; rewrite an existing injury or death; restore consumed resource; replay a meal; or turn an unseen incident into player knowledge. Pristine signed-region, Alpine, polar-shore, cold-shore, and polar-consumer baselines are rederived instead of saved, while only actual deviations, promoted or migrated identities, bodies, claims, and transaction receipts consume regional storage. The existing Open Country Ledger disposition, Alpine adoption, Coldwater Glint adoption, Alpha-35 adoption, working-animal transition, and domestic recovery remain exact and cannot replay.",
        ].join(" "),
      },
      {
    ...
    steps: [
      {
        ...
        body: [
          ...
          "The thirty-one-record species catalog preserves eligible existing wild populations through the exact Open Country Ledger signed-region ecology, the sparse Alpine layer, the separate sparse polar-shore sibling, and the addressable cold-shore sibling, then adds a separate sparse polar-consumer sibling. Lawful empty country remains empty. Rare supported cold saline shoreline may contain one conserved non-addressable Atlantic-capelin school and one solitary Arctic fox. Only an authenticated foraging-water and distinct dry-haulout pair may support one solitary harbor seal; the rarer solitary polar bear is admitted only where that exact seal candidate exists. Ridge habitat may support a mountain-goat HERD, an American-pika talus aggregate, and a solitary golden eagle. The settlement home keeps bounded brown rats and anchored chicken and domestic-goat homes; its free-ranging domestic cat appears only when habitat supports it.",
          "Population lineage remains distinct from present residence. Every base, Alpine, polar-shore, cold-shore, and polar-consumer owner enters one global group-atomic stable-distance top-K plan capped at twenty-four addressable actors, while authoritative density is measured before that cap; aggregate capelin consume no actor slot. Shared tide and density policy moves only conserved school units among authenticated water anchors. A currently seeing Arctic fox or harbor seal can create generic nonlethal capelin pressure, while occlusion prevents observation and response. A currently visible polar bear can pursue a seal and the seal can flee through shared role, attention, locomotion, and amphibious-activity rules; occlusion likewise removes both responses. None of these interactions opens a capture, consumption, injury, death, body, item, cargo, player-harm, or dog-harm transaction. The existing mortality path remains limited to a marsh fox, gray wolf, or cougar exactly contacting a currently identified eligible solitary marsh rabbit; the Alpine, capelin, Arctic-fox, harbor-seal, and polar-bear additions cannot enter it.",
          "Chart, Relief, quick inspection, ABOUT, and EVENTS expose only current lawful knowledge, never a hidden census, target, attention state, migration disposition, or retrospective offscreen story. Outer save version 29 adds RegionalEcologyStateV5 around the exact RegionalEcologyStateV4 Alpha-35 child plus a sparse polar-consumer sibling, and authenticates one sealed outer-version-28 Alpha-35 world for exact-once adoption. Pristine baselines are rederived and only real deviations persist. Habitat version 11 remains sealed compatibility authority, core ecology remains patch version 3, and aggregate ecology remains record version 5. Embedded simulation snapshots remain perception-aware format 4 and rules 6. This Alpha 36 Breath Between Tides SOURCE_CANDIDATE remains strictly local and unpublished: it has not been pushed, published, deployed, run through remote CI or Pages, or LIVE_VERIFIED.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. The bounded thirty-one-record catalog includes a sparse Alpine triad, one sparse polar-shore forage school, one substrate-gated solitary Arctic fox, one foraging-water/dry-haulout-gated harbor seal, and a rarer seal-dependent polar bear. This completes the directive's bounded Wave-F role coverage, not Wave G, Directive 04_1, worldwide polar ecology, biodiversity breadth, or a complete bestiary. Physical loose provisions, store produce, and finite bodies can be perceived, claimed, and consumed only through current bounded owners. The only current harmful live-animal seam is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit; Alpine species, capelin, Arctic foxes, harbor seals, polar bears, brown bears, grouped animals, players, humans, dogs, and broader wildlife cannot enter this harmful ecology path. Golden-eagle pressure on pikas, visible Arctic-fox or harbor-seal pressure on capelin, and visible polar-bear pursuit with seal flight are nonlethal and cannot capture or select an exact aggregate animal. New polar seabirds, sea ice, snow behavior, tactical pack combat, ecological migration behavior, wider aquatic and scavenger relationships, new mortality or capture, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, fishing, carcass scent, insects, broad attack and health systems, audible Living Voice for the newest species, complete scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, Wave G, remaining worldwide polar breadth, and the full bestiary remain planned. Shared invariants, deterministic properties, conservation, bounded fuzzing and performance, and representative emergent scenarios validate the reusable scaffold rather than species-by-species or N² pair tests; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 46 as const;
