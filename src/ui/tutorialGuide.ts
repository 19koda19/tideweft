...
export const TUTORIAL_PLANNED_MECHANICS = [
  ...
  },
  {
    ...
    clarification: "The original harbor country's 42 humans remain the current human population. One independently generated dog remains paired with a porter without ownership, while one separate settlement-custodied working dog watches near the existing two-goat herd from its own kennel relationship. The starting settlement separately retains its bounded brown-rat population area and anchored chicken and goat homes; its free-ranging domestic cat is habitat-optional. The current twenty-seven-record catalog preserves the exact existing signed-region ecology and adds a separate sparse Alpine layer where supported mountain goats form a HERD, American pikas remain one conserved non-addressable talus aggregate, and a golden eagle remains solitary. Every layer shares one group-atomic materialization cap, while honest absence remains valid. Rats, frogs, silversides, fiddler crabs, and pikas are conserved aggregate populations rather than individual actors; the other eligible wildlife use bounded persistent representatives. Each chicken, domestic goat, mountain goat, dog, and eagle representative remains an individual, and domestic groups keep explicit settlement custody. The only current animal mortality is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit, with one conserved finite rabbit body; the Alpine trio, brown bears, players, dogs, humans, social-group members, and broader animals cannot enter that harmful path. Additional dogs and wildlife species beyond this bounded roster, polar breadth, complete Wave F, worldwide species breadth and domestic ownership, reproduction, population recovery, broader attacks and aftermath, a new guardian sound, general scent and evidence tracking, rumors, companions, complete circadian life, foliage browsing, herding, guaranteed livestock defense, and the full bestiary remain planned.",
...
export const TUTORIAL_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: "whats-new-open-country-ledger",
        audience: "all",
        title: "Talus and sky",
        body: "Talus and Sky extends the catalog to twenty-seven records through a separate sparse Alpine ecology layer beside the exact Open Country Ledger base. Where authoritative ridge habitat supports them, mountain goats persist as one group-atomic HERD, American pikas remain a conserved non-addressable talus aggregate revealed only through visible haypiles and talus signs, and a solitary golden eagle uses shared ridge soaring and perching. Mountain-goat travel uses the shared grade-aware terrain contract rather than a species-only pathfinder. A currently visible eagle may create role-based predator pressure that quiets pika activity or redistributes at most one existing population unit on a fixed opportunity; terrain occlusion prevents that observation, and the interaction cannot identify, capture, injure, kill, consume, or create an individual pika. Chart, Relief, quick inspection, and ABOUT show only lawful current actors and evidence. Both ecology layers enter one global group-atomic stable-distance top-K plan capped at twenty-four actors. Outer save 26 adds regional ecology root version 2, preserves the exact version-1 child, and authenticates one sealed version-25 Open Country Ledger save for exact-once adoption. Stable identity, groups, aggregate units, history, mortality, bodies, items, cargo, and Promises remain conserved. This is an Alpine first slice, not polar or complete Wave F: it adds no new mortality, capture or exact pika target, reproduction, audible Living Voice, tactical combat, or worldwide bestiary.",
      },
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: [
          "The seven Wave-B roles, Wave-C tidal roles, bounded Wave-D flock, herd, working-animal, and missing-livestock recovery slices, the five Alpha-30/31 additions, and the new Alpine triad now feed the same role, perception, movement, group, aggregate, ridge-activity, tide, physical-item, plural-custody, typed-home, working-assignment, recovery, mortality, body, and presentation contracts instead of hardcoded species or pair lists.",
          "The current twenty-seven-record catalog preserves the exact signed-region base and derives mountain-goat, American-pika, and golden-eagle populations through one separate sparse Alpine layer. Mountain goats form a HERD, pikas remain a non-addressable aggregate, and golden eagles remain solitary. Every base and Alpine owner shares one global group-atomic materialization cap. This does not create distant settlements, storage, livestock homes, recovery networks, polar breadth, or complete Wave F. Role-driven wolf or cougar pursuit may pressure eligible prey, while the only harmful live-animal contact in this build remains exact contact with a currently identified solitary addressable marsh rabbit; grouped elk, grouped deer, every social-group member, and all three Alpine species cannot be harmed. Brown bear and golden eagle have no live-prey pursuit or contact. Player, dog, human, and broader animal mortality remain absent. A boar, wolf, cougar, or brown bear may claim and consume finite resource from an existing body only after lawful sight and reach.",
          ...
          "Species-directed dog interaction with wild boar, elk, gray wolf, cougar, brown bear, mountain goat, pika, and golden eagle is an intentional no-response and remains unimplemented; ordinary lawful large-predator perception may still drive a non-harmful dog or porter reaction. Boar, elk, and wolf voice patterns are foundation-only and not audible; cougar, brown-bear, mountain-goat, pika, and golden-eagle voice behavior is not implemented. Tactical pack combat, new mortality, live-prey capture or exact pika targets, persistent tracks for the latest additions, reproduction, population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent and insects, complete sound, general scent and evidence tracking, foliage consumption, complete circadian behavior, ecological migration, polar breadth, complete Wave F, worldwide species breadth and storehouses, and the full bestiary are not live yet.",
    ...
    steps: [
      {
        ...
        body: [
          ...
          "Outer save version 26 adds regional ecology root version 2. Its base child is the exact version-1 Open Country Ledger ecology, preserving habitat version 11 as sealed compatibility authority, core-ecology patch version 3, aggregate ecology record version 5, settlement ecology version 4, working-animal state version 2, and every earlier population, actor, group, item, Promise, home, relationship, task, recovery case, store fact, world fact, mortality record, physical body, claim, and consumption record. One separate sparse Alpine child owns only the new ridge populations and true deviations.",
          "A normalized sealed version 25 Open Country Ledger save is authenticated and adopted exactly once into version 26. Its complete version-1 child and original outer integrity remain the adoption witness; mountain-goat, American-pika, and golden-eagle lineages are derived alongside it without rewriting, renumbering, redistributing, or retiring any base wildlife. Both children then enter one deterministic group-atomic materialization and conservation commit.",
          "Re-saving and reloading cannot reroll either regional baseline or Alpine lineage; duplicate or renumber an actor, aggregate, population, group, allocation, body, item, or claim; rewrite an existing injury or death; restore consumed resource; replay a meal; or turn an unseen incident into player knowledge. Pristine signed-region and Alpine baselines are rederived instead of saved, while only actual deviations, promoted or migrated identities, bodies, claims, and transaction receipts consume regional storage. The existing Open Country Ledger disposition, working-animal transition, and domestic recovery remain exact and cannot replay.",
        ].join(" "),
      },
      {
    ...
    steps: [
      {
        ...
        body: [
          ...
          "The twenty-seven-record species catalog preserves eligible existing wild populations through the exact Open Country Ledger signed-region ecology and adds one separate sparse Alpine layer. Lawful empty country remains empty. Where authoritative ridge habitat supports them, mountain goats form a persistent HERD, American pikas remain one conserved non-addressable talus aggregate, and a golden eagle remains solitary. The settlement home keeps bounded brown rats and anchored chicken and domestic-goat homes; its free-ranging domestic cat appears only when habitat supports it.",
          "Population lineage remains distinct from present residence. Every base and Alpine owner enters one global group-atomic stable-distance top-K plan capped at twenty-four actors, while authoritative density is measured before that cap. Shared grade-aware locomotion lets mountain goats favor ridges; the shared ridge activity owner gives a golden eagle authenticated soaring and perching lines. A currently visible eagle can nonlethally quiet or redistribute pika activity, while occlusion prevents that response. The existing mortality path remains limited to a marsh fox, gray wolf, or cougar exactly contacting a currently identified eligible solitary marsh rabbit; the Alpine species cannot enter it.",
          "Chart, Relief, quick inspection, ABOUT, and EVENTS expose only current lawful knowledge, never a hidden census, target, migration disposition, or retrospective offscreen story. Outer save version 26 adds regional ecology root version 2 around the exact version-1 base plus a sparse Alpine child, and authenticates one normalized sealed version-25 Open Country Ledger world for exact-once adoption. Pristine base and Alpine baselines are rederived and only real deviations persist. Habitat version 11 remains sealed compatibility authority, core ecology remains patch version 3, and aggregate ecology remains record version 5. Embedded simulation snapshots remain perception-aware format 4 and rules 6. Perpetual play remains active.",
        ].join(" "),
      },
      {
        ...
        body: "The seven named biomes and their weather, tide, habitat, and magical-water signals are visible now. Rain modifies current visibility, hearing, scent, dog exposure, rat pressure, and frog activity; tide changes conserved aquatic activity and lawful habitat without rerolling populations. The bounded twenty-seven-record catalog includes the first sparse Alpine triad, not polar ecology, complete Wave F, worldwide species breadth, or a complete bestiary. Physical loose provisions, store produce, and finite bodies can be perceived, claimed, and consumed only through current bounded owners. The only current harmful live-animal seam is exact contact by a marsh fox, gray wolf, or cougar against a currently identified eligible solitary marsh rabbit; Alpine species, brown bears, grouped animals, players, humans, dogs, and broader wildlife cannot enter this harmful ecology path. Golden-eagle pressure on the pika aggregate is nonlethal and cannot capture or select an exact pika. Tactical pack combat, ecological migration behavior, wider aquatic and scavenger relationships, broader mortality, reproduction, recruitment, population recovery, live-time decomposition, body drift, dragging, harvesting, carcass scent, insects, broad attack and health systems, complete audible Living Voice, complete scent and evidence tracking, broad schedules, autonomous home life, rumors, foliage consumption, polar breadth, and the full bestiary remain planned. Shared invariants, deterministic properties, conservation, bounded fuzzing and performance, and representative emergent scenarios validate the reusable scaffold rather than species-by-species or N² pair tests; absent systems do not alter a delivery behind the HUD's back.",
      },
      {
...
export const TUTORIAL_CONTENT_VERSION = 43 as const;
