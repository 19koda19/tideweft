  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Alpha 53 · The Turning Day is the current gameplay entry. One deterministic civil clock now carries day, dusk, night, and dawn through weather, tides, outdoor light, WAIT, REST, SLEEP, all forty-two current residents, the settlement working dog, and the seventeen existing wildlife activity profiles. Routine preference never teleports a body or overrules work, route travel, danger, storms, urgent needs, current watch or search, or lawful strong disturbance. Physical arrival remains required before rest or sleep. WAIT stops at the committed boundary of a lawfully heard strong alarm. Mid-recovery reload resumes the same saved interval, and hidden or closed time does not advance the world. Production-backed closure evidence spans exact frame-cadence authority, a three-day resident and wildlife soak with daily persistence, actor dematerialization and rematerialization, and packaged desktop plus mobile recovery controls. This evidence is representative and distributed across shared owners, not a scripted all-species journey. Packaged mobile exercises Relief while packaged desktop exercises Chart and Relief; shared authority covers both views. Packaged timing is a regression and liveness floor, not a promise of comfortable speed on every low-end device. The existing settlement working dog remains the honest relationship-bearing continuity witness; no bonded, named player companion exists yet. Outer save version 32 and simulation format 4 remain unchanged. Breathing Room is next, followed by Living Voice. This gameplay entry does not itself prove deployment: LIVE_VERIFIED status requires the separate push, remote CI, GitHub Pages, and exact deployed-build verification gate.",
      },
    ],
    callouts: [
      {
...
export const TUTORIAL_CONTENT_VERSION = 63 as const;
