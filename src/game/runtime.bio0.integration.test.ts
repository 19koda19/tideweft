...
describe("runtime BIO0 ecology persistence", () => {
  ...
  it("rejects a resealed current v32 home ecology whose rat identity is self-consistent but belongs to another seed", async () => {
    ...
    resealCurrent(repository, (decoded) => {
      ...
      if (regionalV6 === null) throw new Error("seed-auth fixture omitted its v30 authority");
      ...
      const substitutedV2 = createRegionalEcologyStateV2({
      ...
      const substitutedV4 = createRegionalEcologyStateV4({
        base: substitutedV3,
      ...
      const substitutedV5 = createRegionalEcologyStateV5({
        base: substitutedV4,
      ...
      decoded.regionalEcology = serializeRegionalEcologyStateV6(createRegionalEcologyStateV6({
        base: substitutedV5,
...
function legacyRecord(
  ...
  const envelope = {
    ...
    player: legacyPlayerWithoutTimeAction(player),
    session,
  };
  return {
    slotId: "autosave",
...
function legacyPlayerWithoutTimeAction(
