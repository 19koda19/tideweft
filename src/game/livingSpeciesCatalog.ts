...
/** Sorted catalog view after the second Wave-G marsh-channel cohort append. */
export const LIVING_SPECIES_WAVE_G_MARSH_CHANNEL_SPECIES_IDS = Object.freeze([
  "american-black-duck",
  "american-pika",
  "arctic-fox",
  "atlantic-capelin",
...
export const LIVING_SPECIES_WAVE_G_MARSH_CHANNEL_CATALOG_COUNT = 43 as const;
...
> = Object.freeze({
  deer: {
    ...
    activityOwnerId: "game:core-ecology:v2",
  ...
  "brown-rat": {
    ...
    activityOwnerId: "game:core-ecology:v3",
    ...
    aboutObservableFields: ["evidence-kind", "evidence-scale", "species"],
  },
  "domestic-cat": {
    implementation: "active",
    habitatOwnerId: "game:core-ecology-habitat:v2",
    ...
    aboutObservableFields: ["appearance", "behavior", "condition", "life-stage", "species"],
  },
  "marsh-rabbit": {
    implementation: "active",
  ...
  "fish-crow": {
    implementation: "active",
    habitatOwnerId: "game:core-ecology-habitat:v4",
    ecologyOwnerId: "game:core-ecology:v4",
    spatialOwnerId: "game:living-actor-address:v1",
    behaviorOwnerId: "game:core-wildlife-actor:v1",
    locomotionOwnerId: "game:core-wildlife-locomotion-profile:v1",
    socialOwnerId: "game:core-ecology-groups:v1",
    ...
    morphologyDimensions: ["life-stage-size"],
    appearanceTraits: ["life-stage", "morph", "sex", "temperament"],
    habitatClasses: ["marsh", "meadow", "settlement-edge", "tidal-flat"],
    movementMedia: [
      { medium: "air", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
    ],
    movementVerbs: ["fly", "glide", "perch"],
    terrainAffordances: ["open-air", "perch"],
    consumedBy: [],
    competesWith: ["gull"],
    ecologicalEffects: ["aerial-mobbing", "alarm-information", "bounded-food-pressure"],
    includeDogInteraction: true,
    groupModel: "group",
    crossRegion: true,
    sound: {
  ...
  "northern-harrier": {
    ...
    terrainAffordances: ["low-open-air", "open-air"],
    consumedBy: [],
    competesWith: [],
    ecologicalEffects: ["small-prey-pressure"],
    includeDogInteraction: true,
    groupModel: "solitary",
    crossRegion: true,
    sound: noSound(),
  ...
  "southern-leopard-frog": {
    ...
    habitatOwnerId: "game:core-ecology-habitat:v4",
    ecologyOwnerId: "game:core-ecology:v4",
    spatialOwnerId: "game:core-ecology:v4",
    behaviorOwnerId: "game:core-ecology-small-world:v3",
    locomotionOwnerId: "game:core-ecology-small-world:v3",
    socialOwnerId: "game:core-ecology-small-world:v3",
    activityOwnerId: "game:core-ecology-small-world:v3",
    dynamicOverlays: ["visible-activity"],
    morphologyDimensions: ["activity-area", "population-density"],
    appearanceTraits: ["activity-signs", "population-pressure"],
    habitatClasses: ["marsh", "retained-wet", "tidal-flat"],
    movementMedia: [
      { medium: "land", relativeCapability: 400_000 },
      { medium: "shallow-water", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
    ],
    movementVerbs: ["hop", "redistribute", "swim"],
    terrainAffordances: ["retained-wetland", "standable-shallow-water"],
    consumedBy: ["aerial-predator", "small-predator"],
    competesWith: [],
    ecologicalEffects: ["rain-chorus", "small-prey-support"],
    includeDogInteraction: true,
    groupModel: "variable",
    crossRegion: false,
    sound: {
    ...
    evidence: {
      ...
      decayOwnerId: "game:core-ecology:v4",
      interprets: [],
    },
    weather: {
      status: "active",
      ownerId: "game:core-ecology-small-world:v3",
  ...
  "american-black-duck": {
    ...
    habitatOwnerId: "game:core-ecology-habitat:v6",
    ...
    appearanceTraits: ["dark-brown-plumage", "pale-head", "violet-speculum"],
    habitatClasses: ["flooded-marsh-edge", "marsh", "shallow-water", "tidal-creek"],
    movementMedia: [
      { medium: "air", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
      { medium: "deep-water", relativeCapability: 950_000 },
      { medium: "shallow-water", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
    ],
    movementVerbs: ["dabble", "fly", "relocate", "swim"],
    terrainAffordances: [
      "open-air",
      "shore-rest",
      "swimmable-deep-water",
  ...
  "domestic-chicken": {
    ...
    dynamicOverlays: ["visible-condition", "visible-flock-summary"],
    morphologyDimensions: ["body-size", "plumage-state"],
    appearanceTraits: ["comb", "plumage", "sex", "temperament"],
    habitatClasses: ["settlement-edge", "storehouse-yard"],
    movementMedia: [
      { medium: "land", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
      { medium: "shallow-water", relativeCapability: 220_000 },
    ],
    movementVerbs: ["forage", "walk"],
    terrainAffordances: ["land", "standable-shallow-water"],
    consumedBy: ["large-predator", "small-predator"],
    competesWith: ["brown-rat"],
    ecologicalEffects: ["alarm-information", "bounded-food-pressure", "small-prey-support"],
    includeDogInteraction: true,
    groupModel: "group",
    crossRegion: false,
  ...
  "wild-boar": {
    ...
    habitatOwnerId: "game:core-ecology-habitat:v10",
    ecologyOwnerId: "game:core-wildlife-actor:v1",
    spatialOwnerId: "game:living-actor-address:v1",
    behaviorOwnerId: "game:core-wildlife-actor:v1",
    locomotionOwnerId: "game:core-wildlife-locomotion-profile:v1",
    ...
    dynamicOverlays: ["visible-condition"],
    morphologyDimensions: ["body-size", "coat-state"],
    appearanceTraits: ["bristled-coat", "long-snout", "sex", "temperament"],
    // Forest-edge is an ecological class. Runtime placement remains signed
    // meadow/ridge terrain selected by the shared habitat-v10 owner.
    habitatClasses: ["forest-edge", "temperate-upland", "wooded-ridge"],
    movementMedia: [
      { medium: "land", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
      { medium: "shallow-water", relativeCapability: 420_000 },
    ],
    ...
    terrainAffordances: ["land", "standable-shallow-water"],
    consumedBy: ["large-predator"],
    competesWith: ["deer", "elk"],
    ecologicalEffects: ["alarm-information", "bounded-food-pressure", "scavenger-opportunity"],
    includeDogInteraction: false,
    groupModel: "group",
    crossRegion: false,
    sound: {
  ...
  elk: {
    ...
    dynamicOverlays: ["visible-condition"],
    morphologyDimensions: ["body-size", "coat-state"],
    appearanceTraits: ["dark-neck", "pale-rump", "sex", "temperament"],
    habitatClasses: ["forest-edge", "temperate-upland", "upland-meadow"],
    movementMedia: [
      { medium: "land", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
      { medium: "shallow-water", relativeCapability: 360_000 },
    ],
    movementVerbs: ["bound", "graze", "walk"],
    terrainAffordances: ["land", "standable-shallow-water"],
    consumedBy: ["large-predator"],
    competesWith: ["deer", "wild-boar"],
    ecologicalEffects: ["alarm-information", "bounded-food-pressure"],
    includeDogInteraction: false,
    groupModel: "group",
    crossRegion: false,
  ...
  "gray-wolf": {
    ...
    dynamicOverlays: ["visible-condition"],
    morphologyDimensions: ["body-size", "coat-state"],
    appearanceTraits: ["deep-chest", "gray-coat", "sex", "temperament"],
    habitatClasses: ["forest-edge", "ridge", "temperate-upland"],
    movementMedia: [
      { medium: "land", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
      { medium: "shallow-water", relativeCapability: 460_000 },
    ],
    movementVerbs: ["pursue", "trot", "walk"],
    terrainAffordances: ["land", "standable-shallow-water"],
    consumedBy: [],
    competesWith: ["marsh-fox"],
    ecologicalEffects: ["live-prey-pressure", "scavenger-opportunity"],
    includeDogInteraction: false,
    groupModel: "group",
    crossRegion: false,
    sound: {
      implementation: "foundation",
      ownerId: "audio:soundscape:v1",
      repertoire: ["wolf-growl", "wolf-howl"],
      communicationSignals: ["wolf-growl", "wolf-howl"],
      accessibilityCues: ["direct-observation-caption"],
    },
    evidence: {
      status: "foundation",
  ...
  cougar: {
    ...
    habitatOwnerId: "game:core-ecology-habitat:v11",
    ecologyOwnerId: "game:core-wildlife-actor:v1",
    spatialOwnerId: "game:living-actor-address:v1",
    behaviorOwnerId: "game:core-wildlife-actor:v1",
    locomotionOwnerId: "game:core-wildlife-locomotion-profile:v1",
    ...
    dynamicOverlays: ["visible-condition"],
    morphologyDimensions: ["body-size", "coat-state"],
    appearanceTraits: ["long-tail", "sex", "tawny-coat", "temperament"],
    habitatClasses: ["forest-edge", "rocky-cover", "temperate-upland", "wooded-ridge"],
    movementMedia: [
      { medium: "land", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
      { medium: "shallow-water", relativeCapability: 380_000 },
    ],
    movementVerbs: ["bound", "pursue", "walk"],
    terrainAffordances: ["land", "standable-shallow-water"],
    consumedBy: [],
    competesWith: ["gray-wolf", "marsh-fox"],
    ecologicalEffects: ["live-prey-pressure", "scavenger-opportunity"],
    includeDogInteraction: false,
    groupModel: "solitary",
    crossRegion: false,
  ...
  "brown-bear": {
    ...
    dynamicOverlays: ["visible-condition"],
    morphologyDimensions: ["body-size", "coat-state"],
    appearanceTraits: ["sex", "shaggy-coat", "shoulder-hump", "temperament"],
    habitatClasses: ["forest-edge", "temperate-upland", "wooded-ridge"],
    movementMedia: [
      { medium: "land", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
      { medium: "shallow-water", relativeCapability: 520_000 },
    ],
    movementVerbs: ["forage", "wade", "walk"],
    terrainAffordances: ["land", "standable-shallow-water"],
    consumedBy: [],
    competesWith: ["black-bear", "wild-boar"],
    ecologicalEffects: ["bounded-food-pressure", "scavenger-opportunity"],
    includeDogInteraction: false,
    groupModel: "solitary",
    crossRegion: false,
    sound: noSound(),
  ...
  "atlantic-menhaden": {
    ...
    movementMedia: [
      { medium: "deep-water", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
      { medium: "shallow-water", relativeCapability: 850_000 },
    ],
    movementVerbs: ["school", "swim"],
    terrainAffordances: [
      "connected-water",
  ...
  mummichog: {
    implementation: "foundation",
    ecologicalClasses: ["forage-fish", "forager", "omnivore", "prey", "small-prey"],
    habitatOwnerId: "game:core-ecology-breadth-habitat:v1",
    ecologyOwnerId: "game:regional-breadth-ecology:v1",
    populationOwnerId: "game:regional-breadth-cohort:v1",
    spatialOwnerId: "game:regional-breadth-ecology:v1",
    ...
    morphologyDimensions: ["activity-area", "school-density"],
    appearanceTraits: ["school-flash", "school-shape", "surface-density"],
    habitatClasses: ["brackish-marsh", "shallow-water", "tidal-creek", "tidal-refuge"],
    movementMedia: [
    ...
    consumedBy: ["aerial-predator", "wading-predator"],
    competesWith: [],
    ecologicalEffects: ["estuary-food-web-support", "shallow-forage-fish-support"],
    includeDogInteraction: false,
    groupModel: "group",
    crossRegion: false,
    sound: noSound(),
  ...
  "grass-shrimp": {
    implementation: "foundation",
    ecologicalClasses: ["aquatic-detritivore", "forager", "prey", "small-prey"],
    habitatOwnerId: "game:core-ecology-breadth-habitat:v1",
    ecologyOwnerId: "game:regional-breadth-ecology:v1",
    populationOwnerId: "game:regional-breadth-cohort:v1",
    spatialOwnerId: "game:regional-breadth-ecology:v1",
    ...
    dynamicOverlays: ["tide-availability", "visible-activity"],
    morphologyDimensions: ["activity-area", "population-density"],
    appearanceTraits: ["activity-signs", "shoal-density", "surface-flicker"],
    habitatClasses: ["brackish-marsh", "reed-edge", "shallow-water", "tidal-creek"],
    movementMedia: [
      { medium: "deep-water", relativeCapability: 450_000 },
      { medium: "shallow-water", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
    ],
    movementVerbs: ["drift", "redistribute", "swim"],
    terrainAffordances: [
      "connected-water",
      "swimmable-deep-water",
      "swimmable-shallow-water",
    ],
    consumedBy: ["forage-fish", "wading-predator"],
    competesWith: [],
    ecologicalEffects: ["detrital-transfer", "small-prey-support"],
    includeDogInteraction: false,
    groupModel: "variable",
    crossRegion: false,
    sound: noSound(),
  ...
  "blue-crab": {
    implementation: "foundation",
    ecologicalClasses: ["benthic-omnivore", "forager", "prey", "scavenger"],
    habitatOwnerId: "game:core-ecology-breadth-habitat:v1",
    ecologyOwnerId: "game:regional-breadth-ecology:v1",
    populationOwnerId: "game:regional-breadth-cohort:v1",
    spatialOwnerId: "game:regional-breadth-ecology:v1",
    ...
    morphologyDimensions: ["activity-area", "population-density"],
    appearanceTraits: ["activity-signs", "burrow-density", "surface-density"],
    habitatClasses: ["brackish-channel", "mud-bottom", "shallow-water", "tidal-flat"],
    movementMedia: [
      { medium: "deep-water", relativeCapability: 650_000 },
      { medium: "shallow-water", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
    ],
    movementVerbs: ["crawl", "redistribute", "swim"],
    terrainAffordances: [
      "connected-water",
      "swimmable-deep-water",
      "swimmable-shallow-water",
    ...
    consumedBy: ["aerial-predator", "wading-predator"],
    competesWith: [],
    ecologicalEffects: ["benthic-forage-pressure", "small-prey-support"],
    includeDogInteraction: false,
    groupModel: "variable",
    crossRegion: false,
    sound: noSound(),
  ...
  "greater-yellowlegs": {
    implementation: "foundation",
    ecologicalClasses: ["aquatic-forager", "forager", "small-predator", "wader"],
    habitatOwnerId: "game:core-ecology-breadth-habitat:v1",
    ecologyOwnerId: "game:regional-breadth-ecology:v1",
    populationOwnerId: "game:regional-breadth-cohort:v1",
    spatialOwnerId: "game:regional-breadth-ecology:v1",
    ...
    socialOwnerId: "game:core-ecology-groups:v1",
    activityOwnerId: "game:core-ecology-activity:v1",
    dynamicOverlays: ["visible-condition", "visible-flock-summary", "wading-depth"],
    morphologyDimensions: ["body-size", "plumage-state"],
    appearanceTraits: ["long-yellow-legs", "plumage", "temperament", "upturned-bill"],
    habitatClasses: ["brackish-marsh", "shallow-water", "tidal-edge", "tidal-flat"],
    movementMedia: [
      { medium: "air", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
      { medium: "land", relativeCapability: 720_000 },
      { medium: "shallow-water", relativeCapability: 900_000 },
  ...
  "belted-kingfisher": {
    implementation: "foundation",
    ecologicalClasses: ["aerial-forager", "aquatic-forager", "forager", "small-predator"],
    habitatOwnerId: "game:core-ecology-breadth-habitat:v1",
    ecologyOwnerId: "game:regional-breadth-ecology:v1",
    populationOwnerId: "game:regional-breadth-cohort:v1",
    spatialOwnerId: "game:regional-breadth-ecology:v1",
    ...
    dynamicOverlays: ["visible-condition"],
    morphologyDimensions: ["body-size", "plumage-state"],
    appearanceTraits: ["belt-marking", "heavy-bill", "shaggy-crest", "temperament"],
    habitatClasses: ["brackish-channel", "tidal-creek", "waterside-perch"],
    movementMedia: [
      { medium: "air", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
    ],
    movementVerbs: ["fly", "perch", "plunge-dive", "relocate"],
  ...
  "double-crested-cormorant": {
    implementation: "foundation",
    ecologicalClasses: ["aquatic-forager", "diving-waterbird", "forager", "predator"],
    habitatOwnerId: "game:core-ecology-breadth-habitat:v1",
    ecologyOwnerId: "game:regional-breadth-ecology:v1",
    populationOwnerId: "game:regional-breadth-cohort:v1",
    spatialOwnerId: "game:regional-breadth-ecology:v1",
    ...
    dynamicOverlays: ["visible-condition", "visible-flock-summary"],
    morphologyDimensions: ["body-size", "plumage-state"],
    appearanceTraits: ["dark-plumage", "hooked-bill", "orange-throat", "temperament"],
    habitatClasses: ["brackish-channel", "nearshore-saline-water", "tidal-creek", "waterside-perch"],
    movementMedia: [
      { medium: "air", relativeCapability: 900_000 },
      { medium: "deep-water", relativeCapability: 850_000 },
      { medium: "shallow-water", relativeCapability: LIVING_SPECIES_CAPABILITY_SCALE },
    ],
    movementVerbs: ["dive", "fly", "perch", "relocate", "swim"],
    terrainAffordances: [
      "open-air",
      "perch",
      "surface-foraging-opportunity",
      "swimmable-deep-water",
      "swimmable-shallow-water",
    ],
    consumedBy: [],
...
function coreWildlifeInteractionTargets(
  ...
  const alpha37CompatibilitySpecies = (
    LIVING_SPECIES_WAVE_G_ESTUARY_SPECIES_IDS as readonly string[]
  ).includes(species);
  const runtimePolicy = coreEcologySpeciesRuntimePolicy(species);
  ...
  const pressureVerbs = appendedSchoolResponse
    ...
    : appendedAggregateResponse && !alpha37CompatibilitySpecies
      ? [...(runtimePolicy?.aggregate?.responseVerbs ?? [])]
  ...
  if (coreEcologySpeciesHasRuntimeCapability(species, "aquatic-foraging")) {
    ...
    targets.push({
      ...
      verbs: isSchool
        ? ["redistribute", "tighten"]
        : !alpha37CompatibilitySpecies
          ? [...(runtimePolicy?.aggregate?.responseVerbs ?? [])]
          : ["quiet", "retreat-to-burrow"],
      escalationConstraints: [
        "aggregate-unit-conservation",
        "bounded-response",
        "direct-perception-required",
  ...
  if (coreEcologySpeciesHasRuntimeCapability(species, "live-prey-pursuit")) {
  ...
  if (coreEcologySpeciesHasRuntimeCapability(species, "same-species-food-guard")) {
    targets.push({
...
function coreWildlifeModule(species: CoreWildlifeSpecies): LivingSpeciesModule {
  ...
  if (runtimePolicy === null) {
    throw new Error(`Missing core ecology species runtime policy for ${species}`);
  }
  ...
  return {
    ...
    cognition: {
      ...
      memoryKinds: aggregate
        ...
        : [
            ...
            "food",
            "guard",
            ...(coreEcologySpeciesHasRuntimeCapability(species, "movement-memory")
              ? ["movement"]
              : []),
            "pursuit",
            "threat",
            ...(values.weather.status === "active" ? ["weather"] : []),
          ],
    ...
    about: {
      ...
      observableFields: values.aboutObservableFields,
      learnedFields: [],
    },
    persistence: {
      implementation,
...
const waveGMarshChannelModules = LIVING_SPECIES_WAVE_G_MARSH_CHANNEL_SPECIES_IDS.map(
  (speciesId) => {
    const module = currentCatalog.modules.find((candidate) => candidate.speciesId === speciesId);
    if (module === undefined) {
...
const waveGMarshChannelCatalog = deepFreeze({
  version: LIVING_SPECIES_CATALOG_VERSION,
  modules: waveGMarshChannelModules,
});
const waveGMarshChannelBytes = stableStringify(waveGMarshChannelCatalog);
if (
  LIVING_SPECIES_WAVE_G_MARSH_CHANNEL_SPECIES_IDS.length
    !== LIVING_SPECIES_WAVE_G_MARSH_CHANNEL_CATALOG_COUNT
  || hashCanonical(LIVING_SPECIES_WAVE_G_MARSH_CHANNEL_SPECIES_IDS)
    !== LIVING_SPECIES_WAVE_G_MARSH_CHANNEL_SPECIES_IDS_HASH
  || new TextEncoder().encode(waveGMarshChannelBytes).byteLength
    !== LIVING_SPECIES_WAVE_G_MARSH_CHANNEL_CATALOG_BYTE_LENGTH
  || hashCanonical(waveGMarshChannelCatalog)
    !== LIVING_SPECIES_WAVE_G_MARSH_CHANNEL_CATALOG_HASH
) {
  throw new Error("Living Weft Wave-G marsh-channel catalog lineage was rewritten");
}
...
// The catalog and runtime policy are one fail-closed contract. A species may
// not silently acquire actor addressing, flight, grouping, or aggregate
// presentation merely because a caller recognizes its name.
assertCoreEcologySpeciesRuntimePolicies(LIVING_SPECIES_CATALOG);
