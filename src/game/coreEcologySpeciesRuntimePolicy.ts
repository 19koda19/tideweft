...
>> = deepFreeze({
  ...
  "eastern-saltmarsh-mosquito": NO_MORTALITY_RUNTIME,
  "marsh-periwinkle": NO_MORTALITY_RUNTIME,
  "seaside-sparrow": NO_MORTALITY_RUNTIME,
  "diamondback-terrapin": NO_MORTALITY_RUNTIME,
});
...
const RUNTIME_VALUES: Readonly<Record<CoreWildlifeSpecies, AuthoredRuntimePolicyValues>> =
  deepFreeze({
    ...
    "eastern-saltmarsh-mosquito": {
      ...
      activitySignals: ["swarming", "swarm-quieting"],
    ...
    "marsh-periwinkle": {
      ...
      activitySignals: ["surface-crawling", "surface-quieting"],
    ...
    "seaside-sparrow": {
      ...
      activitySignals: ["low-foraging-flight", "marsh-perching"],
      evidenceKinds: [],
      presentationModel: "visible-flock",
    },
