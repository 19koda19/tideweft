...
> = deepFreeze({
  ...
  mummichog: {
    ...
    representation: "population-area",
    identificationClarity: 520_000,
    unidentifiedQuickLabel: "Shallow-water activity",
    unidentifiedIdentityLabel: "Unidentified shallow-water activity",
    identifiedNounNumber: "singular",
    groupNoun: null,
    appearanceStyle: "individual",
    conditionStyle: "none",
  ...
  "grass-shrimp": {
    ...
    representation: "population-area",
    identificationClarity: 520_000,
    unidentifiedQuickLabel: "Fine water activity",
    unidentifiedIdentityLabel: "Unidentified fine water activity",
    identifiedNounNumber: "singular",
    groupNoun: null,
    appearanceStyle: "individual",
    conditionStyle: "none",
  ...
  "blue-crab": {
    ...
    representation: "population-area",
    identificationClarity: 520_000,
    unidentifiedQuickLabel: "Shallow-water signs",
    unidentifiedIdentityLabel: "Unidentified shallow-water activity",
    identifiedNounNumber: "singular",
    groupNoun: null,
    appearanceStyle: "individual",
  ...
  "greater-yellowlegs": {
    ...
    representation: "actor",
    identificationClarity: 350_000,
    unidentifiedQuickLabel: "Unknown waders",
    unidentifiedIdentityLabel: "Unidentified wading birds",
    // Yellowlegs is already both the singular and plural common name.
    identifiedNounNumber: "singular",
    groupNoun: "flock",
    appearanceStyle: "plumage",
    conditionStyle: "flock",
    exposesLifeStage: false,
    baseSizeScale: 0.72,
    observableForm: "Slender waders with long bright legs and slightly upturned bills",
  },
  "belted-kingfisher": {
    form: "shorebird-flock",
    representation: "actor",
    identificationClarity: 380_000,
    unidentifiedQuickLabel: "Unknown waterside bird",
    unidentifiedIdentityLabel: "Unidentified waterside bird",
    identifiedNounNumber: "singular",
    groupNoun: null,
    appearanceStyle: "plumage",
    conditionStyle: "individual",
    exposesLifeStage: true,
    baseSizeScale: 0.64,
    observableForm: "Stocky, crested waterside bird with a heavy pointed bill",
  },
  "double-crested-cormorant": {
    form: "american-black-duck",
    representation: "actor",
    identificationClarity: 350_000,
    unidentifiedQuickLabel: "Unknown dark waterbirds",
    unidentifiedIdentityLabel: "Unidentified dark waterbirds",
    identifiedNounNumber: "plural",
    groupNoun: "flock",
    appearanceStyle: "plumage",
    conditionStyle: "flock",
...
> = deepFreeze({
  ...
  "atlantic-menhaden": {
    identification: "learned-identity",
    identifiedQuickLabel: "Atlantic menhaden school signs",
    unidentifiedQuickLabel: "Aquatic activity",
    identifiedIdentityLabel: "Atlantic menhaden school signs",
    unidentifiedIdentityLabel: "Unidentified aquatic activity",
    byKind: {
      "surface-dimple": {
        form: "surface-dimples",
        minimumClarity: 280_000,
        identifiedLabel: "Atlantic menhaden surface dimples and school glints",
        unidentifiedLabel: "Aquatic surface dimples and brief glints",
        sizeScale: 1.08,
      },
    },
  ...
  mummichog: {
    identification: "learned-identity",
    identifiedQuickLabel: "Mummichog school signs",
    unidentifiedQuickLabel: "Shallow-water activity",
    identifiedIdentityLabel: "Mummichog school signs",
    unidentifiedIdentityLabel: "Unidentified shallow-water activity",
    byKind: {
      "surface-dimple": {
        form: "surface-dimples",
        minimumClarity: 280_000,
        identifiedLabel: "Mummichog surface dimples and school glints",
        unidentifiedLabel: "Shallow-water dimples and brief glints",
        sizeScale: 0.94,
      },
    },
  },
  "grass-shrimp": {
    identification: "learned-identity",
    identifiedQuickLabel: "Grass shrimp activity",
    unidentifiedQuickLabel: "Fine water activity",
    identifiedIdentityLabel: "Grass shrimp population signs",
    unidentifiedIdentityLabel: "Unidentified fine water activity",
    byKind: {
      "surface-dimple": {
        form: "surface-dimples",
        minimumClarity: 320_000,
        identifiedLabel: "Grass shrimp surface flickers",
        unidentifiedLabel: "Fine shallow-water flickers and tiny dimples",
        sizeScale: 0.72,
      },
    },
  },
  "blue-crab": {
    identification: "learned-identity",
    identifiedQuickLabel: "Blue crab signs",
    unidentifiedQuickLabel: "Shallow-water signs",
    identifiedIdentityLabel: "Blue crab population signs",
    unidentifiedIdentityLabel: "Unidentified shallow-water activity",
    byKind: {
      "burrow-opening": {
        form: "burrow-openings",
        minimumClarity: 300_000,
        identifiedLabel: "Blue crab burrow openings",
        unidentifiedLabel: "Submerged burrow openings",
        sizeScale: 0.98,
      },
      "feeding-scrape": {
        form: "feeding-scrapes",
