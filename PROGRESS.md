...
Phase 10: Tide Harps, the mobile/current hotfix, and the perpetual/mobile/biome checkpoint are verified and published as untagged post-alpha previews. The field ecology / KIT checkpoint is implemented and test-verified in the working source but is not published yet.
...
- The current source candidate turns those biomes into nine visible renewable material families, makes desktop E and exact touch-route gathering authoritative, shares one 16,000-milli-load pack across transport/finds/gear, and opens anywhere PACK / MAKE / MEND through I, C, or mobile KIT. Six component and eleven gear recipes, condition-aware repair/dismantling, inherited-Wayknot placement/reclaim wear, and four truthful wearable effects are covered by 49 files / 386 green tests; release and Pages evidence are still pending.
...
- Removed the redundant mobile Title action to reserve its slot for KIT; the later field ecology / KIT source candidate now uses that slot. A compact 44-pixel ☾ Quiet Hour control remains the truthful saved recap/return-to-title path, and Promise/report actions also meet the 44-pixel compact target.
...
## 2026-09-01 — Field ecology / KIT source candidate
