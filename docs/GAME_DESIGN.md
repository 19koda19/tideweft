...
- One bounded local core-wildlife assemblage attached to that first living web. Deer, gull, black-bear, brown-rat, domestic-cat, marsh-rabbit, marsh-fox, fish-crow, northern-harrier, southern-leopard-frog, Atlantic-silverside, Atlantic-marsh-fiddler-crab, snowy-egret, and American-black-duck presence derives from the stable seed, terrain, biome/climate signals, and a settlement-adjacent focus, so unsuitable local ecology can contain no member of a species. Deer, gulls, bears, free-ranging cats, rabbits, foxes, fish crows, northern harriers, snowy egrets, and American black ducks use bounded persistent individual representatives. A viable fish-crow population exposes at most three representatives and, when at least two are present, one persistent flock; the northern harrier, snowy egret, and American black duck each expose at most one representative, and the duck has no flock model. Brown rats, southern leopard frogs, Atlantic silversides, and Atlantic marsh fiddler crabs instead use stable aggregates disclosed only through directly visible signs. Fish and crabs never become manufactured individual actors. This is not worldwide habitat generation or a complete bestiary.
...
The bounded core-wildlife assemblage extends the same observation boundary to its present deer, gulls, black bears, free-ranging domestic cats, marsh rabbits, marsh foxes, fish crows, northern harrier, snowy egret, and American black duck. Terrain and structures can block sight; sufficiently clear contact can identify an ecologically plausible relationship; and an explicit alarm can propagate through bounded hearing without revealing the caller's stable identity, species, hidden target, or exact motive. Cats, rabbits, foxes, crows, the harrier, the egret, the duck, the current dog, the porter, gulls, and the player receive only the visual observations that lawfully reach them. The egret or duck receives a current anonymous **AQUATIC ACTIVITY** area only when an occupied, active, depth-usable fish or crab anchor passes shared direct sight; neither receives an aggregate ID, species, exact count, or hidden target. A directly seen second cat can become food competition for a hungry cat; strong local rain can make a materialized cat retreat and leave bounded wet pawprints. Rabbit and fox movement can leave paired tracks or canid pawprints at the saved movement site. Crows, the harrier, the egret, and the duck do not manufacture ground tracks. Directly visible individual wildlife has distinct Chart and Relief silhouettes and a non-pausing ABOUT surface; each visible crow representative renders and hit-tests once even when its flock context reports a larger group, while the duck always remains one addressable individual. Loss of direct-detail sight removes rendering, selection, labels, actions, and inspection rather than leaving a remote tracker. Individual movement signs require current direct-detail sight, fade from identified to ambiguous as their clarity ages, expire after 180 ticks, remain non-targetable, and cannot reveal an unseen animal's thoughts or current location. Rat/frog-area evidence, silverside surface activity, and fiddler-crab burrows or feeding scrapes follow the same knowledge boundary and never pretend to be individual aggregate animals.

When a bear is present, it may choose an easier exposed provision instead of pursuing visible live prey. A gull or fish crow may also opportunistically inspect and claim exposed food. Each animal must physically reach the same exact whole dried-fish parcel before consumption can commit; the entity is then removed and its animal-consumption history persists. A marsh rabbit can alarm and then flee from a directly perceived fox or northern harrier. A hungry marsh fox or harrier can begin a finite pursuit of directly perceived small prey, but lawful pressure can replace that prey as its urgent attention. A fish crow can alarm only after directly identifying the harrier; only that causally retained alarm can become mobbing pressure and interrupt the harrier. Mere proximity cannot manufacture the relationship. Rabbit flight and fox/harrier pursuit use shared locomotion boundaries with distinct bounded gaits, and pursuit ends through finite disengagement rather than attack. No live prey is injured, killed, consumed, or converted into a carcass. Deer, gulls, and fish crows can likewise alarm, flee, retreat, observe, or disengage through their role and current observations, and terrestrial wildlife can traverse standable shallow water while rejecting deeper water. Deer and rabbit browsing are not live. The player can **WAIT AND WATCH**, **ROUTE AROUND THIS SPOT**, or **LEAVE**, but cannot command, feed, tame, name, own, recruit, attack, or otherwise directly manipulate these animals in this release.

Habitat analysis stores carrying capacity inputs, aggregate population units, pressure, trend, and deterministic placement anchors even though only a bounded set of individual representatives materializes. Habitat version 5 preserves the exact version-4 population prefix and appends only the Atlantic-silverside, Atlantic-marsh-fiddler-crab, and snowy-egret analyses. Habitat version 6 in the complete unpublished Alpha 20 candidate preserves that entire version-5 population and tidal-anchor record as its exact prefix, then appends only the American-black-duck analysis. Empty population is a valid ecological result, not a failed spawn. Group-sized deer, gull, and fish-crow populations receive stable herd/flock membership, cohesion, group components, anonymous alarm-signal state, and split/rejoin lineage; crows use their own `CROW-FLOCK` namespace. Black bears, northern harriers, and snowy egrets remain solitary, while the black duck is represented by at most one individual with no flock state; domestic cats, marsh rabbits, and marsh foxes remain individual. Brown-rat, southern-leopard-frog, Atlantic-silverside, and Atlantic-marsh-fiddler-crab population units are conserved across saved aggregate anchors without ever materializing any aggregate as actors. Tidal anchors persist baseline elevation; current water depth and usability are derived later from the authoritative tide rather than participating in generation. The duck adds exactly two saved dabbling-water destinations and one dry refuge when supported.
...
Player-facing rat rustles, domestic-cat calls, rabbit thumps, fox yips, and fish-crow double calls occur only for activity visible at event time. The frog chorus instead passes through shared directional hearing from its actual aggregate anchor. Its anonymous bottom-right caption and attenuated stereo pan derive from the same heard-bearing uncertainty; it names a cardinal direction only when that contact supports one. The northern harrier, snowy egret, and American black duck have no fabricated calls. These are redundant cues, not long-range simulation knowledge. Cats, rabbits, foxes, fish crows, the harrier, the egret, and the duck preserve individual identity, bounded state, and already-authoritative intent through full/coarse/full transitions and accept the same **WAIT AND WATCH**, **ROUTE AROUND THIS SPOT**, and **LEAVE** choices as other visible wildlife, but cannot be owned, bonded, named, tamed, or recruited. A selected gull or fish-crow representative's ABOUT view uses the same visible flock estimate already present in projection; it does not recount hidden members. The duck never displays a group suffix or hidden flock estimate. Rat, frog, silverside, and fiddler-crab signs are close-only observations because none represents an addressable actor; cat, rabbit, and fox tracks are visible context rather than inspectable actor proxies.

Shared species policy composes representation, capabilities, group eligibility, locomotion, travel medium, decision verbs, activity, evidence, sound, tide, and projection instead of adding a separate detector or decision tree for each animal. Aggregate visual pressure and aquatic observation likewise accept canonical species and resolve shared roles/capabilities/trophic classes instead of maintaining a pair allowlist. Every core-wildlife catalog module declares every broad interaction target class as either supported or an intentional no-response, so adding a species cannot silently inherit an unspecified behavior. These broad rows are a fail-closed contract, not a claim that every species pair has bespoke coverage. The released activity owner remains intentionally narrow: a bounded daytime window authorizes ordinary fish-crow activity, the harrier's deterministic low-quartering search, egret wading observation, and the duck's waterfowl activity, while crows seek authenticated habitat perches and the egret or duck seeks its saved dry refuge outside the window unless an immediate lawful need takes precedence. Future species should remain data and capability declarations over these shared owners. Correctness comes from invariants, conservation, representative deterministic scenarios, bounded fuzzing, and performance witnesses—not a hand-authored test matrix for every animal pair. This is not a full sleep, denning, ecological migration, feeding, or circadian-life simulation.
...
Source version `0.3.3-alpha.20 — Between Water and Sky` is the complete but
unpublished second bounded Wave-C unit. Habitat version 6 retains every
...
visible event is evicted. This candidate adds no flock, nesting, breeding,
...
Directive 04_1 completion. Its CI, Pages, and exact-live publication evidence
remain open.

The candidate extends species as data and capabilities over shared habitat,
...
- one versioned production species contract covering exactly fifteen current records—human, domestic dog, deer, gull, black bear, brown rat, domestic cat, marsh rabbit, marsh fox, fish crow, northern harrier, southern leopard frog, Atlantic silverside, Atlantic marsh fiddler crab, and snowy egret—while keeping rat, frog, silverside, and fiddler-crab populations non-addressable as individual actors; shared policy composes representation, capabilities, groups, movement, activity, evidence, sound, decisions, projection, and tide-responsive habitat use; complete scent/evidence tracking, foliage consumption, health/death, full circadian behavior, worldwide habitat breadth, ecological migration/reproduction, complete food-web turnover, and an exhaustive pair matrix remain closed;
