...
Source version `0.3.3-alpha.17` is the Rain Chorus / Shadow Overhead candidate.
...
This candidate does not add attacks, injury, mortality, carcasses, live-prey
...
- one versioned production species contract covering exactly nine Alpha-16 records—human, domestic dog, deer, gull, black bear, brown rat, domestic cat, marsh rabbit, and marsh fox—while keeping the rat non-addressable as an individual actor; the shared trophic resolver deliberately excludes the former size-blind cat/deer predator-prey classification; complete scent/evidence tracking, foliage consumption, health/death, circadian behavior, worldwide habitat breadth, ecological migration/reproduction, complete food-web turnover, and an exhaustive pair matrix remain closed;
