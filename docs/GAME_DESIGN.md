...
- One bounded local core-wildlife assemblage attached to that first living web. Deer, gull, black-bear, brown-rat, and domestic-cat presence derives from the stable seed, terrain, biome/climate signals, and a settlement-adjacent focus, so unsuitable local ecology can contain no member of a species. Deer, gulls, bears, and free-ranging cats use bounded persistent individual representatives; brown rats instead use one stable population-area aggregate disclosed only through directly visible signs. Group-sized deer and gull populations also retain herd/flock state. This is not worldwide habitat generation.
...
The bounded core-wildlife assemblage extends the same observation boundary to its present deer, gulls, black bears, and free-ranging domestic cats. Terrain and structures can block sight; sufficiently clear contact can identify predator or prey classes; and an explicit alarm can propagate through bounded hearing without revealing the caller's stable identity, species, hidden target, or exact motive. Cats, the current dog, the porter, gulls, and the player receive only the visual observations that lawfully reach them. A directly seen second cat can become food competition for a hungry cat; strong local rain can make a materialized cat retreat and leave bounded wet pawprints. Directly visible individual wildlife has distinct Chart and Relief silhouettes and a non-pausing ABOUT surface; loss of direct-detail sight removes rendering, selection, labels, actions, and inspection rather than leaving a remote tracker. Cat pawprints are non-targetable evidence and cannot reveal the unseen cat's thoughts or current location.

When a bear is present, it may choose an easier exposed provision instead of pursuing visible live prey. A gull may also opportunistically inspect and claim exposed food. Either animal must physically reach the same exact whole dried-fish parcel before consumption can commit; the entity is then removed and its animal-consumption history persists. Deer and gulls can currently alarm, flee, retreat, observe, or disengage through their role and current observations, and non-gull wildlife can traverse standable shallow water while rejecting deeper water. Deer browsing is not live. The player can **WAIT AND WATCH**, **ROUTE AROUND THIS SPOT**, or **LEAVE**, but cannot command, feed, tame, name, own, recruit, attack, or otherwise directly manipulate these animals in this release.

Habitat analysis stores carrying capacity inputs, aggregate population units, pressure, trend, and deterministic placement anchors even though only a bounded set of individual representatives materializes. Empty population is a valid ecological result, not a failed spawn. Group-sized deer and gull populations receive stable herd/flock membership, cohesion, group components, anonymous alarm-signal state, and split/rejoin lineage; black bears and domestic cats remain individuals. Brown-rat population units are conserved across a small set of area anchors without ever materializing rats as actors.
...
Player-facing rat rustles and domestic-cat calls occur only for activity visible at event time. They are redundant cues, not long-range simulation knowledge. Cats preserve their individual identity, bounded wet-track history, and already-authoritative intent through full/coarse/full transitions and accept the same **WAIT AND WATCH**, **ROUTE AROUND THIS SPOT**, and **LEAVE** choices as other visible wildlife, but cannot be owned, bonded, named, tamed, or recruited. Rat signs are close-only observations because they are not actors; wet cat tracks are visible context rather than an inspectable actor proxy.

When an entire deer herd or gull flock is coarse, high persisted habitat pressure can produce a bounded player-absent displacement or separation between already validated habitat anchors, followed later by reunion as cohesion recovers. This aftermath is explicitly nonlethal, cannot touch cargo, and never enters player EVENTS or knowledge automatically.
...
- Outer save format 10 preserves the sealed partial fixed-step phase and bounded player sensory samples introduced by version 5, plus dog ecology, porter response, player-choice history, provision custody, bounded memory, promotion, and the aggregate-capable habitat/population/group ecology record. Exact version-9 sessions authenticate and preserve their existing actors, groups, cargo, Promises, and ecology before adopting seed-derived brown-rat and domestic-cat state once. A current version-10 envelope must already contain the canonical version-3 ecology shape; reload cannot reroll or duplicate its rat aggregate, signs, cats, or physical food. Committed human cognition remains in embedded simulation format 4 and `tideweft-sim/6`.
...
The contextual first route teaches movement, depth sounding, promise choice, travel, arrival, and witnessing in sequence. A complete versioned field manual then acts as the durable explanation layer: desktop T and the mobile ? open the same eighteen-topic source covering every current control, physical Promises and parcels, information-only reports, terrain-responsive footing/falls, sweep recovery, cargo care, biomes/tools, Wayknots/Harps, the unbroken world, routes/projects, living actors through ABOUT, views/HUD, local saves/Quiet Hour, accessibility, and explicit build boundaries. Version 25 teaches the dog's five choices and request-versus-command boundary; the bounded deer/gull/black-bear crossing; individual free-ranging cats versus aggregate brown-rat areas; direct signs and visible-event-only sound; lawful visual, food-scent, rain, and terrain pressure; non-consuming redistribution; save adoption; and the absent companion/full-roster/harm systems. Each feature phase updates this manual and its tests as part of completion, so new rules do not accumulate as unexplained HUD clutter.
...
- one deterministic bounded habitat-derived deer/gull/black-bear assemblage with honest species absence, aggregate capacity/population pressure/trend, capped persistent representatives, shared visual and anonymous alarm observations, predator/prey appraisal, bounded alarm/flee/retreat/pursuit/disengagement, standable shallow-water movement, conditional whole-parcel scavenging, knowledge-honest ABOUT, coarse physiology without invented perception or movement, persistent deer/gull group signals/cohesion/split/rejoin, nonlethal cargo-neutral player-absent group aftermath, and identity-preserving full/coarse/full return;
...
- one versioned production species contract covering exactly seven current records—human, domestic dog, deer, gull, black bear, brown rat, and domestic cat—while keeping the rat non-addressable as an individual actor; broad evidence/tracking, health/death, circadian behavior, worldwide habitat breadth, ecological migration/reproduction, and complete food-web turnover remain closed;
...
- universal procedural humans beyond the original harbor country; general distant-actor simulation; general scent fields, broad physical evidence/tracking, social information and rumors, cross-group and broad species communication, physical human search/pursuit pathfinding, human-to-human perception, additional dogs and wildlife beyond the one bounded core patch, habitat-derived worldwide populations, reproduction, ecological migration, broader herd/flock social behavior beyond the current deer/gull sidecar, attacks/injury/death/carcasses, ownership, companions, social networks, general physical NPC inventory, negotiation, deterrence, and broader actor-to-actor ecology;
