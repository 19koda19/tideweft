...
Source candidate `0.3.3-alpha.19 — The Tide Table` begins the first bounded
Wave-C tidal unit near the stable starting harbor. Habitat version 5 preserves
...
This candidate does not complete Wave C or the biodiversity directive. It does
...
matrix. Full regression, packaging, CI, Pages, and exact-live verification are
still required.
...
- one versioned production species contract covering exactly twelve current records—human, domestic dog, deer, gull, black bear, brown rat, domestic cat, marsh rabbit, marsh fox, fish crow, northern harrier, and southern leopard frog—while keeping rat and frog populations non-addressable as individual actors; shared policy composes representation, capabilities, groups, movement, activity, evidence, sound, decisions, and projection; complete scent/evidence tracking, foliage consumption, health/death, full circadian behavior, worldwide habitat breadth, ecological migration/reproduction, complete food-web turnover, and an exhaustive pair matrix remain closed;
