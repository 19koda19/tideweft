...
- One bounded local core-wildlife assemblage attached to that first living web. Deer, gull, black-bear, brown-rat, domestic-cat, marsh-rabbit, marsh-fox, fish-crow, northern-harrier, southern-leopard-frog, Atlantic-silverside, Atlantic-marsh-fiddler-crab, and snowy-egret presence derives from the stable seed, terrain, biome/climate signals, and a settlement-adjacent focus, so unsuitable local ecology can contain no member of a species. Deer, gulls, bears, free-ranging cats, rabbits, foxes, fish crows, northern harriers, and snowy egrets use bounded persistent individual representatives. A viable fish-crow population exposes at most three representatives and, when at least two are present, one persistent flock; the northern harrier and snowy egret remain solitary and expose at most one representative each. Brown rats, southern leopard frogs, Atlantic silversides, and Atlantic marsh fiddler crabs instead use stable aggregates disclosed only through directly visible signs. Fish and crabs never become manufactured individual actors. This is not worldwide habitat generation or a complete bestiary.
...
The bounded core-wildlife assemblage extends the same observation boundary to its present deer, gulls, black bears, free-ranging domestic cats, marsh rabbits, marsh foxes, fish crows, northern harrier, and snowy egret. Terrain and structures can block sight; sufficiently clear contact can identify an ecologically plausible relationship; and an explicit alarm can propagate through bounded hearing without revealing the caller's stable identity, species, hidden target, or exact motive. Cats, rabbits, foxes, crows, the harrier, the egret, the current dog, the porter, gulls, and the player receive only the visual observations that lawfully reach them. The egret receives a current anonymous **AQUATIC ACTIVITY** area only when an occupied, active, depth-usable fish or crab anchor passes shared direct sight; it never receives an aggregate ID, species, exact count, or hidden target. A directly seen second cat can become food competition for a hungry cat; strong local rain can make a materialized cat retreat and leave bounded wet pawprints. Rabbit and fox movement can leave paired tracks or canid pawprints at the saved movement site. Crows, the harrier, and the egret do not manufacture ground tracks. Directly visible individual wildlife has distinct Chart and Relief silhouettes and a non-pausing ABOUT surface; each visible crow representative renders and hit-tests once even when its flock context reports a larger group. Loss of direct-detail sight removes rendering, selection, labels, actions, and inspection rather than leaving a remote tracker. Individual movement signs require current direct-detail sight, fade from identified to ambiguous as their clarity ages, expire after 180 ticks, remain non-targetable, and cannot reveal an unseen animal's thoughts or current location. Rat/frog-area evidence, silverside surface activity, and fiddler-crab burrows or feeding scrapes follow the same knowledge boundary and never pretend to be individual aggregate animals.
...
Player-facing rat rustles, domestic-cat calls, rabbit thumps, fox yips, and fish-crow double calls occur only for activity visible at event time. The frog chorus instead passes through shared directional hearing from its actual aggregate anchor. Its anonymous bottom-right caption and attenuated stereo pan derive from the same heard-bearing uncertainty; it names a cardinal direction only when that contact supports one. The northern harrier and snowy egret have no fabricated calls. These are redundant cues, not long-range simulation knowledge. Cats, rabbits, foxes, fish crows, the harrier, and the egret preserve individual identity, bounded state, and already-authoritative intent through full/coarse/full transitions and accept the same **WAIT AND WATCH**, **ROUTE AROUND THIS SPOT**, and **LEAVE** choices as other visible wildlife, but cannot be owned, bonded, named, tamed, or recruited. A selected gull or fish-crow representative's ABOUT view uses the same visible flock estimate already present in projection; it does not recount hidden members. Rat, frog, silverside, and fiddler-crab signs are close-only observations because none represents an addressable actor; cat, rabbit, and fox tracks are visible context rather than inspectable actor proxies.

Shared species policy composes representation, capabilities, group eligibility, locomotion, decision verbs, activity, evidence, sound, tide, and projection instead of adding a separate detector or decision tree for each animal. Aggregate visual pressure likewise accepts canonical species and resolves shared roles/capabilities/trophic classes instead of maintaining a pair allowlist. Every core-wildlife catalog module declares every broad interaction target class as either supported or an intentional no-response, so adding a species cannot silently inherit an unspecified behavior. These broad rows are a fail-closed contract, not a claim that every species pair has bespoke coverage. The released activity owner remains intentionally narrow: a bounded daytime window authorizes ordinary fish-crow activity, the harrier's deterministic low-quartering search, and egret wading observation, while crows seek authenticated habitat perches and the egret seeks its saved dry refuge outside the window unless an immediate lawful need takes precedence. This is not a full sleep, denning, ecological migration, feeding, or circadian-life simulation.
...
- Outer save format 13 preserves the sealed partial fixed-step phase and bounded player sensory samples introduced by version 5, plus dog ecology, porter response, player-choice history, provision custody, bounded memory, promotion, and the aggregate-capable habitat/population/group ecology record. Exact version-12 sessions authenticate and preserve every existing actor, group, aggregate population, cargo object, Promise, disturbance, evidence record, and ecology fact before adopting the seed-derived Atlantic-silverside, Atlantic-marsh-fiddler-crab, and snowy-egret extension once. A current version-13 envelope must already contain the canonical aggregate ecology shape with a habitat-version-5 derivation; reload cannot reroll or duplicate its exact version-4 prefix, new aggregate populations, egret actor, tidal anchors, evidence, or physical food history. Earlier supported saves continue through their frozen save-adoption paths. Committed human cognition remains in embedded simulation format 4 and `tideweft-sim/6`.
