...
- One bounded local core-wildlife assemblage attached to that first living web. Deer, gull, black-bear, brown-rat, domestic-cat, marsh-rabbit, marsh-fox, fish-crow, northern-harrier, and southern-leopard-frog presence derives from the stable seed, terrain, biome/climate signals, and a settlement-adjacent focus, so unsuitable local ecology can contain no member of a species. Deer, gulls, bears, free-ranging cats, rabbits, foxes, fish crows, and northern harriers use bounded persistent individual representatives. A viable fish-crow population exposes at most three representatives and, when at least two are present, one persistent flock; the northern harrier remains solitary and exposes at most one. Brown rats and southern leopard frogs instead use stable population-area aggregates disclosed only through directly visible signs. The frog area conserves 64–72 units over at most three anchors without manufacturing individual frog actors. This is not worldwide habitat generation or a complete bestiary.
...
The bounded core-wildlife assemblage extends the same observation boundary to its present deer, gulls, black bears, free-ranging domestic cats, marsh rabbits, marsh foxes, fish crows, and northern harrier. Terrain and structures can block sight; sufficiently clear contact can identify an ecologically plausible relationship; and an explicit alarm can propagate through bounded hearing without revealing the caller's stable identity, species, hidden target, or exact motive. Cats, rabbits, foxes, crows, the harrier, the current dog, the porter, gulls, and the player receive only the visual observations that lawfully reach them. A directly seen second cat can become food competition for a hungry cat; strong local rain can make a materialized cat retreat and leave bounded wet pawprints. Rabbit and fox movement can leave paired tracks or canid pawprints at the saved movement site. The two new birds do not manufacture ground tracks. Directly visible individual wildlife has distinct Chart and Relief silhouettes and a non-pausing ABOUT surface; each visible crow representative renders and hit-tests once even when its flock context reports a larger group. Loss of direct-detail sight removes rendering, selection, labels, actions, and inspection rather than leaving a remote tracker. Individual movement signs require current direct-detail sight, fade from identified to ambiguous as their clarity ages, expire after 180 ticks, remain non-targetable, and cannot reveal an unseen animal's thoughts or current location. Frog-area evidence follows the same knowledge boundary and never pretends to be an individual frog.
...
Habitat analysis stores carrying capacity inputs, aggregate population units, pressure, trend, and deterministic placement anchors even though only a bounded set of individual representatives materializes. Habitat version 4 preserves the exact version-3 population prefix and appends only the fish-crow, northern-harrier, and southern-leopard-frog analyses. Empty population is a valid ecological result, not a failed spawn. Group-sized deer, gull, and fish-crow populations receive stable herd/flock membership, cohesion, group components, anonymous alarm-signal state, and split/rejoin lineage; crows use their own `CROW-FLOCK` namespace. Black bears and northern harriers remain solitary, while domestic cats, marsh rabbits, and marsh foxes remain individual. Brown-rat and southern-leopard-frog population units are conserved across their saved area anchors without ever materializing either aggregate as actors.

The rat aggregate can redistribute at most one population unit on each fixed eight-tick opportunity. Its stimulus must first be derived through shared owners: terrain-occluded sight for nearby cats, dogs, people, or gulls; wind- and rain-shaped scent from an exposed loose provision that still physically exists; or direct rain and terrain-exposure pressure. With no stronger external relocation, a substantially crowded anchor can space one conserved unit toward a quieter anchor. Attraction does not consume, move, damage, or duplicate the food. No stimulus causes mortality, cargo transfer, or automatic player knowledge. Gnaw marks, small tracks, and shelter signs become player-facing only under current direct-detail sight, and their ABOUT view reports evidence rather than an invented rat identity or hidden population census.

The frog aggregate conserves 64–72 units across no more than three suitable wetland anchors. Rain raises its bounded activity while lawful nearby pressure can quiet it or redistribute at most one existing unit on the fixed opportunity. The same rain that encourages chorus also masks hearing, so an extant strongest audible anchor may produce one directional stereo chorus and anonymous nearby/distant caption without disclosing its aggregate identity, exact location, or hidden population count. Weather alone cannot create, kill, duplicate, or reroll frogs.

Player-facing rat rustles, domestic-cat calls, rabbit thumps, fox yips, and fish-crow double calls occur only for activity visible at event time. The frog chorus instead passes through shared directional hearing from its actual aggregate anchor. Anonymous bottom-right captions disclose no more than the sound. The northern harrier has no fabricated call. These are redundant cues, not long-range simulation knowledge. Cats, rabbits, foxes, fish crows, and the harrier preserve individual identity, bounded state, and already-authoritative intent through full/coarse/full transitions and accept the same **WAIT AND WATCH**, **ROUTE AROUND THIS SPOT**, and **LEAVE** choices as other visible wildlife, but cannot be owned, bonded, named, tamed, or recruited. Rat and frog signs are close-only observations because neither represents an addressable actor; cat, rabbit, and fox tracks are visible context rather than inspectable actor proxies.

Shared species policy composes representation, capabilities, group eligibility, locomotion, decision verbs, activity, evidence, sound, and projection instead of adding a separate detector or decision tree for each animal. The released activity owner is intentionally narrow: a bounded daytime window authorizes ordinary fish-crow activity and the harrier's deterministic low-quartering search, while crows seek authenticated habitat perches and both birds rest outside it unless an immediate lawful need takes precedence. This is not a full sleep, denning, migration, or circadian-life simulation.
...
- Outer save format 12 preserves the sealed partial fixed-step phase and bounded player sensory samples introduced by version 5, plus dog ecology, porter response, player-choice history, provision custody, bounded memory, promotion, and the aggregate-capable habitat/population/group ecology record. Exact version-11 sessions authenticate and preserve every existing actor, group, aggregate population, cargo object, Promise, disturbance, evidence record, and ecology fact before adopting the seed-derived fish-crow, northern-harrier, and southern-leopard-frog extension once. A current version-12 envelope must already contain the canonical aggregate ecology shape with a habitat-version-4 derivation; reload cannot reroll or duplicate its prior version-3 prefix, new populations, crow group, bird actors, frog aggregate, evidence, or physical food history. Committed human cognition remains in embedded simulation format 4 and `tideweft-sim/6`.
