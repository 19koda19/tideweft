...
20. Vite production build under relative paths.
...
representative-emergence based. Exact release/main commit
`f2c55413c64a8e6b8e3cc1fab06e50252df2399f` passed feature CI
`34158217494`, main CI `34158968284`, and Pages `34158968401`; all five
cache-bypassed deployed artifacts match the tested production build exactly.
