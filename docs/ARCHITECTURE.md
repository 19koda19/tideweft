...
## Original-estuary human identity and ABOUT boundary
...
This is not the universal NPC architecture yet. Generated people beyond the original estuary, persistence promotion tiers, dogs, bears, birds, deer, ownership and social networks, physical NPC inventory, actor-to-actor perception, negotiation, deterrence, and companion behavior remain explicit later slices.
