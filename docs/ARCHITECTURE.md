...
- One canonical bounded wildlife catalog whose first twenty-four records are distributed through deterministic signed-region ecology. Habitat v11 remains sealed compatibility lineage: its exact habitat-v9 prefix describes the original-harbor populations, habitat v10 appends one remote temperate-upland/forest-edge source for wild boar, elk, and gray wolf, and habitat v11 appends cougar and brown bear at that same source. Alpha 32 derives eligible current wild populations across signed regions from seed-stable terrain, biome/climate, carrying capacity, food or prey support, territory, and density signals, with honest absence when ecology cannot support a species. Addressable species use capped persistent representatives with stable seed/region/population/ordinal identities, segmented positions, bounded dynamic state, and saved materialized/coarse state. A separate starting-settlement home owner retains bounded brown rats, one stable two-to-three-chicken flock in a coop, and one stable two-goat herd in a separate pen; its free-ranging domestic cat remains habitat-optional. Eligible crows, boars, elk, and wolves use shared flock, sounder, herd, and pack topology, while cougar and brown bear remain solitary. Northern harriers, snowy egrets, American black ducks, and river otters each expose at most one representative, and the otter requires both tidal aggregate populations plus authenticated usable water and a distinct dry haulout. Brown rats, southern leopard frogs, Atlantic silversides, and Atlantic marsh fiddler crabs instead use stable aggregate populations; no fish or crab actor is synthesized. Released Alpha33 preserves that exact twenty-four-record prefix and appends three Alpine records. The preserved unpublished Alpha34 checkpoint appends non-addressable Atlantic capelin as record 28 through a polar-shore sibling; preserved unpublished Alpha35 appends solitary addressable Arctic fox as record 29 through a cold-shore sibling. The current unpublished Alpha36 candidate retains that exact prefix and appends solitary harbor seal and polar bear records 30–31 through a separate capelin-backed polar-consumer sibling. This is signed-region distribution of a bounded current catalog rather than worldwide species breadth, ecological migration behavior, or a complete bestiary.
...
`0.3.3-alpha.35` is an **unpublished local working-tree candidate**; Alpha33
remains the LIVE_VERIFIED public release, and commit `950b2b5` remains the
preserved unpublished Alpha34 checkpoint. The candidate retains Alpha34's
...
completion, or release. It has no Alpha35 commit, push, deployment, Pages
result, or LIVE_VERIFIED evidence.
...
working-tree candidate**. It keeps Alpha35's exact 29-record catalog and
...
The current unpublished Alpha36 candidate preserves that complete
...
Chart and Relief project the same direct-detail individual wildlife set and use species plus stable ID for selection. Domestic cats, domestic chickens, domestic goats, marsh rabbits, marsh foxes, fish crows, northern harriers, snowy egrets, American black ducks, North American river otters, wild boars, elk, gray wolves, cougars, and brown bears receive distinct color-independent low-cost forms and the ordinary wildlife choices: **WAIT AND WATCH**, **ROUTE AROUND THIS SPOT**, and **LEAVE**; gulls retain their established flock form and the same direct-detail gate. Each visible crow, gull, chicken, goat, boar, elk, wolf, cougar, or brown bear representative renders and hit-tests once. Only gull, fish-crow, and domestic-chicken visible-flock projection may expose a bounded visible count, and that summary never manufactures decorative copies or extra targets. Boar, elk, wolf, duck, otter, cougar, and brown bear render and hit-test as individual addressable actors without a group suffix or hidden census. Authenticated perch, low-quartering, egret flight/refuge/wading, duck floating/scanning/dabbling/resting/surface-swimming/relocation-flight, otter foraging/diving/shore-water/resting, and candidate gull surface-circling/habitat-rest states have distinct presentation. Gull circling remains air-only and ABOUT reports only the authenticated visible behavior, never the anonymous observation's hidden source. At uncertain clarity the otter remains an unidentified aquatic mammal, cougar an unknown large cat, and brown bear a large bear; direct ABOUT can identify visible form and authenticated behavior without exposing a private target, exact trait, aggregate count, or stable ID. Rat/frog-area evidence, silverside surface activity, and fiddler-crab burrow or scrape evidence remain aggregate target types; cat/rabbit/fox/wolf tracks remain non-targetable, and the two Alpha-31 additions produce no track evidence. Mouse/touch and Chart/Relief share the same projection, reduced motion preserves the same facts, and loss of sight clears the ephemeral target.
