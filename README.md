...
`0.3.3-alpha.24 — The Yard Flock` release described below. Exact release
commit `4067ac4439bb6f624ed88f69eb09cc591b246741` passed CI run
`34093027893` and Pages run `34093027917`; all five fetched live artifacts
...
- The Alpha 25 source candidate advances the catalog to nineteen records, habitat to version 9, settlement ecology to version 3, and the outer save to version 18. It preserves the complete Alpha 24 habitat, actors, flock, coop, custody, store, and food-use history before appending exactly two goats, one herd, one separated pen, and one second custody. Shared group, perception, locomotion, presentation, conservation, and deterministic claim-arbitration owners carry the new role; no per-species or N² interaction matrix is introduced.
...
Source version `0.3.3-alpha.25 — The Far Paddock` is the current bounded
Wave-D candidate. Habitat version 9 preserves the complete version-8 record as
...
Wave D, and Directive 04_1 completion remain outside this candidate.
...
The current Alpha 24 feature is **LIVE_VERIFIED** at exact release commit
`4067ac4439bb6f624ed88f69eb09cc591b246741`. CI run `34093027893` and Pages
run `34093027917` succeeded. Five cache-bypassed fetched live
assets match the local production build exactly:

| Asset | Bytes | SHA-256 |
| --- | ---: | --- |
| `index.html` | 4,168 | `9c3c46c10fdf12df28a94381daf309ded63709c8715b834da23c8acd851ef3cb` |
...
| `assets/index-DQwcyiNX.js` | 2,983,489 | `09c0b8b0734c96f996f64232b489d95646e445b64c5f78a9c7d51806f93958af` |
