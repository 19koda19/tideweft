...
The repository is preparing the unreleased **SOURCE_CANDIDATE**
`0.3.3-alpha.33 — Talus and Sky`. It is not the current live build and has no
CI, Pages, or deployed-artifact claim yet.
...
### Source candidate — Alpha 33 Talus and Sky
...
This candidate has no release commit, public CI/Pages run, or live-artifact
attestation yet. It adds no new mortality, live-prey capture, exact pika
target, reproduction, audible Living Voice, tactical combat, complete polar
breadth, worldwide ecology, Wave-F completion, or exhaustive species-pair
testing. Alpha32 remains the current live release until the full gate and exact
deployment verification succeed.
