...
The `0.3.3-alpha.2` source candidate carries gameplay contract 11 and tutorial 12. It adds one cached perception snapshot shared by Chart and Relief, omits unseen live detail and off-screen route work from rendering and targeting, preserves explored geography as dim memory, limits event reporting to what the courier observes or directly causes, and exposes signed coordinates with measured renderer FPS. [CHANGELOG.md](./CHANGELOG.md), the title and Quiet Hour Patch Notes, and the field manual's **What's New** page are generated from or synchronized with the same canonical release ledger. Player-controlled ADRIFT recovery, audible living-actor contacts, generated NPC identities, emotion/deterrence, dogs, health, and generated regional settlement ecology remain explicitly unfinished rather than hidden behind inert controls.
