...
- **Bounded living ecology:** one local habitat patch now derives deer, gull, black-bear, brown-rat, domestic-cat, domestic-chicken, marsh-rabbit, marsh-fox, fish-crow, northern-harrier, southern-leopard-frog, Atlantic-silverside, Atlantic-marsh-fiddler-crab, snowy-egret, American-black-duck, and North American river otter presence from the seed and actual terrain. Rats, frogs, silversides, and fiddler crabs remain conserved population-area aggregates; the other listed wildlife use capped persistent representatives, including at most one snowy egret, one American black duck, one river otter, and one stable two-to-three-chicken starting-yard flock. The flock's individual birds, group, yard anchor, and settlement custody persist while shared perception, terrestrial locomotion, group alarm, and exact physical store-food claims produce bounded behavior. Securing the real store door removes its food opportunity. Exact spatial top-K materialization keeps the active field at 24 while preserving overflow actors in coarse state. This remains one original-harbor assemblage, not worldwide ecology or livestock, harmful animal interaction, live-prey capture or consumption, fishing, mortality, reproduction, or a complete bestiary.
...
- One bounded core-wildlife assemblage with stable deer, gull, black-bear, domestic-cat, domestic-chicken, marsh-rabbit, marsh-fox, fish-crow, northern-harrier, snowy-egret, American-black-duck, and North American river otter actors plus conserved brown-rat, southern-leopard-frog, Atlantic-silverside, and Atlantic-marsh-fiddler-crab aggregates; terrain-occluded sight; anonymous weather-aware hearing for established cues; nonlethal alarm, flee, retreat, observe, pursue, wade, float, dabble, dive, surface-swim, shore-water relocation, fly, forage, and disengage decisions; direct-detail Chart/Relief presentation; and physical food conservation. Seeded habitat analysis may produce an honest local absence and otherwise persists capacity, population units, pressure, trend, and bounded representative or aggregate allocations instead of treating visible actor count as total population. Group-sized deer, gull, crow, and chicken populations share persistent herd/flock state; the starting yard's two or three chickens additionally share one stable settlement-custody relationship. Black bears and the harrier remain solitary representatives, while the egret, black duck, and otter each expose at most one individual. A hungry chicken can use the generic perception, locomotion, and exact-item transaction seam to consume one accessible open-store unit; a secured store grants neither a food belief nor a claim. Deterministic local-distance ranking with a stable-ID tie break selects no more than 24 materialized individuals while preserving every overflow actor in coarse state. Returning to full detail preserves the same identities and reconciles members around saved group components. The assemblage is deliberately local and adds no animal attacks, capture, fishing, injury, death, carcasses, hunting, taming, live-prey consumption, reproduction, ecological migration, nesting, or worldwide habitat generation.
- One strict versioned species catalog covering exactly eighteen current source records—human, domestic dog, deer, gull, black bear, brown rat, domestic cat, domestic chicken, marsh rabbit, marsh fox, fish crow, northern harrier, southern leopard frog, Atlantic silverside, Atlantic marsh fiddler crab, snowy egret, American black duck, and North American river otter. Rats, frogs, silversides, and fiddler crabs remain non-addressable aggregates rather than individual actors. Shared representation, sensory, role, size, decision, locomotion, travel-medium, group, aggregate-response, activity, evidence, sound, tide, item-claim, materialization, custody, and presentation contracts support the bounded local behaviors above, while fail-closed boundaries keep complete tracking and scent, health/death, full circadian schedules, worldwide habitat breadth, ecological migration/reproduction, and the rest of the food web distinct from implemented gameplay. Future species extend those shared roles and capabilities; shared invariants, deterministic properties, bounded interaction-graph fuzzing, conservation, representative scenarios, and performance witnesses replace a brittle species-by-species or N² test matrix.
...
candidate. Habitat version 8 preserves the entire version-7 tidal-web record as
...
species-by-species and N² pair coverage. The candidate does not add chicken
...
D, or completion of Directive 04_1. It will be called LIVE_VERIFIED only after
its committed build passes CI, Pages, package/smoke, and exact-live comparison.
