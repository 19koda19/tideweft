...
`0.3.3-alpha.22 — Tidal Convergence` release described below. Its exact
feature commit, CI, Pages deployment, and fetched live assets are verified.

The current local source candidate is `0.3.3-alpha.23 — The Storehouse Door`.
It is not marked **LIVE_VERIFIED** until its release commit, CI, Pages run, and
fetched assets have all been independently attested.
...
- **Bounded living ecology:** one local habitat patch now derives deer, gull, black-bear, brown-rat, domestic-cat, marsh-rabbit, marsh-fox, fish-crow, northern-harrier, southern-leopard-frog, Atlantic-silverside, Atlantic-marsh-fiddler-crab, snowy-egret, American-black-duck, and North American river otter presence from the seed and actual terrain. Rats, frogs, silversides, and fiddler crabs remain conserved population-area aggregates; the other listed wildlife use capped persistent representatives, including at most one snowy egret, one American black duck, and one river otter. The otter appears only where fish, crab, usable water, and a separate dry haulout all support it. Shared amphibious locomotion carries that same persistent actor between shore and surface water; current anonymous aquatic activity can guide it only through ordinary occluded sight. Broad roles produce nonlethal fish/crab pressure, and the common physical-item claim boundary resolves a representative loose-food contest. Exact spatial top-K materialization keeps the active field at 24 while preserving overflow actors in coarse state. This remains one original-harbor assemblage, not worldwide ecology, harmful animal interaction, live-prey capture or consumption, fishing, mortality, or a complete bestiary.
...
Each seed now creates one continuous deterministic terrain world. The preserved original 96 × 72 tidal country contains its well-separated harbor network, 42 persistent generated human residents, five resource economies, changing weather, shortage-driven promises, five civic projects, one generated independent dog paired with one existing porter, and one bounded habitat-derived assemblage covering deer, gulls, black bears, a brown-rat population area, free-ranging domestic cats, marsh rabbits, marsh foxes, fish crows, one northern harrier, a southern leopard-frog population area, an Atlantic-silverside school, an Atlantic-marsh-fiddler-crab area, at most one snowy egret, at most one American black duck, and at most one habitat-supported North American river otter. Walking beyond that old extent requires no edge action or transition: terrain is prepared ahead, exact negative coordinates work, and the same chart, cargo, route, camera, field kit, and persistent objects continue. Alpha 0.1's existing 64 × 48 saves retain their authored world rather than being regenerated. Generated distant settlements and worldwide populations, additional dogs and wildlife, ownership, companions, animal mortality, and full actor-to-actor ecology remain later vertical slices; empty country is not padded with cloned harbors, people, animals, or free loot. The main loop is:
...
- One bounded core-wildlife assemblage with stable deer, gull, black-bear, domestic-cat, marsh-rabbit, marsh-fox, fish-crow, northern-harrier, snowy-egret, American-black-duck, and North American river otter actors plus conserved brown-rat, southern-leopard-frog, Atlantic-silverside, and Atlantic-marsh-fiddler-crab aggregates; terrain-occluded sight; anonymous weather-aware hearing for established cues; nonlethal alarm, flee, retreat, observe, pursue, wade, float, dabble, dive, surface-swim, shore-water relocation, fly, and disengage decisions; direct-detail Chart/Relief presentation; and whole-parcel food conservation. Seeded habitat analysis may produce an honest local absence and otherwise persists capacity, population units, pressure, trend, and bounded representative or aggregate allocations instead of treating visible actor count as total population. Group-sized deer, gull, and crow populations share persistent herd/flock state; black bears and the harrier remain solitary representatives, while the egret, black duck, and otter each expose at most one individual. The otter requires both aquatic aggregates plus usable water and a dry haulout, crosses shore and water through shared amphibious pathing, observes aquatic activity only through lawful anonymous sight, applies nonlethal aggregate pressure through broad roles, and uses the generic physical-item claim/custody seam for loose food. Deterministic local-distance ranking with a stable-ID tie break selects no more than 24 materialized individuals while preserving every overflow actor in coarse state. Returning to full detail preserves the same identities and reconciles members around saved group components. The assemblage is deliberately local and adds no animal attacks, capture, fishing, injury, death, carcasses, hunting, taming, live-prey consumption, reproduction, ecological migration, nesting, or worldwide habitat generation.
- One strict versioned species catalog covering exactly seventeen current source records—human, domestic dog, deer, gull, black bear, brown rat, domestic cat, marsh rabbit, marsh fox, fish crow, northern harrier, southern leopard frog, Atlantic silverside, Atlantic marsh fiddler crab, snowy egret, American black duck, and North American river otter. Rats, frogs, silversides, and fiddler crabs remain non-addressable aggregates rather than individual actors. Shared representation, sensory, role, size, decision, locomotion, travel-medium, group, aggregate-response, activity, evidence, sound, tide, item-claim, materialization, and presentation contracts support the bounded local behaviors above, while fail-closed boundaries keep complete tracking and scent, health/death, full circadian schedules, worldwide habitat breadth, ecological migration/reproduction, and the rest of the food web distinct from implemented gameplay. Future species extend those shared roles and capabilities; shared invariants, deterministic properties, bounded interaction-graph fuzzing, conservation, representative scenarios, and performance witnesses replace a brittle species-by-species or N² test matrix.
...
The Alpha 23 local source candidate advances outer session to version 16 while
...
release candidate, not yet **LIVE_VERIFIED**. It adds no species. One bounded
...
The current Alpha 22 feature is **LIVE_VERIFIED** at exact commit
`4dacd99e95a018314d65a72183b82cba8583774f`. CI run `34074045801` and Pages
run `34074045818` succeeded. Five cache-bypassed fetched live
assets match the local production build exactly:

| Asset | Bytes | SHA-256 |
| --- | ---: | --- |
| `index.html` | 4,168 | `5cba89d6342e3317e23884ed8bef0647a350ac86143be305eefef8455a04a2e0` |
...
| `assets/index-Cax2bWhQ.js` | 2,910,838 | `224f43b580e77712efdb94b035c6686de115ffd1d5e25d9f8aeb6e0cc865c04a` |
