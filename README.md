...
`0.3.3-alpha.28 — The Missing Goat` release described below. Exact
gameplay/release/main commit `60c9bc34ac871425e5319c8369e715751b5d1c44`
passed main CI run `34175693435` and Pages run `34175693447`; all five fetched
live artifacts match the tested local production build byte-for-byte.
...
The current Alpha 28 feature is **LIVE_VERIFIED** at exact
gameplay/release/main commit
`60c9bc34ac871425e5319c8369e715751b5d1c44`. Feature CI `34174876320`, main
CI `34175693435`, and Pages `34175693447` succeeded. The first cache-bypassed
fetch matched all five live assets to the tested production build exactly:

| Asset | Bytes | SHA-256 |
| --- | ---: | --- |
| `index.html` | 4,168 | `29fa9933e16b9157c33f61be0ee270e5d19d034c82b541e1129193af9b015d4b` |
...
| `assets/index-BVohL3Tv.js` | 3,172,296 | `135ed5df6a34c9cd14675754f9e4b275e33d65f38cf6816b5f203ac095f488d9` |
