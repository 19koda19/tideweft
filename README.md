...
The `0.3.3-alpha.1` source candidate carries gameplay contract 10 and tutorial 11. It combines deterministic signed-region streaming with the restart/report hotfix and fairer terrain-responsive footing described above. [CHANGELOG.md](./CHANGELOG.md), the title and Quiet Hour Patch Notes, and the field manual's **What's New** page are generated from or synchronized with the same canonical release ledger. Fog/perception culling with coordinates and smoothed renderer FPS, player-controlled ADRIFT recovery, living actors, emotion/deterrence, dogs, and generated regional settlement ecology remain explicitly unfinished rather than hidden behind inert controls.
