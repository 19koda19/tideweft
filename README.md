...
`0.3.3-alpha.22 — Tidal Convergence` is a source candidate only. It has not
replaced that public deployment and has no live-build, CI, Pages, or fetched-
asset attestation yet.
...
The Alpha 22 source candidate deliberately retains outer session 15, habitat 7,
...
Source candidate `0.3.3-alpha.22 — Tidal Convergence` adds no species. It closes
...
lawful threat, alarm, pursuit, and physical-food intent retains priority over
...
The candidate retains outer save 15, habitat 7, aggregate schema 4, the
...
coverage. It is not the live build, has no exact deployment attestation, and
does not complete worldwide Wave C or Directive 04_1. It adds no mortality,
