...
`0.3.3-alpha.25 — The Far Paddock` release described below. Exact release
commit `29af7793346c0c3977a5ca727b79feb3a50b83bb` passed CI run
`34108539228` and Pages run `34108539255`; all five fetched live artifacts
...
Each seed now creates one continuous deterministic terrain world. The preserved original 96 × 72 tidal country contains its well-separated harbor network, 42 persistent generated human residents, five resource economies, changing weather, shortage-driven promises, five civic projects, one generated independent dog paired with one existing porter, one separate settlement working dog assigned beside the two-goat pen, and one bounded habitat-derived assemblage covering deer, gulls, black bears, a brown-rat population area, free-ranging domestic cats, one two-to-three-member domestic-chicken flock at the starting storehouse yard, exactly two domestic goats in a separate pen herd, marsh rabbits, marsh foxes, fish crows, one northern harrier, a southern leopard-frog population area, an Atlantic-silverside school, an Atlantic-marsh-fiddler-crab area, at most one snowy egret, at most one American black duck, and at most one habitat-supported North American river otter. Walking beyond that old extent requires no edge action or transition: terrain is prepared ahead, exact negative coordinates work, and the same chart, cargo, route, camera, field kit, and persistent objects continue. Alpha 0.1's existing 64 × 48 saves retain their authored world rather than being regenerated. Generated distant settlements and worldwide populations, additional dogs beyond those two, additional wildlife, wider domestic ownership, companions, animal mortality, and full actor-to-actor ecology remain later vertical slices; empty country is not padded with cloned harbors, people, animals, or free loot. The main loop is:
...
- One bounded core-wildlife assemblage with stable deer, gull, black-bear, domestic-cat, domestic-chicken, domestic-goat, marsh-rabbit, marsh-fox, fish-crow, northern-harrier, snowy-egret, American-black-duck, and North American river otter actors plus conserved brown-rat, southern-leopard-frog, Atlantic-silverside, and Atlantic-marsh-fiddler-crab aggregates; terrain-occluded sight; anonymous weather-aware hearing for established cues; nonlethal alarm, flee, retreat, observe, pursue, wade, float, dabble, dive, surface-swim, shore-water relocation, fly, forage, and disengage decisions; direct-detail Chart/Relief presentation; and physical food conservation. Seeded habitat analysis may produce an honest local absence and otherwise persists capacity, population units, pressure, trend, and bounded representative or aggregate allocations instead of treating visible actor count as total population. Group-sized deer, gull, crow, chicken, and goat populations share persistent herd/flock state; the starting yard's two or three chickens and the separated pen's two goats use distinct stable custody and typed home relationships. Black bears and the harrier remain solitary representatives, while the egret, black duck, and otter each expose at most one individual. A hungry chicken can use the generic perception, locomotion, and exact-item transaction seam to consume one accessible open-store unit; a goat cannot claim it, and a secured store grants neither a food belief nor a claim. Deterministic local-distance ranking with a stable-ID tie break selects no more than 24 materialized individuals while preserving every overflow actor in coarse state. Returning to full detail preserves the same identities and reconciles members around saved group components. The assemblage is deliberately local and adds no animal attacks, capture, fishing, injury, death, carcasses, hunting, taming, live-prey consumption, foliage browsing, reproduction, ecological migration, nesting, or worldwide habitat generation.
- One strict versioned species catalog covering exactly nineteen current source records—human, domestic dog, deer, gull, black bear, brown rat, domestic cat, domestic chicken, domestic goat, marsh rabbit, marsh fox, fish crow, northern harrier, southern leopard frog, Atlantic silverside, Atlantic marsh fiddler crab, snowy egret, American black duck, and North American river otter. Rats, frogs, silversides, and fiddler crabs remain non-addressable aggregates rather than individual actors. Shared representation, sensory, role, size, decision, locomotion, travel-medium, group, aggregate-response, activity, evidence, sound, tide, item-claim, materialization, custody, and presentation contracts support the bounded local behaviors above, while fail-closed boundaries keep complete tracking and scent, health/death, full circadian schedules, worldwide habitat breadth, ecological migration/reproduction, and the rest of the food web distinct from implemented gameplay. Future species extend those shared roles and capabilities; shared invariants, deterministic properties, bounded interaction-graph fuzzing, conservation, representative scenarios, and performance witnesses replace a brittle species-by-species or N² test matrix.
...
- Source candidate Alpha 26 keeps the nineteen-record catalog, habitat version 9, aggregate ecology version 4, and nearest-24 core-wildlife ceiling. Settlement ecology version 4 admits a kennel as the third typed domestic home, outer save 19 persists the separate dog roster and generic working-animal root, and sealed version 18 migrates once without rewriting the existing flock, herd, homes, actors, items, Promises, or world facts. Shared invariants and one representative runtime/emergence chain cover assignment, perception, pathing, recovery, and conditional deterrence rather than introducing species-by-species or N² tests.
...
The current public Alpha 25 release uses outer session version 18, habitat version 9,
...
The Alpha 26 source candidate advances outer session to version 19 and
...
**SOURCE_CANDIDATE**, not yet a CI-, Pages-, or live-verified release. It keeps
...
The current Alpha 25 feature is **LIVE_VERIFIED** at exact release commit
`29af7793346c0c3977a5ca727b79feb3a50b83bb`. CI run `34108539228` and Pages
run `34108539255` succeeded. Five cache-bypassed fetched live
assets match the local production build exactly:

| Asset | Bytes | SHA-256 |
| --- | ---: | --- |
| `index.html` | 4,168 | `8fc146f86d6d8cc9dd16bccd9ee266697975e985300847fe2b990a7e5d9c236a` |
...
| `assets/index-TLGkREQR.js` | 3,016,777 | `bf144525ed2be44aa1272514313350c09ab4826d8b47d53f009ac88944b0950b` |
